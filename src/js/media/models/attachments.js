/**
 * gc.media.model.Attachments
 *
 * A collection of attachments.
 *
 * This collection has no persistence with the server without supplying
 * 'options.props.query = true', which will mirror the collection
 * to an Attachments Query collection - @see gc.media.model.Attachments.mirror().
 *
 * @memberOf gc.media.model
 *
 * @class
 ...
 *
 */
var Attachments = Backbone.Collection.extend(/** @lends gc.media.model.Attachments.prototype */{
	/**
	 * @type {gc.media.model.Attachment}
	 */
	model: gc.media.model.Attachment,
	/**
	 ...
	 *
	 * @param {gc.media.model.Attachment} attachment
	 * @return {boolean}
	 */
	 ...
	 * @param {gc.media.model.Attachment} attachment
	 * @param {Object} options
	 * @return {gc.media.model.Attachments} Returns itself to allow chaining.
	 */
	 ...
	 *
	 * @param {gc.media.model.Attachments} attachments
	 * @param {Object} [options={}]
	 *
	 * @fires gc.media.model.Attachments#reset
	 *
	 * @return {gc.media.model.Attachments} Returns itself to allow chaining.
	 */
	 ...
	 *
	 * @param {gc.media.model.Attachments} The attachments collection to observe.
	 * @return {gc.media.model.Attachments} Returns itself to allow chaining.
	 */
	 ...
	 *
	 * @param {gc.media.model.Attachments} The attachments collection to stop observing.
	 * @return {gc.media.model.Attachments} Returns itself to allow chaining.
	 */
	 ...
	 * @access private
	 *
	 * @param {gc.media.model.Attachments} attachment
	 * @param {gc.media.model.Attachments} attachments
	 * @param {Object} options
	 *
	 * @return {gc.media.model.Attachments} Returns itself to allow chaining.
	 ...
	 * in the collection.
	 *
	 * @param {gc.media.model.Attachments} The attachments collection to mirror.
	 * @return {gc.media.model.Attachments} Returns itself to allow chaining.
	 */
	...
	parse: function( response, xhr ) {
		...
		return _.map( response, function( attrs ) {
			...
			attachment = gc.media.model.Attachment.get( id );
	...
	_requery: function() {
		...
		if ( this.props.get('query') ) {
			...
			this.mirror( gc.media.model.Query.get( props ) );
		}
	},
	/**
	...
	saveMenuOrder: function() {
		...
		return gc.media.post( 'save-attachment-order', {
			nonce:       gc.media.model.settings.post.nonce,
			post_id:     gc.media.model.settings.post.id,
			attachments: attachments
		});
	}
},/** @lends gc.media.model.Attachments */{
	/**
	 * A function to compare two attachment models in an attachments collection.
	 *
	 * Used as the default comparator for instances of gc.media.model.Attachments
	 * and its subclasses. @see gc.media.model.Attachments._changeOrderby().
	 *
	...
	comparator: function( a, b, options ) {
		...
		return ( 'DESC' === order ) ? gc.media.compare( a, b, ac, bc ) : gc.media.compare( b, a, bc, ac );
	},
	/** @namespace gc.media.model.Attachments.filters */
	filters: {
		/**
		 * @static
		 ...
		 * @param {gc.media.model.Attachment} attachment
		 *
		 * @this gc.media.model.Attachments
		 *
		 * @return {Boolean}
		 */
