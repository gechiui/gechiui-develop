 ...
 * @param {gc.media.model.Attachment} attributes.model                The attachment.
 ...
 */
EditImage = gc.media.controller.State.extend(/** @lends gc.media.controller.EditImage.prototype */{
	defaults: {
		id:      'edit-image',
	...
	toolbar: function() {
		...
		frame.toolbar.set( new gc.media.view.Toolbar({
			controller: frame,
			items: {
				back: {
					style: 'primary',
