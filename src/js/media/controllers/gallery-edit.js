...
/**
 * gc.media.controller.GalleryEdit
 *
 ...
 * @param {gc.media.model.Attachments} [attributes.library]               The collection of attachments in the gallery.
 ...
 */
GalleryEdit = Library.extend(/** @lends gc.media.controller.GalleryEdit.prototype */{
	defaults: {
		id:               'gallery-edit',
	 ...
	 *
	 *
	 * @param {gc.media.view.Frame} browser The file browser.
	 *
	 * @return {void}
	 */
	gallerySettings: function( browser ) {
		...
		browser.sidebar.set({
			gallery: new gc.media.view.Settings.Gallery({
				controller: this,
