var Selection = gc.media.model.Selection,
	Library = gc.media.controller.Library,
	CollectionAdd;

/**
 * gc.media.controller.CollectionAdd
 *
 ...
 */
CollectionAdd = Library.extend(/** @lends gc.media.controller.CollectionAdd.prototype */{
	defaults: _.defaults( {
	...
	initialize: function() {
		...
		if ( ! this.get('library') ) {
			this.set( 'library', gc.media.query({ type: this.get('type') }) );
		}
