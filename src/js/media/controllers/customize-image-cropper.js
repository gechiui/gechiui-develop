 ...
 *
 *
 * @constructs gc.media.controller.CustomizeImageCropper
 * @memberOf gc.media.controller
 * @augments gc.media.controller.CustomizeImageCropper.Cropper
 * @inheritDoc
 */
CustomizeImageCropper = Controller.Cropper.extend(/** @lends gc.media.controller.CustomizeImageCropper.prototype */{
	/**
