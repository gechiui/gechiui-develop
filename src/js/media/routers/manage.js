/**
 * gc.media.view.MediaFrame.Manage.Router
 *
 * A router for handling the browser history and application state.
 *
 * @memberOf gc.media.view.MediaFrame.Manage
 *
 * @class
 * @augments Backbone.Router
 */
var Router = Backbone.Router.extend(/** @lends gc.media.view.MediaFrame.Manage.Router.prototype */{
	routes: {
	...
	reset: function() {
		var frame = gc.media.frames.edit;
	...
	editItem: function( query ) {
		this.showItem( query );
		gc.media.frames.edit.content.mode( 'edit-details' );
	}
});
