 ...
 */
Attachment = View.extend(/** @lends gc.media.view.Attachment.prototype */{
	tagName:   'li',
	className: 'attachment',
	template:  gc.template('attachment'),
	...
	/**
	 * @return {gc.media.view.Attachment} Returns itself to allow chaining.
	 */
	dispose: function() {
		var selection = this.options.selection;
