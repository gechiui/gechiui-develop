...
/**
 * gc.media.view.DeleteSelectedButton
 *
 ...
 */
DeleteSelected = Button.extend(/** @lends gc.media.view.DeleteSelectedButton.prototype */{
	initialize: function() {
	...
	filterChange: function( model ) {
		...
		} else if ( gc.media.view.settings.mediaTrash ) {
