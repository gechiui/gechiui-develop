 ...
 */
UploaderStatus = View.extend(/** @lends gc.media.view.UploaderStatus.prototype */{
	className: 'media-uploader-status',
	template:  gc.template('uploader-status'),
	...
	/**
	 * @return {gc.media.view.UploaderStatus}
	 */
	dispose: function() {
	...
	error: function( error ) {
		var statusError = new gc.media.view.UploaderStatusError( {
		...
		_.delay( function() {
			...
			gc.a11y.speak( error.get( 'message' ), 'assertive' );
		}, 1000 );
	},
