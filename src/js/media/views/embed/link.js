 ...
 */
EmbedLink = gc.media.view.Settings.extend(/** @lends gc.media.view.EmbedLink.prototype */{
	className: 'embed-link-settings',
	template:  gc.template('embed-link-settings'),
	...
	updateoEmbed: _.debounce( function() {
		...
		this.fetch();
	}, gc.media.controller.Embed.sensitivity ),
	...
	fetch: function() {
		...
		this.dfd = gc.apiRequest({
			url: gc.media.view.settings.oEmbedProxyUrl,
			data: {
				url: url,
