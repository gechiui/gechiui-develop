 ...
 */
Modal = gc.media.View.extend(/** @lends gc.media.view.Modal.prototype */{
	tagName:  'div',
	template: gc.template('media-modal'),
	...
	initialize: function() {
		...
		this.focusManager = new gc.media.view.FocusManager({
			el: this.el
		});
	},
	/**
	...
	/**
	 * @return {gc.media.view.Modal} Returns itself to allow chaining.
	 */
	attach: function() {
