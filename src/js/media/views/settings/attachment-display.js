...
/**
 * gc.media.view.Settings.AttachmentDisplay
 *
 ...
 */
AttachmentDisplay = Settings.extend(/** @lends gc.media.view.Settings.AttachmentDisplay.prototype */{
	className: 'attachment-display-settings',
	template:  gc.template('attachment-display-settings'),
	...
	/**
	 * @return {gc.media.view.AttachmentDisplay} Returns itself to allow chaining.
	 */
	render: function() {
		var attachment = this.options.attachment;
		if ( attachment ) {
