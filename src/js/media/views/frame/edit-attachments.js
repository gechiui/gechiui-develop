var Frame = gc.media.view.Frame,
	MediaFrame = gc.media.view.MediaFrame,

	$ = jQuery,
	EditAttachments;

/**
 * gc.media.view.MediaFrame.EditAttachments
 *
 ...
 */
EditAttachments = MediaFrame.extend(/** @lends gc.media.view.MediaFrame.EditAttachments.prototype */{

	className: 'edit-attachment-frame',
	template:  gc.template( 'edit-attachment-frame' ),
	...
	createStates: function() {
		this.states.add([
			new gc.media.controller.EditAttachmentMetadata({
				model:   this.model,
	...
	editMetadataMode: function( contentRegion ) {
		contentRegion.view = new gc.media.view.Attachment.Details.TwoColumn({
			controller: this,
			model:      this.model
		});
		 ...
		 */
		contentRegion.view.views.set( '.attachment-compat', new gc.media.view.AttachmentCompat({
			controller: this,
			model:      this.model
		}) );
	...
	editImageMode: function( contentRegion ) {
		var editImageController = new gc.media.controller.EditImage( {
			model: this.model,
			frame: this
		} );
		// Noop some methods.
		...
		contentRegion.view = new gc.media.view.EditImage.Details( {
			model: this.model,
			frame: this,
