...
/**
 * gc.media.view.MediaFrame.VideoDetails
 *
 ...
 */
VideoDetails = MediaDetails.extend(/** @lends gc.media.view.MediaFrame.VideoDetails.prototype */{
	defaults: {
		id:      'video',
		url:     '',
		menu:    'video-details',
	...
	initialize: function( options ) {
		options.DetailsView = gc.media.view.VideoDetails;
	...
	createStates: function() {
		this.states.add([
			new gc.media.controller.VideoDetails({
				media: this.media
			}),
	...
	renderSelectPosterImageToolbar: function() {
		this.setPrimaryButton( l10n.videoSelectPosterImageTitle, function( controller, state ) {
			...
			_.each( gc.media.view.settings.embedExts, function (ext) {
