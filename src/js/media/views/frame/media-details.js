...
/**
 * gc.media.view.MediaFrame.MediaDetails
 *
 ...
 */
MediaDetails = Select.extend(/** @lends gc.media.view.MediaFrame.MediaDetails.prototype */{
	defaults: {
		id:      'media',
		url:     '',
		menu:    'media-details',
	...
	initialize: function( options ) {
		...
		this.media = new gc.media.model.PostMedia( options.metadata );
		this.options.selection = new gc.media.model.Selection( this.media.attachment, { multiple: false } );
