...
Attachments = View.extend(/** @lends gc.media.view.Attachments.prototype */{
	tagName:   'ul',
	...
	initialize: function() {
		...
		_.defaults( this.options, {
			...
			refreshSensitivity: gc.media.isTouchDevice ? 300 : 200,
			refreshThreshold:   3,
			AttachmentView:     gc.media.view.Attachment,
			sortable:           false,
			resize:             true,
	 ...
	 *
	 * @return {gc.media.View} The created view.
	 */
