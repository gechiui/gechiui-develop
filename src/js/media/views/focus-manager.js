 ...
 */
var FocusManager = gc.media.View.extend(/** @lends gc.media.view.FocusManager.prototype */{
	 ...
	 * prevents the `gc.a11y.speak()` ARIA live regions to work as they're outside
