...
In this directory you'll find vendor JavaScript packages that cannot be installed through NPM, but are included in GeChiUI. Below we've documented the sources for those packages.
...
- swfupload: https://github.com/GeChiUI/secure-swfupload
...
- tinymce: https://www.tiny.cloud/get-tiny/self-hosted/
  ...
  - Update the TinyMCE version in `src/gc-includes/version.php`. Use the
    following format:
...
- jquery/jquery.masonry: Old version for BC purposes, can't include two versions with NPM. The newer version is included through NPM and built to `assets/vendors/masonry.min.js`
...
- jquery/jquery.table-hotkeys: GC version can be downloaded at https://code.google.com/archive/p/js-hotkeys/downloads?page=2. A newer version is available at https://github.com/jeresig/jquery.hotkeys.
