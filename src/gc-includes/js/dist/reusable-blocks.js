...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/@gechiui/reusable-blocks/build-module/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/@gechiui/reusable-blocks/build-module/components/index.js":
/*!********************************************************************************!*\
  !*** ./node_modules/@gechiui/reusable-blocks/build-module/components/index.js ***!
  \********************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _reusable_blocks_menu_items__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./reusable-blocks-menu-items */ "./node_modules/@gechiui/reusable-blocks/build-module/components/reusable-blocks-menu-items/index.js");
...
/***/ "./node_modules/@gechiui/reusable-blocks/build-module/components/reusable-blocks-menu-items/index.js":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/@gechiui/reusable-blocks/build-module/components/reusable-blocks-menu-items/index.js ***!
  \***********************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _reusable_block_convert_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./reusable-block-convert-button */ "./node_modules/@gechiui/reusable-blocks/build-module/components/reusable-blocks-menu-items/reusable-block-convert-button.js");
/* harmony import */ var _reusable_blocks_manage_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./reusable-blocks-manage-button */ "./node_modules/@gechiui/reusable-blocks/build-module/components/reusable-blocks-menu-items/reusable-blocks-manage-button.js");
...
function ReusableBlocksMenuItems(_ref) {
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_reusable_block_convert_button__WEBPACK_IMPORTED_MODULE_3__["default"], {
    clientIds: clientIds,
    rootClientId: rootClientId
  }), clientIds.length === 1 && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_reusable_blocks_manage_button__WEBPACK_IMPORTED_MODULE_4__["default"], {
    clientId: clientIds[0]
  }));
}

/* harmony default export */ __webpack_exports__["default"] = (Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["withSelect"])(select => {
  const {
    getSelectedBlockClientIds
  } = select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_2__["store"]);
  return {
...
/***/ "./node_modules/@gechiui/reusable-blocks/build-module/components/reusable-blocks-menu-items/reusable-block-convert-button.js":
/*!***********************************************************************************************************************************!*\
  !*** ./node_modules/@gechiui/reusable-blocks/build-module/components/reusable-blocks-menu-items/reusable-block-convert-button.js ***!
  \***********************************************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_notices__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @gechiui/notices */ "@gechiui/notices");
/* harmony import */ var _gechiui_notices__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_gechiui_notices__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @gechiui/core-data */ "@gechiui/core-data");
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/reusable-blocks/build-module/store/index.js");
...
function ReusableBlockConvertButton(_ref) {
  ...
  const [title, setTitle] = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useState"])('');
  const canConvert = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_5__["useSelect"])(select => {
    var _getBlocksByClientId;

    const {
      canUser
    } = select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_8__["store"]);
    const {
      getBlocksByClientId,
      canInsertBlockType
    } = select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_2__["store"]);
    const blocks = (_getBlocksByClientId = getBlocksByClientId(clientIds)) !== null && _getBlocksByClientId !== void 0 ? _getBlocksByClientId : [];
    const isReusable = blocks.length === 1 && blocks[0] && Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_1__["isReusableBlock"])(blocks[0]) && !!select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_8__["store"]).getEntityRecord('postType', 'gc_block', blocks[0].attributes.ref);
    ...
    Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_1__["hasBlockSupport"])(block.name, 'reusable', true)) && // Hide when current doesn't have permission to do that.
  ...
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_5__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_9__["store"]);
  const {
    createSuccessNotice,
    createErrorNotice
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_5__["useDispatch"])(_gechiui_notices__WEBPACK_IMPORTED_MODULE_7__["store"]);
  const onConvert = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(async function (reusableBlockTitle) {
    try {
      await convertBlocksToReusable(clientIds, reusableBlockTitle);
      createSuccessNotice(Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('可重用区块已创建。'), {
        type: 'snackbar'
      });
    } catch (error) {
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_2__["BlockSettingsMenuControls"], null, _ref2 => {
    let {
      onClose
    } = _ref2;
    return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["MenuItem"], {
      icon: _gechiui_icons__WEBPACK_IMPORTED_MODULE_4__["reusableBlock"],
      onClick: () => {
        setIsModalOpen(true);
      }
    }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('添加至可重用区块')), isModalOpen && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["Modal"], {
      title: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('创建可重用区块'),
      closeLabel: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('关闭'),
      onRequestClose: () => {
    ...
    }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["TextControl"], {
      label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('显示名称'),
      value: title,
      onChange: setTitle
    }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["Flex"], {
      className: "reusable-blocks-menu-items__convert-modal-actions",
      justify: "flex-end"
    }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["FlexItem"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["Button"], {
      variant: "secondary",
      onClick: () => {
        setIsModalOpen(false);
        setTitle('');
      }
    }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('取消'))), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["FlexItem"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["Button"], {
      variant: "primary",
      type: "submit"
    }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('保存')))))));
  });
}
...
/***/ "./node_modules/@gechiui/reusable-blocks/build-module/components/reusable-blocks-menu-items/reusable-blocks-manage-button.js":
/*!***********************************************************************************************************************************!*\
  !*** ./node_modules/@gechiui/reusable-blocks/build-module/components/reusable-blocks-menu-items/reusable-blocks-manage-button.js ***!
  \***********************************************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/reusable-blocks/build-module/store/index.js");
...
function ReusableBlocksManageButton(_ref) {
  ...
  const {
    ...
    const {
      canUser
    } = select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_7__["store"]);
    const reusableBlock = getBlock(clientId);
    return {
      isVisible: !!reusableBlock && Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_3__["isReusableBlock"])(reusableBlock) && !!canUser('update', 'blocks', reusableBlock.attributes.ref)
    };
  }, [clientId]);
  const {
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_5__["BlockSettingsMenuControls"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_1__["MenuItem"], {
    href: Object(_gechiui_url__WEBPACK_IMPORTED_MODULE_6__["addQueryArgs"])('edit.php', {
      post_type: 'gc_block'
    })
  }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('管理可重用区块')), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_1__["MenuItem"], {
    onClick: () => convertBlockToStatic(clientId)
  }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('转换为常规区块')));
}
...
/***/ "./node_modules/@gechiui/reusable-blocks/build-module/index.js":
/*!*********************************************************************!*\
  !*** ./node_modules/@gechiui/reusable-blocks/build-module/index.js ***!
  \*********************************************************************/
/*! exports provided: store, ReusableBlocksMenuItems */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./store */ "./node_modules/@gechiui/reusable-blocks/build-module/store/index.js");
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components */ "./node_modules/@gechiui/reusable-blocks/build-module/components/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ReusableBlocksMenuItems", function() { return _components__WEBPACK_IMPORTED_MODULE_1__["ReusableBlocksMenuItems"]; });
...
/***/ "./node_modules/@gechiui/reusable-blocks/build-module/store/actions.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@gechiui/reusable-blocks/build-module/store/actions.js ***!
  \*****************************************************************************/
...
const __experimentalConvertBlockToStatic = clientId => _ref => {
  ...
  const oldBlock = registry.select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["store"]).getBlock(clientId);
  const reusableBlock = registry.select('core').getEditedEntityRecord('postType', 'gc_block', oldBlock.attributes.ref);
  const newBlocks = Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_2__["parse"])(Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isFunction"])(reusableBlock.content) ? reusableBlock.content(reusableBlock) : reusableBlock.content);
  registry.dispatch(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["store"]).replaceBlocks(oldBlock.clientId, newBlocks);
};
/**
...
const __experimentalConvertBlocksToReusable = (clientIds, title) => async _ref2 => {
  ...
  const reusableBlock = {
    title: title || Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('未命名可重用区块'),
    content: Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_2__["serialize"])(registry.select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["store"]).getBlocksByClientId(clientIds)),
    status: 'publish'
  };
  const updatedRecord = await registry.dispatch('core').saveEntityRecord('postType', 'gc_block', reusableBlock);
  const newBlock = Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_2__["createBlock"])('core/block', {
    ref: updatedRecord.id
  });
  registry.dispatch(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["store"]).replaceBlocks(clientIds, newBlock);
...
const __experimentalDeleteReusableBlock = id => async _ref3 => {
  ...
  const allBlocks = registry.select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["store"]).getBlocks();
  const associatedBlocks = allBlocks.filter(block => Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_2__["isReusableBlock"])(block) && block.attributes.ref === id);
  const associatedBlockClientIds = associatedBlocks.map(block => block.clientId); // Remove the parsed block.

  if (associatedBlockClientIds.length) {
    registry.dispatch(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["store"]).removeBlocks(associatedBlockClientIds);
  }
...
/***/ "./node_modules/@gechiui/reusable-blocks/build-module/store/index.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@gechiui/reusable-blocks/build-module/store/index.js ***!
  \***************************************************************************/
...
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./actions */ "./node_modules/@gechiui/reusable-blocks/build-module/store/actions.js");
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reducer */ "./node_modules/@gechiui/reusable-blocks/build-module/store/reducer.js");
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./selectors */ "./node_modules/@gechiui/reusable-blocks/build-module/store/selectors.js");
/**
 * GeChiUI dependencies
 */
...
/***/ "./node_modules/@gechiui/reusable-blocks/build-module/store/reducer.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@gechiui/reusable-blocks/build-module/store/reducer.js ***!
  \*****************************************************************************/
...
/***/ "./node_modules/@gechiui/reusable-blocks/build-module/store/selectors.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/@gechiui/reusable-blocks/build-module/store/selectors.js ***!
  \*******************************************************************************/
