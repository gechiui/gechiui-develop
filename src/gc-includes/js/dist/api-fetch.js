...
const defaultFetchHandler = nextOptions => {
  ...
  return responsePromise.then(value => Promise.resolve(value).then(checkStatus).catch(response => Object(_utils_response__WEBPACK_IMPORTED_MODULE_9__["parseAndThrowError"])(response, parse)).then(response => Object(_utils_response__WEBPACK_IMPORTED_MODULE_9__["parseResponseAndNormalizeError"])(response, parse)), err => {
    ...
    throw {
      code: 'fetch_error',
      message: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('您可能已经掉线。')
    };
  });
};
/** @type {FetchHandler} */
    ...
    if (response.status >= 500 && response.status < 600 && attachmentId) {
      return postProcess(attachmentId).catch(() => {
        if (options.parse !== false) {
          return Promise.reject({
            code: 'post_process',
            message: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('媒体上传失败。如果这是一张较大的照片或图片，请将其缩小并重新上传。')
          });
        }
...
const parseJsonAndNormalizeError = response => {
  const invalidJsonError = {
    code: 'invalid_json',
    message: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('此响应不是合法的JSON响应。')
  };
...
function parseAndThrowError(response) {
  ...
  return parseJsonAndNormalizeError(response).then(error => {
    const unknownError = {
      code: 'unknown_error',
      message: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('发生了未知错误。')
    };
