...
/***/ "./node_modules/@gechiui/date/build-module/index.js":
/*!**********************************************************!*\
  !*** ./node_modules/@gechiui/date/build-module/index.js ***!
  \**********************************************************/
...
const GC_ZONE = 'GC'; // This regular expression tests positive for UTC offsets as described in ISO 8601.
...
function isInTheFuture(dateValue) {
  const now = moment__WEBPACK_IMPORTED_MODULE_0___default.a.tz(GC_ZONE);
  const momentObject = moment__WEBPACK_IMPORTED_MODULE_0___default.a.tz(dateValue, GC_ZONE);
...
function getDate(dateString) {
  if (!dateString) {
    return moment__WEBPACK_IMPORTED_MODULE_0___default.a.tz(GC_ZONE).toDate();
  }

  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.tz(dateString, GC_ZONE).toDate();
}
/**
