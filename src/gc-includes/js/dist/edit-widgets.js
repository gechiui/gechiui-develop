...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/@gechiui/edit-widgets/build-module/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/index.js":
/*!******************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/index.js ***!
  \******************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WidgetAreaEdit; });
...
/* harmony import */ var _inner_blocks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./inner-blocks */ "./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/inner-blocks.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
/* harmony import */ var _use_is_dragging_within__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./use-is-dragging-within */ "./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/use-is-dragging-within.js");
...
function WidgetAreaEdit(_ref) {
  ...
  const isOpen = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["useSelect"])(select => select(_store__WEBPACK_IMPORTED_MODULE_5__["store"]).getIsWidgetAreaOpen(clientId), [clientId]);
  const {
    setIsWidgetAreaOpen
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_5__["store"]);
  const wrapper = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useRef"])();
  const setOpen = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(openState => setIsWidgetAreaOpen(clientId, openState), [clientId]);
  const isDragging = useIsDragging(wrapper);
  const isDraggingWithin = Object(_use_is_dragging_within__WEBPACK_IMPORTED_MODULE_6__["default"])(wrapper);
  const [openedWhileDragging, setOpenedWhileDragging] = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["Panel"], {
    className: className,
    ref: wrapper
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["PanelBody"], {
    title: name,
    opened: isOpen,
    onToggle: () => {
    ...
    return (// This is required to ensure LegacyWidget blocks are not
      ...
      Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["__unstableDisclosureContent"], {
        className: "gc-block-widget-area__panel-body-content",
        visible: opened
      }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_2__["EntityProvider"], {
        kind: "root",
        type: "postType",
        id: `widget-area-${id}`
      }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_inner_blocks__WEBPACK_IMPORTED_MODULE_4__["default"], {
        id: id
      })))
    );
  }));
...
const useIsDragging = elementRef => {
  const [isDragging, setIsDragging] = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
  Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    const {
      ownerDocument
    } = elementRef.current;
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/inner-blocks.js":
/*!*************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/inner-blocks.js ***!
  \*************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WidgetAreaInnerBlocks; });
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/element */ "@gechiui/element");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _use_is_dragging_within__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./use-is-dragging-within */ "./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/use-is-dragging-within.js");
...
function WidgetAreaInnerBlocks(_ref) {
  ...
  const [blocks, onInput, onChange] = Object(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_2__["useEntityBlockEditor"])('root', 'postType');
  const innerBlocksRef = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useRef"])();
  const isDraggingWithinInnerBlocks = Object(_use_is_dragging_within__WEBPACK_IMPORTED_MODULE_4__["default"])(innerBlocksRef);
  ...
  const innerBlocksProps = Object(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_3__["useInnerBlocksProps"])({
    ref: innerBlocksRef
  }, {
    value: blocks,
    onInput,
    onChange,
    templateLock: false,
    renderAppender: _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_3__["InnerBlocks"].ButtonBlockAppender
  });
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    "data-widget-area-id": id,
    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('gc-block-widget-area__inner-blocks block-editor-inner-blocks editor-styles-wrapper', {
      'gc-block-widget-area__highlight-drop-zone': shouldHighlightDropZone
    })
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", innerBlocksProps));
}


/***/ }),

/***/ "./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/use-is-dragging-within.js":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/use-is-dragging-within.js ***!
  \***********************************************************************************************************/
/*! exports provided: default */
...
const useIsDraggingWithin = elementRef => {
  const [isDraggingWithin, setIsDraggingWithin] = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useState"])(false);
  Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    const {
      ownerDocument
    } = elementRef.current;
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/index.js":
/*!*************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/index.js ***!
  \*************************************************************************************/
...
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/edit/index.js");
/**
 * GeChiUI dependencies
 */
...
const settings = {
  title: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('小工具区域'),
  description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('小工具区域容器。'),
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/error-boundary/index.js":
/*!********************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/error-boundary/index.js ***!
  \********************************************************************************************/
/*! exports provided: default */
...
class ErrorBoundary extends _gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  render() {
    ...
    return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_3__["Warning"], {
      ...
      actions: [Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["Button"], {
        key: "recovery",
        onClick: this.reboot,
        variant: "secondary"
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('尝试恢复')), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(CopyButton, {
        key: "copy-error",
        text: error.stack
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('复制错误'))]
    }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('编辑器遇到了未知错误。'));
  }
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/header/index.js":
/*!************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/header/index.js ***!
  \************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_compose__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @gechiui/compose */ "@gechiui/compose");
/* harmony import */ var _gechiui_compose__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_gechiui_compose__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _save_button__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../save-button */ "./node_modules/@gechiui/edit-widgets/build-module/components/save-button/index.js");
/* harmony import */ var _undo_redo_undo__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./undo-redo/undo */ "./node_modules/@gechiui/edit-widgets/build-module/components/header/undo-redo/undo.js");
/* harmony import */ var _undo_redo_redo__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./undo-redo/redo */ "./node_modules/@gechiui/edit-widgets/build-module/components/header/undo-redo/redo.js");
/* harmony import */ var _more_menu__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../more-menu */ "./node_modules/@gechiui/edit-widgets/build-module/components/more-menu/index.js");
/* harmony import */ var _hooks_use_last_selected_widget_area__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../hooks/use-last-selected-widget-area */ "./node_modules/@gechiui/edit-widgets/build-module/hooks/use-last-selected-widget-area.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
...
function Header() {
  const isMediumViewport = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_7__["useViewportMatch"])('medium');
  const inserterButton = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useRef"])();
  const widgetAreaClientId = Object(_hooks_use_last_selected_widget_area__WEBPACK_IMPORTED_MODULE_12__["default"])();
  const isLastSelectedWidgetAreaOpen = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["useSelect"])(select => select(_store__WEBPACK_IMPORTED_MODULE_13__["store"]).getIsWidgetAreaOpen(widgetAreaClientId), [widgetAreaClientId]);
  const {
    isInserterOpen,
    isListViewOpen
  ...
  const {
    ...
    setIsInserterOpened,
    setIsListViewOpened
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_13__["store"]);
  const {
    selectBlock
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["useDispatch"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__["store"]);
  ...
  const toggleListView = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(() => setIsListViewOpened(!isListViewOpen), [setIsListViewOpened, isListViewOpen]);
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
  ...
  }, isMediumViewport && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h1", {
    className: "edit-widgets-header__title"
  }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('小工具')), !isMediumViewport && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["VisuallyHidden"], {
    as: "h1",
    className: "edit-widgets-header__title"
  }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('小工具')), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__["NavigableToolbar"], {
    className: "edit-widgets-header-toolbar",
    "aria-label": Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('文档工具')
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["ToolbarItem"], {
    ref: inserterButton,
    ...
    characters. */
    ,
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Toggle block inserter', 'Generic label for block inserter button')
  }), isMediumViewport && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_undo_redo_undo__WEBPACK_IMPORTED_MODULE_9__["default"], null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_undo_redo_redo__WEBPACK_IMPORTED_MODULE_10__["default"], null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["ToolbarItem"], {
    as: _gechiui_components__WEBPACK_IMPORTED_MODULE_3__["Button"],
    className: "edit-widgets-header-toolbar__list-view-toggle",
    icon: _gechiui_icons__WEBPACK_IMPORTED_MODULE_6__["listView"],
    isPressed: isListViewOpen
    /* translators: button label text should, if possible, be under 16 characters. */
    ,
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('列表视图'),
    onClick: toggleListView
  })))), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "edit-widgets-header__actions"
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_save_button__WEBPACK_IMPORTED_MODULE_8__["default"], null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_5__["PinnedItems"].Slot, {
    scope: "core/edit-widgets"
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_more_menu__WEBPACK_IMPORTED_MODULE_11__["default"], null))));
}
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/header/undo-redo/redo.js":
/*!*********************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/header/undo-redo/redo.js ***!
  \*********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RedoButton; });
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/element */ "@gechiui/element");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/i18n */ "@gechiui/i18n");
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @gechiui/core-data */ "@gechiui/core-data");
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_6__);
...
function RedoButton() {
  const hasRedo = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__["useSelect"])(select => select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_6__["store"]).hasRedo(), []);
  const {
    redo
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__["useDispatch"])(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_6__["store"]);
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["ToolbarButton"], {
    icon: !Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? _gechiui_icons__WEBPACK_IMPORTED_MODULE_4__["redo"] : _gechiui_icons__WEBPACK_IMPORTED_MODULE_4__["undo"],
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('重做'),
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/header/undo-redo/undo.js":
/*!*********************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/header/undo-redo/undo.js ***!
  \*********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UndoButton; });
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/element */ "@gechiui/element");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/i18n */ "@gechiui/i18n");
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__);
...
function UndoButton() {
  const hasUndo = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__["useSelect"])(select => select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_6__["store"]).hasUndo(), []);
  const {
    undo
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__["useDispatch"])(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_6__["store"]);
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["ToolbarButton"], {
    icon: !Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__["isRTL"])() ? _gechiui_icons__WEBPACK_IMPORTED_MODULE_4__["undo"] : _gechiui_icons__WEBPACK_IMPORTED_MODULE_4__["redo"],
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('撤销'),
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/config.js":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/config.js ***!
  \***********************************************************************************************************/
...
const textFormattingShortcuts = [{
  ...
  description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('将选定的文字加粗。')
}, {
  keyCombination: {
    modifier: 'primary',
    character: 'i'
  },
  description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('将选定的文字设为斜体。')
}, {
  keyCombination: {
    modifier: 'primary',
    character: 'k'
  },
  description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('将选定的文字转换为链接。')
}, {
  keyCombination: {
    modifier: 'primaryShift',
    character: 'k'
  },
  description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('移除链接。')
}, {
  keyCombination: {
    modifier: 'primary',
    character: 'u'
  },
  description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('给选定的文字加下划线。')
}];


/***/ }),

/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/dynamic-shortcut.js":
/*!*********************************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/dynamic-shortcut.js ***!
  \*********************************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _shortcut__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shortcut */ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/shortcut.js");
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/index.js":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/index.js ***!
  \**********************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./config */ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/config.js");
/* harmony import */ var _shortcut__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shortcut */ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/shortcut.js");
/* harmony import */ var _dynamic_shortcut__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./dynamic-shortcut */ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/dynamic-shortcut.js");
...
function KeyboardShortcutHelpModal(_ref4) {
  ...
  Object(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_5__["useShortcut"])('core/edit-widgets/keyboard-shortcuts', toggleModal, {
    bindGlobal: true
  });
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["Modal"], {
    ...
    title: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('键盘快捷键'),
    closeLabel: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('关闭'),
    ...
    title: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('全局快捷键'),
    categoryName: "global"
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(ShortcutCategorySection, {
    title: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('选定快捷键'),
    categoryName: "selection"
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(ShortcutCategorySection, {
    title: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('区块快捷键'),
    categoryName: "block",
    additionalShortcuts: [{
      keyCombination: {
        character: '/'
      },
      description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('在添加新段落后修改区块类型。'),

      /* translators: The forward-slash character. e.g. '/'. */
      ariaLabel: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('正斜杠')
    }]
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(ShortcutSection, {
    title: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('文字内容格式化'),
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/shortcut.js":
/*!*************************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/shortcut.js ***!
  \*************************************************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcuts/index.js":
/*!************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcuts/index.js ***!
  \************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @gechiui/core-data */ "@gechiui/core-data");
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
/**
 * GeChiUI dependencies
 */
...
function KeyboardShortcuts() {
  const {
    redo,
    undo
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_2__["useDispatch"])(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]);
  const {
    saveEditedWidgetAreas
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_2__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_5__["store"]);
  Object(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_1__["useShortcut"])('core/edit-widgets/undo', event => {
    undo();
    event.preventDefault();
  });
  Object(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_1__["useShortcut"])('core/edit-widgets/redo', event => {
    redo();
    event.preventDefault();
  });
  Object(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_1__["useShortcut"])('core/edit-widgets/save', event => {
    event.preventDefault();
    saveEditedWidgetAreas();
  });
  return null;
...
function KeyboardShortcutsRegister() {
  ...
  Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    registerShortcut({
      ...
      category: 'global',
      description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('撤销您的上一个更改。'),
      keyCombination: {
        modifier: 'primary',
        character: 'z'
      }
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('重做您撤销的操作。'),
      keyCombination: {
        modifier: 'primaryShift',
        character: 'z'
      }
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('保存您的更改。'),
      keyCombination: {
        modifier: 'primary',
        character: 's'
      }
    ...
    registerShortcut({
      ...
      category: 'main',
      description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('显示这些键盘快捷键。'),
      keyCombination: {
        modifier: 'access',
        character: 'h'
      }
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('导航至编辑器的下一个功能区域。'),
      keyCombination: {
        modifier: 'ctrl',
        character: '`'
      },
    ...
    registerShortcut({
      ...
      category: 'global',
      description: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('导航至编辑器的上一个功能区域。'),
      keyCombination: {
        modifier: 'ctrlShift',
        character: '`'
      },
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/layout/index.js":
/*!************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/layout/index.js ***!
  \************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_plugins__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @gechiui/plugins */ "@gechiui/plugins");
/* harmony import */ var _gechiui_plugins__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_gechiui_plugins__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _error_boundary__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../error-boundary */ "./node_modules/@gechiui/edit-widgets/build-module/components/error-boundary/index.js");
/* harmony import */ var _widget_areas_block_editor_provider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../widget-areas-block-editor-provider */ "./node_modules/@gechiui/edit-widgets/build-module/components/widget-areas-block-editor-provider/index.js");
/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../sidebar */ "./node_modules/@gechiui/edit-widgets/build-module/components/sidebar/index.js");
/* harmony import */ var _interface__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./interface */ "./node_modules/@gechiui/edit-widgets/build-module/components/layout/interface.js");
/* harmony import */ var _unsaved_changes_warning__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./unsaved-changes-warning */ "./node_modules/@gechiui/edit-widgets/build-module/components/layout/unsaved-changes-warning.js");
/* harmony import */ var _welcome_guide__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../welcome-guide */ "./node_modules/@gechiui/edit-widgets/build-module/components/welcome-guide/index.js");
...
function Layout(_ref) {
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_error_boundary__WEBPACK_IMPORTED_MODULE_3__["default"], {
    onError: onError
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_widget_areas_block_editor_provider__WEBPACK_IMPORTED_MODULE_4__["default"], {
    blockEditorSettings: blockEditorSettings
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_interface__WEBPACK_IMPORTED_MODULE_6__["default"], {
    blockEditorSettings: blockEditorSettings
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_sidebar__WEBPACK_IMPORTED_MODULE_5__["default"], null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_1__["Popover"].Slot, null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_plugins__WEBPACK_IMPORTED_MODULE_2__["PluginArea"], null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_unsaved_changes_warning__WEBPACK_IMPORTED_MODULE_7__["default"], null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_welcome_guide__WEBPACK_IMPORTED_MODULE_8__["default"], null)));
}
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/layout/interface.js":
/*!****************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/layout/interface.js ***!
  \****************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @gechiui/keyboard-shortcuts */ "@gechiui/keyboard-shortcuts");
/* harmony import */ var _gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _header__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../header */ "./node_modules/@gechiui/edit-widgets/build-module/components/header/index.js");
/* harmony import */ var _widget_areas_block_editor_content__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../widget-areas-block-editor-content */ "./node_modules/@gechiui/edit-widgets/build-module/components/widget-areas-block-editor-content/index.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
/* harmony import */ var _secondary_sidebar__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../secondary-sidebar */ "./node_modules/@gechiui/edit-widgets/build-module/components/secondary-sidebar/index.js");
...
const interfaceLabels = {
  ...
  header: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('小工具顶部栏'),

  /* translators: accessibility text for the widgets screen content landmark region. */
  body: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('小工具与区块'),

  /* translators: accessibility text for the widgets screen settings landmark region. */
  sidebar: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('小工具设置'),

  /* translators: accessibility text for the widgets screen footer landmark region. */
  footer: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('小工具页脚')
};
...
function Interface(_ref) {
  ...
  const isMobileViewport = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_1__["useViewportMatch"])('medium', '<');
  const isHugeViewport = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_1__["useViewportMatch"])('huge', '>=');
  const {
    setIsInserterOpened,
    setIsListViewOpened,
    closeGeneralSidebar
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_9__["store"]);
  const {
    ...
    hasSidebarEnabled: !!select(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["store"]).getActiveComplementaryArea(_store__WEBPACK_IMPORTED_MODULE_9__["store"].name),
    ...
    hasBlockBreadCrumbsEnabled: select(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["store"]).isFeatureActive('core/edit-widgets', 'showBlockBreadcrumbs'),
    previousShortcut: select(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_6__["store"]).getAllShortcutKeyCombinations('core/edit-widgets/previous-region'),
    nextShortcut: select(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_6__["store"]).getAllShortcutKeyCombinations('core/edit-widgets/next-region')
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["InterfaceSkeleton"], {
    labels: interfaceLabels,
    header: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_header__WEBPACK_IMPORTED_MODULE_7__["default"], null),
    secondarySidebar: hasSecondarySidebar && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_secondary_sidebar__WEBPACK_IMPORTED_MODULE_10__["default"], null),
    sidebar: hasSidebarEnabled && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["ComplementaryArea"].Slot, {
      scope: "core/edit-widgets"
    }),
    content: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_widget_areas_block_editor_content__WEBPACK_IMPORTED_MODULE_8__["default"], {
      blockEditorSettings: blockEditorSettings
    }),
    footer: hasBlockBreadCrumbsEnabled && !isMobileViewport && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
      className: "edit-widgets-layout__footer"
    }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_2__["BlockBreadcrumb"], {
      rootLabelText: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('小工具')
    })),
    shortcuts: {
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/layout/unsaved-changes-warning.js":
/*!******************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/layout/unsaved-changes-warning.js ***!
  \******************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UnsavedChangesWarning; });
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/i18n */ "@gechiui/i18n");
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
/**
 * GeChiUI dependencies
 */
...
function UnsavedChangesWarning() {
  const isDirty = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_2__["useSelect"])(select => {
    const {
  ...
  Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    ...
    const warnIfUnsavedChanges = event => {
      if (isDirty) {
        event.returnValue = Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('您有未保存的修改。如果您继续，这些修改将会丢失。');
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/more-menu/index.js":
/*!***************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/more-menu/index.js ***!
  \***************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_compose__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @gechiui/compose */ "@gechiui/compose");
/* harmony import */ var _gechiui_compose__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_gechiui_compose__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _keyboard_shortcut_help_modal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../keyboard-shortcut-help-modal */ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcut-help-modal/index.js");
...
function MoreMenu() {
  ...
  Object(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_6__["useShortcut"])('core/edit-widgets/keyboard-shortcuts', toggleKeyboardShortcutsModal);
  const isLargeViewport = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_7__["useViewportMatch"])('medium');
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["MoreMenuDropdown"], null, () => Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, isLargeViewport && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_1__["MenuGroup"], {
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('View', 'noun')
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["MoreMenuFeatureToggle"], {
    scope: "core/edit-widgets",
    feature: "fixedToolbar",
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('顶部工具栏'),
    info: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('在一个位置访问所有的区块和文档工具'),
    messageActivated: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('顶部工具栏已启用'),
    messageDeactivated: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('顶部工具栏已禁用')
    ...
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('工具')
    ...
    shortcut: _gechiui_keycodes__WEBPACK_IMPORTED_MODULE_5__["displayShortcut"].access('h')
  }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('键盘快捷键')), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["MoreMenuFeatureToggle"], {
    scope: "core/edit-widgets",
    feature: "welcomeGuide",
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('欢迎指南')
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_1__["MenuItem"], {
    role: "menuitem",
  ...
  }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('帮助'), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_1__["VisuallyHidden"], {
    as: "span"
  },
  /* translators: accessibility text */
  Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('（在新窗口中打开）')))), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_1__["MenuGroup"], {
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('偏好设置')
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["MoreMenuFeatureToggle"], {
    scope: "core/edit-widgets",
    feature: "keepCaretInsideBlock",
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('在区块内包含文本光标'),
    info: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('通过阻止光标离开区块来帮助屏幕阅读器。'),
    messageActivated: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('启用区块内的文本光标'),
    messageDeactivated: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('禁用区块内的文本光标')
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["MoreMenuFeatureToggle"], {
    scope: "core/edit-widgets",
    feature: "themeStyles",
    info: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('使编辑器看起来像您的主题。'),
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('使用主题样式')
  }), isLargeViewport && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["MoreMenuFeatureToggle"], {
    scope: "core/edit-widgets",
    feature: "showBlockBreadcrumbs",
    label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('显示区块面包屑'),
    info: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('在编辑器的底部显示区块的面包屑。'),
    messageActivated: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('显示区块面包屑已启用'),
    messageDeactivated: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('显示区块面包屑已禁用')
  })))), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_keyboard_shortcut_help_modal__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/notices/index.js":
/*!*************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/notices/index.js ***!
  \*************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _gechiui_notices__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @gechiui/notices */ "@gechiui/notices");
/* harmony import */ var _gechiui_notices__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_gechiui_notices__WEBPACK_IMPORTED_MODULE_4__);
...
function Notices() {
  const {
    removeNotice
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__["useDispatch"])(_gechiui_notices__WEBPACK_IMPORTED_MODULE_4__["store"]);
  const {
    notices
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__["useSelect"])(select => {
    return {
      notices: select(_gechiui_notices__WEBPACK_IMPORTED_MODULE_4__["store"]).getNotices()
    };
  }, []);
  const dismissibleNotices = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["filter"])(notices, {
    isDismissible: true,
    type: 'default'
  });
  const nonDismissibleNotices = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["filter"])(notices, {
    isDismissible: false,
    type: 'default'
  });
  const snackbarNotices = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["filter"])(notices, {
    type: 'snackbar'
  });
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["NoticeList"], {
    notices: nonDismissibleNotices,
    className: "edit-widgets-notices__pinned"
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["NoticeList"], {
    notices: dismissibleNotices,
    className: "edit-widgets-notices__dismissible",
    onRemove: removeNotice
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["SnackbarList"], {
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/save-button/index.js":
/*!*****************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/save-button/index.js ***!
  \*****************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
...
function SaveButton() {
  ...
  const {
    saveEditedWidgetAreas
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_4__["store"]);
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_1__["Button"], {
    variant: "primary",
    isBusy: isSaving,
    "aria-disabled": isSaving,
    onClick: isSaving ? undefined : saveEditedWidgetAreas,
    disabled: !hasEditedWidgetAreaIds
  }, isSaving ? Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('正在保存…') : Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('更新'));
}
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/secondary-sidebar/index.js":
/*!***********************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/secondary-sidebar/index.js ***!
  \***********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SecondarySidebar; });
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/element */ "@gechiui/element");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
/* harmony import */ var _inserter_sidebar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inserter-sidebar */ "./node_modules/@gechiui/edit-widgets/build-module/components/secondary-sidebar/inserter-sidebar.js");
/* harmony import */ var _list_view_sidebar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./list-view-sidebar */ "./node_modules/@gechiui/edit-widgets/build-module/components/secondary-sidebar/list-view-sidebar.js");
...
function SecondarySidebar() {
  ...
  if (isInserterOpen) {
    return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_inserter_sidebar__WEBPACK_IMPORTED_MODULE_3__["default"], null);
  }

  if (isListViewOpen) {
    return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_list_view_sidebar__WEBPACK_IMPORTED_MODULE_4__["default"], null);
  }
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/secondary-sidebar/inserter-sidebar.js":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/secondary-sidebar/inserter-sidebar.js ***!
  \**********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return InserterSidebar; });
...
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _hooks_use_widget_library_insertion_point__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../hooks/use-widget-library-insertion-point */ "./node_modules/@gechiui/edit-widgets/build-module/hooks/use-widget-library-insertion-point.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
...
function InserterSidebar() {
  const isMobileViewport = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_5__["useViewportMatch"])('medium', '<');
  const {
    rootClientId,
    insertionIndex
  } = Object(_hooks_use_widget_library_insertion_point__WEBPACK_IMPORTED_MODULE_7__["default"])();
  const {
    setIsInserterOpened
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_6__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_8__["store"]);
  const closeInserter = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(() => {
    return () => setIsInserterOpened(false);
  }, [setIsInserterOpened]);
  const [inserterDialogRef, inserterDialogProps] = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_5__["__experimentalUseDialog"])({
    onClose: closeInserter
  });
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
  ...
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["Button"], {
    icon: _gechiui_icons__WEBPACK_IMPORTED_MODULE_3__["close"],
    onClick: closeInserter
  })), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "edit-widgets-layout__inserter-panel-content"
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__["__experimentalLibrary"], {
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/secondary-sidebar/list-view-sidebar.js":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/secondary-sidebar/list-view-sidebar.js ***!
  \***********************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ListViewSidebar; });
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/element */ "@gechiui/element");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _gechiui_icons__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @gechiui/icons */ "./node_modules/@gechiui/icons/build-module/index.js");
/* harmony import */ var _gechiui_keycodes__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @gechiui/keycodes */ "@gechiui/keycodes");
/* harmony import */ var _gechiui_keycodes__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_gechiui_keycodes__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
...
function ListViewSidebar() {
  const {
    setIsListViewOpened
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_4__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_8__["store"]);
  const {
    clearSelectedBlock,
    selectBlock
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_4__["useDispatch"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["store"]);
  ...
  const focusOnMountRef = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_3__["useFocusOnMount"])('firstElement');
  const focusReturnRef = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_3__["useFocusReturn"])();

  function closeOnEscape(event) {
    if (event.keyCode === _gechiui_keycodes__WEBPACK_IMPORTED_MODULE_7__["ESCAPE"] && !event.defaultPrevented) {
      event.preventDefault();
      setIsListViewOpened(false);
    }
  }

  const instanceId = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_3__["useInstanceId"])(ListViewSidebar);
  ...
  return (// eslint-disable-next-line jsx-a11y/no-static-element-interactions
    ...
    }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("strong", {
      id: labelId
    }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('列表视图')), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["Button"], {
      icon: _gechiui_icons__WEBPACK_IMPORTED_MODULE_6__["closeSmall"],
      label: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('关闭列表试图边栏'),
      onClick: () => setIsListViewOpened(false)
    })), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
      className: "edit-widgets-editor__list-view-panel-content",
      ref: Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_3__["useMergeRefs"])([focusReturnRef, focusOnMountRef])
    }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["__experimentalListView"], {
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/sidebar/index.js":
/*!*************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/sidebar/index.js ***!
  \*************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @gechiui/i18n */ "@gechiui/i18n");
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _gechiui_interface__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/interface */ "./node_modules/@gechiui/interface/build-module/index.js");
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @gechiui/block-editor */ "@gechiui/block-editor");
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _gechiui_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @gechiui/icons */ "./node_modules/@gechiui/icons/build-module/index.js");
/* harmony import */ var _gechiui_components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @gechiui/components */ "@gechiui/components");
/* harmony import */ var _gechiui_components__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_gechiui_components__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _widget_areas__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./widget-areas */ "./node_modules/@gechiui/edit-widgets/build-module/components/sidebar/widget-areas.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
...
const SIDEBAR_ACTIVE_BY_DEFAULT = _gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Platform"].select({
  web: true,
  native: false
});
...
function ComplementaryAreaTab(_ref) {
  ...
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_7__["useDispatch"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_3__["store"]);
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_6__["Button"], {
    onClick: () => enableComplementaryArea(_store__WEBPACK_IMPORTED_MODULE_9__["store"].name, identifier),
    ...
    Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["sprintf"])(Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('%s（已选）'), label) : label,
    "data-label": label
  }, label);
}
...
function Sidebar() {
  ...
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_7__["useSelect"])(select => {
    const {
      getSelectedBlock,
      getBlock,
      getBlockParentsByBlockName
    } = select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__["store"]);
    const {
      getActiveComplementaryArea
    } = select(_gechiui_interface__WEBPACK_IMPORTED_MODULE_3__["store"]);
    const selectedBlock = getSelectedBlock();
    const activeArea = getActiveComplementaryArea(_store__WEBPACK_IMPORTED_MODULE_9__["store"].name);
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_3__["ComplementaryArea"], {
    className: "edit-widgets-sidebar",
    header: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("ul", null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(ComplementaryAreaTab, {
      identifier: WIDGET_AREAS_IDENTIFIER,
      label: selectedWidgetAreaBlock ? selectedWidgetAreaBlock.attributes.name : Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('小工具区域'),
      isActive: currentArea === WIDGET_AREAS_IDENTIFIER
    })), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(ComplementaryAreaTab, {
    ...
    /* translators: button label text should, if possible, be under 16 characters. */
    ,
    title: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('设置'),
    closeLabel: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('关闭设置'),
    scope: "core/edit-widgets",
    identifier: currentArea,
    icon: _gechiui_icons__WEBPACK_IMPORTED_MODULE_5__["cog"],
    isActiveByDefault: SIDEBAR_ACTIVE_BY_DEFAULT
  }, currentArea === WIDGET_AREAS_IDENTIFIER && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_widget_areas__WEBPACK_IMPORTED_MODULE_8__["default"], {
  ...
  }), currentArea === BLOCK_INSPECTOR_IDENTIFIER && (hasSelectedNonAreaBlock ? Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__["BlockInspector"], null) : // Pretend that Widget Areas are part of the UI by not
  // showing the Block Inspector when one is selected.
  Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("span", {
    className: "block-editor-block-inspector__no-blocks"
  }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('未选择区块。'))));
}


/***/ }),

/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/sidebar/widget-areas.js":
/*!********************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/sidebar/widget-areas.js ***!
  \********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WidgetAreas; });
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/element */ "@gechiui/element");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _gechiui_icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @gechiui/icons */ "./node_modules/@gechiui/icons/build-module/index.js");
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/block-editor */ "@gechiui/block-editor");
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _gechiui_dom__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @gechiui/dom */ "@gechiui/dom");
/* harmony import */ var _gechiui_dom__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_gechiui_dom__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
...
function WidgetAreas(_ref) {
  ...
  const widgetAreas = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["useSelect"])(select => select(_store__WEBPACK_IMPORTED_MODULE_8__["store"]).getWidgetAreas(), []);
  const selectedWidgetArea = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => selectedWidgetAreaId && (widgetAreas === null || widgetAreas === void 0 ? void 0 : widgetAreas.find(widgetArea => widgetArea.id === selectedWidgetAreaId)), [selectedWidgetAreaId, widgetAreas]);
  let description;

  if (!selectedWidgetArea) {
    description = Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('小工具区域是站点布局中可以支持区块的全局部分。这些区域因主题而异，但通常都是您的边栏或页脚部分。');
  } else if (selectedWidgetAreaId === 'gc_inactive_widgets') {
    description = Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('此小工具区域中的区块将不会显示在您的站点中。');
  } else {
  ...
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_3__["BlockIcon"], {
    icon: _gechiui_icons__WEBPACK_IMPORTED_MODULE_2__["blockDefault"]
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", {
    // Use `dangerouslySetInnerHTML` to keep backwards
    // compatibility. Basic markup in the description is an
    // established feature of GeChiUI.
    // @see https://github.com/GeChiUI/gutenberg/issues/33106
    dangerouslySetInnerHTML: {
      __html: Object(_gechiui_dom__WEBPACK_IMPORTED_MODULE_7__["safeHTML"])(description)
    }
  }), (widgetAreas === null || widgetAreas === void 0 ? void 0 : widgetAreas.length) === 0 && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", null, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('您的主题不包含任何小工具区域。')), !selectedWidgetArea && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_4__["Button"], {
    href: Object(_gechiui_url__WEBPACK_IMPORTED_MODULE_6__["addQueryArgs"])('customize.php', {
      'autofocus[panel]': 'widgets',
      return: window.location.pathname
    }),
    variant: "tertiary"
  }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('使用实时预览进行管理')))));
}


/***/ }),

/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/welcome-guide/index.js":
/*!*******************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/welcome-guide/index.js ***!
  \*******************************************************************************************/
/*! exports provided: default */
...
function WelcomeGuide() {
  ...
  const isActive = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["useSelect"])(select => select(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["store"]).isFeatureActive('core/edit-widgets', 'welcomeGuide'), []);
  const {
    toggleFeature
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["useDispatch"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_4__["store"]);
  const widgetAreas = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["useSelect"])(select => select(_store__WEBPACK_IMPORTED_MODULE_5__["store"]).getWidgetAreas({
    per_page: -1
  }), []);
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["Guide"], {
    className: "edit-widgets-welcome-guide",
    contentLabel: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('欢迎来到区块小工具'),
    finishButtonText: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('从这里开始'),
    onFinish: () => toggleFeature('core/edit-widgets', 'welcomeGuide'),
    pages: [{
      image: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(WelcomeGuideImage, {
        nonAnimatedSrc: "https://s.w.org/images/block-editor/welcome-canvas.svg",
        animatedSrc: "https://s.w.org/images/block-editor/welcome-canvas.gif"
      }),
      content: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h1", {
        className: "edit-widgets-welcome-guide__heading"
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('欢迎来到区块小工具')), isEntirelyBlockWidgets ? Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", {
        className: "edit-widgets-welcome-guide__text"
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["sprintf"])( // Translators: %s: Number of block areas in the current theme.
      Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["_n"])('', 'Your theme provides %s different “block” areas for you to add and edit content. Try adding a search bar, social icons, or other types of blocks here and see how they’ll look on your site.', numWidgetAreas), numWidgetAreas))) : Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", {
        className: "edit-widgets-welcome-guide__text"
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('您现可在站点的小工具区添加任意区块。不用担心，您之前添加的所有小工具仍然可完美运作。')), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", {
        className: "edit-widgets-welcome-guide__text"
      }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("strong", null, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('想坚持使用旧版小工具吗？')), ' ', Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["ExternalLink"], {
        href: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('https://www.gechiui.com/plugins/classic-widgets/')
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('获取经典小工具插件。')))))
    }, {
      image: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(WelcomeGuideImage, {
      ...
      content: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h1", {
        className: "edit-widgets-welcome-guide__heading"
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('让每个区块彰显其独有的特色')), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", {
        className: "edit-widgets-welcome-guide__text"
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('每个区块都可修改颜色、宽度及对齐等属性。这些控件将在您选择区块时自动显示及隐藏。')))
    }, {
      image: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(WelcomeGuideImage, {
      ...
      content: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h1", {
        className: "edit-widgets-welcome-guide__heading"
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('了解区块库')), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", {
        className: "edit-widgets-welcome-guide__text"
      }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createInterpolateElement"])(Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('所有可用的区块都在区块库中。只要看到<InserterIconImage />图标便可找到区块库。'), {
        InserterIconImage: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("img", {
          className: "edit-widgets-welcome-guide__inserter-icon",
          alt: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('插入'),
      ...
      content: Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h1", {
        className: "edit-widgets-welcome-guide__heading"
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('了解如何使用区块编辑器')), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", {
        className: "edit-widgets-welcome-guide__text"
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('刚开始使用区块编辑器？想进一步了解区块编辑器的使用方式？'), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_2__["ExternalLink"], {
        href: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('https://www.gechiui.com/support/article/gechiui-editor/')
      }, Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])("这是详细的指南。"))))
    }]
  });
}
...
function WelcomeGuideImage(_ref) {
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("picture", {
    className: "edit-widgets-welcome-guide__image"
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("source", {
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/widget-areas-block-editor-content/index.js":
/*!***************************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/widget-areas-block-editor-content/index.js ***!
  \***************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WidgetAreasBlockEditorContent; });
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/element */ "@gechiui/element");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/block-editor */ "@gechiui/block-editor");
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _gechiui_interface__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/interface */ "./node_modules/@gechiui/interface/build-module/index.js");
/* harmony import */ var _notices__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../notices */ "./node_modules/@gechiui/edit-widgets/build-module/components/notices/index.js");
/* harmony import */ var _keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../keyboard-shortcuts */ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcuts/index.js");
...
function WidgetAreasBlockEditorContent(_ref) {
  ...
  const hasThemeStyles = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_2__["useSelect"])(select => select(_gechiui_interface__WEBPACK_IMPORTED_MODULE_3__["store"]).isFeatureActive('core/edit-widgets', 'themeStyles'), []);
  const styles = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => {
    return hasThemeStyles ? blockEditorSettings.styles : [];
  }, [blockEditorSettings, hasThemeStyles]);
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    className: "edit-widgets-block-editor"
  }, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_notices__WEBPACK_IMPORTED_MODULE_4__["default"], null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["BlockTools"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_5__["default"], null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["__unstableEditorStyles"], {
    styles: styles
  }), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["BlockSelectionClearer"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["WritingFlow"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["ObserveTyping"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["BlockList"], {
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/components/widget-areas-block-editor-provider/index.js":
/*!****************************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/components/widget-areas-block-editor-provider/index.js ***!
  \****************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WidgetAreasBlockEditorProvider; });
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/extends */ "./node_modules/@babel/runtime/helpers/esm/extends.js");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/element */ "@gechiui/element");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash */ "lodash");
...
/* harmony import */ var _gechiui_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/components */ "@gechiui/components");
/* harmony import */ var _gechiui_components__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _gechiui_media_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @gechiui/media-utils */ "@gechiui/media-utils");
/* harmony import */ var _gechiui_media_utils__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_gechiui_media_utils__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @gechiui/block-editor */ "@gechiui/block-editor");
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _gechiui_reusable_blocks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @gechiui/reusable-blocks */ "@gechiui/reusable-blocks");
/* harmony import */ var _gechiui_reusable_blocks__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_gechiui_reusable_blocks__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _gechiui_interface__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @gechiui/interface */ "./node_modules/@gechiui/interface/build-module/index.js");
/* harmony import */ var _gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @gechiui/keyboard-shortcuts */ "@gechiui/keyboard-shortcuts");
/* harmony import */ var _gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../keyboard-shortcuts */ "./node_modules/@gechiui/edit-widgets/build-module/components/keyboard-shortcuts/index.js");
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @gechiui/core-data */ "@gechiui/core-data");
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _store_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../store/utils */ "./node_modules/@gechiui/edit-widgets/build-module/store/utils.js");
/* harmony import */ var _hooks_use_last_selected_widget_area__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../hooks/use-last-selected-widget-area */ "./node_modules/@gechiui/edit-widgets/build-module/hooks/use-last-selected-widget-area.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../constants */ "./node_modules/@gechiui/edit-widgets/build-module/constants.js");
...
function WidgetAreasBlockEditorProvider(_ref) {
  ...
  const {
  ...
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_5__["useSelect"])(select => ({
    hasUploadPermissions: Object(lodash__WEBPACK_IMPORTED_MODULE_2__["defaultTo"])(select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_11__["store"]).canUser('create', 'media'), true),
    ...
    reusableBlocks: _constants__WEBPACK_IMPORTED_MODULE_15__["ALLOW_REUSABLE_BLOCKS"] ? select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_11__["store"]).getEntityRecords('postType', 'gc_block') : [],
    isFixedToolbarActive: select(_gechiui_interface__WEBPACK_IMPORTED_MODULE_8__["store"]).isFeatureActive('core/edit-widgets', 'fixedToolbar'),
    keepCaretInsideBlock: select(_gechiui_interface__WEBPACK_IMPORTED_MODULE_8__["store"]).isFeatureActive('core/edit-widgets', 'keepCaretInsideBlock')
  }), []);
  const {
    setIsInserterOpened
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_5__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_14__["store"]);
  const settings = Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["useMemo"])(() => {
    ...
    if (hasUploadPermissions) {
      mediaUploadBlockEditor = _ref2 => {
        ...
        Object(_gechiui_media_utils__WEBPACK_IMPORTED_MODULE_4__["uploadMedia"])({
  ...
  const widgetAreaId = Object(_hooks_use_last_selected_widget_area__WEBPACK_IMPORTED_MODULE_13__["default"])();
  const [blocks, onInput, onChange] = Object(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_11__["useEntityBlockEditor"])(_store_utils__WEBPACK_IMPORTED_MODULE_12__["KIND"], _store_utils__WEBPACK_IMPORTED_MODULE_12__["POST_TYPE"], {
    id: Object(_store_utils__WEBPACK_IMPORTED_MODULE_12__["buildWidgetAreasPostId"])()
  });
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_gechiui_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_9__["ShortcutProvider"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_6__["BlockEditorKeyboardShortcuts"].Register, null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_keyboard_shortcuts__WEBPACK_IMPORTED_MODULE_10__["default"].Register, null), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_gechiui_components__WEBPACK_IMPORTED_MODULE_3__["SlotFillProvider"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_6__["BlockEditorProvider"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
    value: blocks,
    onInput: onInput,
    onChange: onChange,
    settings: settings,
    useSubRegistry: false
  }, props), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_6__["CopyHandler"], null, children), Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_gechiui_reusable_blocks__WEBPACK_IMPORTED_MODULE_7__["ReusableBlocksMenuItems"], {
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/constants.js":
/*!**********************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/constants.js ***!
  \**********************************************************************/
/*! exports provided: ALLOW_REUSABLE_BLOCKS, ENABLE_EXPERIMENTAL_FSE_BLOCKS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ALLOW_REUSABLE_BLOCKS", function() { return ALLOW_REUSABLE_BLOCKS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ENABLE_EXPERIMENTAL_FSE_BLOCKS", function() { return ENABLE_EXPERIMENTAL_FSE_BLOCKS; });
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/filters/index.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/filters/index.js ***!
  \**************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _move_to_widget_area__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./move-to-widget-area */ "./node_modules/@gechiui/edit-widgets/build-module/filters/move-to-widget-area.js");
/* harmony import */ var _replace_media_upload__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./replace-media-upload */ "./node_modules/@gechiui/edit-widgets/build-module/filters/replace-media-upload.js");
/**
 * Internal dependencies
 */
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/filters/move-to-widget-area.js":
/*!****************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/filters/move-to-widget-area.js ***!
  \****************************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _gechiui_hooks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @gechiui/hooks */ "@gechiui/hooks");
/* harmony import */ var _gechiui_hooks__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_gechiui_hooks__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _gechiui_widgets__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @gechiui/widgets */ "@gechiui/widgets");
/* harmony import */ var _gechiui_widgets__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
...
const withMoveToWidgetAreaToolbarItem = Object(_gechiui_compose__WEBPACK_IMPORTED_MODULE_2__["createHigherOrderComponent"])(BlockEdit => props => {
  const {
    clientId,
    name: blockName
  } = props;
  ...
  } = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_3__["useDispatch"])(_store__WEBPACK_IMPORTED_MODULE_6__["store"]);
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(BlockEdit, props), isMoveToWidgetAreaVisible && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["BlockControls"], null, Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_5__["MoveToWidgetArea"], {
...
Object(_gechiui_hooks__WEBPACK_IMPORTED_MODULE_4__["addFilter"])('editor.BlockEdit', 'core/edit-widgets/block-edit', withMoveToWidgetAreaToolbarItem);


/***/ }),

/***/ "./node_modules/@gechiui/edit-widgets/build-module/filters/replace-media-upload.js":
/*!*****************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/filters/replace-media-upload.js ***!
  \*****************************************************************************************/
/*! no exports provided */
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/hooks/use-last-selected-widget-area.js":
/*!************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/hooks/use-last-selected-widget-area.js ***!
  \************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
/* harmony import */ var _store_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../store/utils */ "./node_modules/@gechiui/edit-widgets/build-module/store/utils.js");
/**
 * GeChiUI dependencies
 */
...
const useLastSelectedWidgetArea = () => Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_0__["useSelect"])(select => {
  var _widgetAreasPost$bloc;

  const {
    getBlockSelectionEnd,
    getBlockName
  } = select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_1__["store"]);
  ...
  const {
    getEntityRecord
  } = select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_2__["store"]);
  const widgetAreasPost = getEntityRecord(_store_utils__WEBPACK_IMPORTED_MODULE_4__["KIND"], _store_utils__WEBPACK_IMPORTED_MODULE_4__["POST_TYPE"], Object(_store_utils__WEBPACK_IMPORTED_MODULE_4__["buildWidgetAreasPostId"])());
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/hooks/use-widget-library-insertion-point.js":
/*!*****************************************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/hooks/use-widget-library-insertion-point.js ***!
  \*****************************************************************************************************/
/*! exports provided: default */
...
const useWidgetLibraryInsertionPoint = () => {
  const firstRootId = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_0__["useSelect"])(select => {
    var _widgetAreasPost$bloc;
  ...
  return Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_0__["useSelect"])(select => {
    const {
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/index.js":
/*!******************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/index.js ***!
  \******************************************************************/
/*! exports provided: reinitializeEditor, initialize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/element */ "@gechiui/element");
/* harmony import */ var _gechiui_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _gechiui_blocks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/blocks */ "@gechiui/blocks");
/* harmony import */ var _gechiui_blocks__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _gechiui_block_library__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/block-library */ "@gechiui/block-library");
/* harmony import */ var _gechiui_block_library__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_gechiui_block_library__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @gechiui/core-data */ "@gechiui/core-data");
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _gechiui_widgets__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @gechiui/widgets */ "@gechiui/widgets");
/* harmony import */ var _gechiui_widgets__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./store */ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js");
/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./filters */ "./node_modules/@gechiui/edit-widgets/build-module/filters/index.js");
/* harmony import */ var _blocks_widget_area__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./blocks/widget-area */ "./node_modules/@gechiui/edit-widgets/build-module/blocks/widget-area/index.js");
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/layout */ "./node_modules/@gechiui/edit-widgets/build-module/components/layout/index.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./constants */ "./node_modules/@gechiui/edit-widgets/build-module/constants.js");
...
function reinitializeEditor(target, settings) {
  Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["unmountComponentAtNode"])(target);
  const reboot = reinitializeEditor.bind(null, target, settings);
  Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["render"])(Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_layout__WEBPACK_IMPORTED_MODULE_10__["default"], {
...
function initialize(id, settings) {
  ...
  const coreBlocks = Object(_gechiui_block_library__WEBPACK_IMPORTED_MODULE_3__["__experimentalGetCoreBlocks"])().filter(block => {
  ...
  Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_2__["dispatch"])(_gechiui_interface__WEBPACK_IMPORTED_MODULE_6__["store"]).setFeatureDefaults('core/edit-widgets', {
    fixedToolbar: false,
    welcomeGuide: true,
  ...
  Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_2__["dispatch"])(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_1__["store"]).__experimentalReapplyBlockTypeFilters();

  Object(_gechiui_block_library__WEBPACK_IMPORTED_MODULE_3__["registerCoreBlocks"])(coreBlocks);
  Object(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_5__["registerLegacyWidgetBlock"])();

  if (false) {}

  Object(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_5__["registerLegacyWidgetVariations"])(settings);
  registerBlock(_blocks_widget_area__WEBPACK_IMPORTED_MODULE_9__);
  Object(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_5__["registerWidgetGroupBlock"])();

  settings.__experimentalFetchLinkSuggestions = (search, searchOptions) => Object(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["__experimentalFetchLinkSuggestions"])(search, searchOptions, settings); // As we are unregistering `core/freeform` to avoid the Classic block, we must
  // replace it with something as the default freeform content handler. Failure to
  // do this will result in errors in the default block parser.
  // see: https://github.com/GeChiUI/gutenberg/issues/33097


  Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_1__["setFreeformContentHandlerName"])('core/html');
  Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["render"])(Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_layout__WEBPACK_IMPORTED_MODULE_10__["default"], {
    blockEditorSettings: settings,
    onError: reboot
  }), target);
...
const registerBlock = block => {
  ...
  if (metadata) {
    Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_1__["unstable__bootstrapServerSideBlockDefinitions"])({
      [name]: metadata
    });
  }

  Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_1__["registerBlockType"])(name, settings);
};


/***/ }),

/***/ "./node_modules/@gechiui/edit-widgets/build-module/store/actions.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/store/actions.js ***!
  \**************************************************************************/
/*! exports provided: persistStubPost, saveEditedWidgetAreas, saveWidgetAreas, saveWidgetArea, setWidgetIdForClientId, setWidgetAreasOpenState, setIsWidgetAreaOpen, setIsInserterOpened, setIsListViewOpened, closeGeneralSidebar, moveBlockToWidgetArea */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "persistStubPost", function() { return persistStubPost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveEditedWidgetAreas", function() { return saveEditedWidgetAreas; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveWidgetAreas", function() { return saveWidgetAreas; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "saveWidgetArea", function() { return saveWidgetArea; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setWidgetIdForClientId", function() { return setWidgetIdForClientId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setWidgetAreasOpenState", function() { return setWidgetAreasOpenState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setIsWidgetAreaOpen", function() { return setIsWidgetAreaOpen; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setIsInserterOpened", function() { return setIsInserterOpened; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setIsListViewOpened", function() { return setIsListViewOpened; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeGeneralSidebar", function() { return closeGeneralSidebar; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moveBlockToWidgetArea", function() { return moveBlockToWidgetArea; });
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/i18n */ "@gechiui/i18n");
/* harmony import */ var _gechiui_i18n__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _gechiui_notices__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/notices */ "@gechiui/notices");
/* harmony import */ var _gechiui_notices__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_notices__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _gechiui_interface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @gechiui/interface */ "./node_modules/@gechiui/interface/build-module/index.js");
...
/* harmony import */ var _transformers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./transformers */ "./node_modules/@gechiui/edit-widgets/build-module/store/transformers.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils */ "./node_modules/@gechiui/edit-widgets/build-module/store/utils.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./constants */ "./node_modules/@gechiui/edit-widgets/build-module/store/constants.js");
/**
 * GeChiUI dependencies
 */
...
const persistStubPost = (id, blocks) => _ref => {
  ...
  const stubPost = Object(_utils__WEBPACK_IMPORTED_MODULE_7__["createStubPost"])(id, blocks);
  registry.dispatch(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).receiveEntityRecords(_utils__WEBPACK_IMPORTED_MODULE_7__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_7__["POST_TYPE"], stubPost, {
    id: stubPost.id
  }, false);
  return stubPost;
};
...
const saveEditedWidgetAreas = () => async _ref2 => {
  ...
  try {
    ...
    registry.dispatch(_gechiui_notices__WEBPACK_IMPORTED_MODULE_1__["store"]).createSuccessNotice(Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('小工具已保存。'), {
      type: 'snackbar'
    });
  } catch (e) {
    registry.dispatch(_gechiui_notices__WEBPACK_IMPORTED_MODULE_1__["store"]).createErrorNotice(
    /* translators: %s: The error message. */
    Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["sprintf"])(Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('出现错误。 %s'), e.message), {
      type: 'snackbar'
    });
  }
};
...
const saveWidgetAreas = widgetAreas => async _ref3 => {
  ...
  try {
    ...
    await registry.dispatch(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).finishResolution('getEntityRecord', _utils__WEBPACK_IMPORTED_MODULE_7__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_7__["WIDGET_AREA_ENTITY_TYPE"], Object(_utils__WEBPACK_IMPORTED_MODULE_7__["buildWidgetAreasQuery"])());
  }
};
/**
...
const saveWidgetArea = widgetAreaId => async _ref4 => {
  ...
  const post = registry.select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).getEditedEntityRecord(_utils__WEBPACK_IMPORTED_MODULE_7__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_7__["POST_TYPE"], Object(_utils__WEBPACK_IMPORTED_MODULE_7__["buildWidgetAreaPostId"])(widgetAreaId)); // Get all widgets from this area
  ...
  for (let i = 0; i < widgetsBlocks.length; i++) {
    ...
    const widgetId = Object(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_3__["getWidgetIdFromBlock"])(block);
    const oldWidget = widgets[widgetId];
    const widget = Object(_transformers__WEBPACK_IMPORTED_MODULE_6__["transformBlockToWidget"])(block, oldWidget); // We'll replace the null widgetId after save, but we track it here
    ...
    if (oldWidget) {
      ...
      registry.dispatch(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).editEntityRecord('root', 'widget', widgetId, { ...widget,
        sidebar: widgetAreaId
      }, {
        undoIgnore: true
      });
      const hasEdits = registry.select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).hasEditsForEntityRecord('root', 'widget', widgetId);
  ...
  const records = await registry.dispatch(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).__experimentalBatch(batchTasks);
  ...
  for (let i = 0; i < preservedRecords.length; i++) {
    ...
    const error = registry.select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).getLastEntitySaveError('root', 'widget', widget.id);
  ...
  if (failedWidgetNames.length) {
    throw new Error(Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["sprintf"])(
    /* translators: %s: List of widget names */
    Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('无法保存以下小工具：%s。'), failedWidgetNames.join(', ')));
  }

  registry.dispatch(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).editEntityRecord(_utils__WEBPACK_IMPORTED_MODULE_7__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_7__["WIDGET_AREA_ENTITY_TYPE"], widgetAreaId, {
    widgets: sidebarWidgetsIds
  }, {
    undoIgnore: true
  });
  dispatch(trySaveWidgetArea(widgetAreaId));
  registry.dispatch(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).receiveEntityRecords(_utils__WEBPACK_IMPORTED_MODULE_7__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_7__["POST_TYPE"], post, undefined);
};
...
const trySaveWidgetArea = widgetAreaId => _ref9 => {
  ...
  const saveErrorBefore = registry.select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).getLastEntitySaveError(_utils__WEBPACK_IMPORTED_MODULE_7__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_7__["WIDGET_AREA_ENTITY_TYPE"], widgetAreaId);
  registry.dispatch(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).saveEditedEntityRecord(_utils__WEBPACK_IMPORTED_MODULE_7__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_7__["WIDGET_AREA_ENTITY_TYPE"], widgetAreaId);
  const saveErrorAfter = registry.select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_4__["store"]).getLastEntitySaveError(_utils__WEBPACK_IMPORTED_MODULE_7__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_7__["WIDGET_AREA_ENTITY_TYPE"], widgetAreaId);
...
const closeGeneralSidebar = () => _ref10 => {
  ...
  registry.dispatch(_gechiui_interface__WEBPACK_IMPORTED_MODULE_2__["store"]).disableComplementaryArea(_constants__WEBPACK_IMPORTED_MODULE_8__["STORE_NAME"]);
};
/**
...
const moveBlockToWidgetArea = (clientId, widgetAreaId) => async _ref11 => {
  ...
  const sourceRootClientId = registry.select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_5__["store"]).getBlockRootClientId([clientId]); // Search the top level blocks (widget areas) for the one with the matching
  // id attribute. Makes the assumption that all top-level blocks are widget
  // areas.

  const widgetAreas = registry.select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_5__["store"]).getBlocks();
  ...
  const destinationInnerBlocksClientIds = registry.select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_5__["store"]).getBlockOrder(destinationRootClientId);
  ...
  registry.dispatch(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_5__["store"]).moveBlocksToPosition([clientId], sourceRootClientId, destinationRootClientId, destinationIndex);
};


/***/ }),

/***/ "./node_modules/@gechiui/edit-widgets/build-module/store/constants.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/store/constants.js ***!
  \****************************************************************************/
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/store/index.js":
/*!************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/store/index.js ***!
  \************************************************************************/
...
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reducer */ "./node_modules/@gechiui/edit-widgets/build-module/store/reducer.js");
/* harmony import */ var _resolvers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./resolvers */ "./node_modules/@gechiui/edit-widgets/build-module/store/resolvers.js");
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./selectors */ "./node_modules/@gechiui/edit-widgets/build-module/store/selectors.js");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./actions */ "./node_modules/@gechiui/edit-widgets/build-module/store/actions.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./constants */ "./node_modules/@gechiui/edit-widgets/build-module/store/constants.js");
/**
 * GeChiUI dependencies
 */
...
const store = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createReduxStore"])(_constants__WEBPACK_IMPORTED_MODULE_6__["STORE_NAME"], storeConfig); // Once we build a more generic persistence plugin that works across types of stores
// we'd be able to replace this with a register call.

Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["registerStore"])(_constants__WEBPACK_IMPORTED_MODULE_6__["STORE_NAME"], storeConfig); // This package uses a few in-memory post types as wrappers for convenience.
// This middleware prevents any network requests related to these types as they are
// bound to fail anyway.

_gechiui_api_fetch__WEBPACK_IMPORTED_MODULE_0___default.a.use(function (options, next) {
  var _options$path;
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/store/reducer.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/store/reducer.js ***!
  \**************************************************************************/
/*! exports provided: widgetAreasOpenState, blockInserterPanel, listViewPanel, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "widgetAreasOpenState", function() { return widgetAreasOpenState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "blockInserterPanel", function() { return blockInserterPanel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "listViewPanel", function() { return listViewPanel; });
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/data */ "@gechiui/data");
/* harmony import */ var _gechiui_data__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_data__WEBPACK_IMPORTED_MODULE_0__);
/**
 * GeChiUI dependencies
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/store/resolvers.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/store/resolvers.js ***!
  \****************************************************************************/
/*! exports provided: getWidgetAreas, getWidgets */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/core-data */ "@gechiui/core-data");
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./actions */ "./node_modules/@gechiui/edit-widgets/build-module/store/actions.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./node_modules/@gechiui/edit-widgets/build-module/store/utils.js");
/* harmony import */ var _transformers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./transformers */ "./node_modules/@gechiui/edit-widgets/build-module/store/transformers.js");
/**
 * GeChiUI dependencies
 */
...
const getWidgetAreas = () => async _ref => {
  ...
  const query = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["buildWidgetAreasQuery"])();
  const widgetAreas = await registry.resolveSelect(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_1__["store"]).getEntityRecords(_utils__WEBPACK_IMPORTED_MODULE_3__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_3__["WIDGET_AREA_ENTITY_TYPE"], query);
  ...
  for (const widgetArea of sortedWidgetAreas) {
    widgetAreaBlocks.push(Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_0__["createBlock"])('core/widget-area', {
      id: widgetArea.id,
    ...
    if (!widgetArea.widgets.length) {
      ...
      dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_2__["persistStubPost"])(Object(_utils__WEBPACK_IMPORTED_MODULE_3__["buildWidgetAreaPostId"])(widgetArea.id), []));
    }
  }
  ...
  dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_2__["setWidgetAreasOpenState"])(widgetAreasOpenState));
  dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_2__["persistStubPost"])(Object(_utils__WEBPACK_IMPORTED_MODULE_3__["buildWidgetAreasPostId"])(), widgetAreaBlocks));
};
/**
...
const getWidgets = () => async _ref2 => {
  ...
  const query = Object(_utils__WEBPACK_IMPORTED_MODULE_3__["buildWidgetsQuery"])();
  const widgets = await registry.resolveSelect(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_1__["store"]).getEntityRecords('root', 'widget', query);
  const groupedBySidebar = {};

  for (const widget of widgets) {
    const block = Object(_transformers__WEBPACK_IMPORTED_MODULE_4__["transformWidgetToBlock"])(widget);
  ...
  for (const sidebarId in groupedBySidebar) {
    if (groupedBySidebar.hasOwnProperty(sidebarId)) {
      ...
      dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_2__["persistStubPost"])(Object(_utils__WEBPACK_IMPORTED_MODULE_3__["buildWidgetAreaPostId"])(sidebarId), groupedBySidebar[sidebarId]));
    }
  }
};
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/store/selectors.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/store/selectors.js ***!
  \****************************************************************************/
/*! exports provided: getWidgets, getWidget, getWidgetAreas, getWidgetAreaForWidgetId, getParentWidgetAreaBlock, getEditedWidgetAreas, getReferenceWidgetBlocks, isSavingWidgetAreas, getIsWidgetAreaOpen, isInserterOpened, __experimentalGetInsertionPoint, canInsertBlockInWidgetArea, isListViewOpened */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWidgetAreas", function() { return getWidgetAreas; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWidgetAreaForWidgetId", function() { return getWidgetAreaForWidgetId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getParentWidgetAreaBlock", function() { return getParentWidgetAreaBlock; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEditedWidgetAreas", function() { return getEditedWidgetAreas; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getReferenceWidgetBlocks", function() { return getReferenceWidgetBlocks; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isSavingWidgetAreas", function() { return isSavingWidgetAreas; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getIsWidgetAreaOpen", function() { return getIsWidgetAreaOpen; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "canInsertBlockInWidgetArea", function() { return canInsertBlockInWidgetArea; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isListViewOpened", function() { return isListViewOpened; });
...
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/core-data */ "@gechiui/core-data");
/* harmony import */ var _gechiui_core_data__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @gechiui/block-editor */ "@gechiui/block-editor");
/* harmony import */ var _gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "./node_modules/@gechiui/edit-widgets/build-module/store/utils.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./constants */ "./node_modules/@gechiui/edit-widgets/build-module/store/constants.js");
/**
 * External dependencies
 */
...
const getWidgets = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createRegistrySelector"])(select => () => {
  const widgets = select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__["store"]).getEntityRecords('root', 'widget', Object(_utils__WEBPACK_IMPORTED_MODULE_5__["buildWidgetsQuery"])());
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["keyBy"])(widgets, 'id');
});
/**
...
const getWidget = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createRegistrySelector"])(select => (state, id) => {
...
const getWidgetAreas = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createRegistrySelector"])(select => () => {
  const query = Object(_utils__WEBPACK_IMPORTED_MODULE_5__["buildWidgetAreasQuery"])();
  return select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__["store"]).getEntityRecords(_utils__WEBPACK_IMPORTED_MODULE_5__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_5__["WIDGET_AREA_ENTITY_TYPE"], query);
});
/**
...
const getWidgetAreaForWidgetId = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createRegistrySelector"])(select => (state, widgetId) => {
  const widgetAreas = select(_constants__WEBPACK_IMPORTED_MODULE_6__["STORE_NAME"]).getWidgetAreas();
  return widgetAreas.find(widgetArea => {
    const post = select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__["store"]).getEditedEntityRecord(_utils__WEBPACK_IMPORTED_MODULE_5__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_5__["POST_TYPE"], Object(_utils__WEBPACK_IMPORTED_MODULE_5__["buildWidgetAreaPostId"])(widgetArea.id));
    const blockWidgetIds = post.blocks.map(block => Object(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_2__["getWidgetIdFromBlock"])(block));
...
const getParentWidgetAreaBlock = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createRegistrySelector"])(select => (state, clientId) => {
  const {
    getBlock,
    getBlockName,
    getBlockParents
...
const getEditedWidgetAreas = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createRegistrySelector"])(select => (state, ids) => {
  ...
  return widgetAreas.filter(_ref2 => {
    ...
    return select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__["store"]).hasEditsForEntityRecord(_utils__WEBPACK_IMPORTED_MODULE_5__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_5__["POST_TYPE"], Object(_utils__WEBPACK_IMPORTED_MODULE_5__["buildWidgetAreaPostId"])(id));
  }).map(_ref3 => {
    let {
      id
    } = _ref3;
    return select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__["store"]).getEditedEntityRecord(_utils__WEBPACK_IMPORTED_MODULE_5__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_5__["WIDGET_AREA_ENTITY_TYPE"], id);
  });
});
/**
...
const getReferenceWidgetBlocks = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createRegistrySelector"])(select => function (state) {
  let referenceWidgetName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  const results = [];
  const widgetAreas = select(_constants__WEBPACK_IMPORTED_MODULE_6__["STORE_NAME"]).getWidgetAreas();

  for (const _widgetArea of widgetAreas) {
    const post = select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__["store"]).getEditedEntityRecord(_utils__WEBPACK_IMPORTED_MODULE_5__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_5__["POST_TYPE"], Object(_utils__WEBPACK_IMPORTED_MODULE_5__["buildWidgetAreaPostId"])(_widgetArea.id));
...
const isSavingWidgetAreas = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createRegistrySelector"])(select => () => {
  ...
  for (const id of widgetAreasIds) {
    const isSaving = select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__["store"]).isSavingEntityRecord(_utils__WEBPACK_IMPORTED_MODULE_5__["KIND"], _utils__WEBPACK_IMPORTED_MODULE_5__["WIDGET_AREA_ENTITY_TYPE"], id);
  ...
  for (const id of widgetIds) {
    const isSaving = select(_gechiui_core_data__WEBPACK_IMPORTED_MODULE_3__["store"]).isSavingEntityRecord('root', 'widget', id);
...
const canInsertBlockInWidgetArea = Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["createRegistrySelector"])(select => (state, blockName) => {
  // Widget areas are always top-level blocks, which getBlocks will return.
  const widgetAreas = select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__["store"]).getBlocks(); // Makes an assumption that a block that can be inserted into one
  // widget area can be inserted into any widget area. Uses the first
  // widget area for testing whether the block can be inserted.

  const [firstWidgetArea] = widgetAreas;
  return select(_gechiui_block_editor__WEBPACK_IMPORTED_MODULE_4__["store"]).canInsertBlockType(blockName, firstWidgetArea.clientId);
});
/**
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/store/transformers.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/store/transformers.js ***!
  \*******************************************************************************/
/*! exports provided: transformWidgetToBlock, transformBlockToWidget */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "transformWidgetToBlock", function() { return transformWidgetToBlock; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "transformBlockToWidget", function() { return transformBlockToWidget; });
/* harmony import */ var _gechiui_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gechiui/blocks */ "@gechiui/blocks");
/* harmony import */ var _gechiui_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_0__);
...
function transformWidgetToBlock(widget) {
  if (widget.id_base === 'block') {
    const parsedBlocks = Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_0__["parse"])(widget.instance.raw.content);

    if (!parsedBlocks.length) {
      return Object(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_1__["addWidgetIdToBlock"])(Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_0__["createBlock"])('core/paragraph', {}, []), widget.id);
    }

    return Object(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_1__["addWidgetIdToBlock"])(parsedBlocks[0], widget.id);
  }
  ...
  return Object(_gechiui_widgets__WEBPACK_IMPORTED_MODULE_1__["addWidgetIdToBlock"])(Object(_gechiui_blocks__WEBPACK_IMPORTED_MODULE_0__["createBlock"])('core/legacy-widget', attributes, []), widget.id);
}
/**
...
/***/ "./node_modules/@gechiui/edit-widgets/build-module/store/utils.js":
/*!************************************************************************!*\
  !*** ./node_modules/@gechiui/edit-widgets/build-module/store/utils.js ***!
  \************************************************************************/
/*! exports provided: KIND, WIDGET_AREA_ENTITY_TYPE, POST_TYPE, buildWidgetAreaPostId, buildWidgetAreasPostId, buildWidgetAreasQuery, buildWidgetsQuery, createStubPost */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KIND", function() { return KIND; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WIDGET_AREA_ENTITY_TYPE", function() { return WIDGET_AREA_ENTITY_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "POST_TYPE", function() { return POST_TYPE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buildWidgetAreaPostId", function() { return buildWidgetAreaPostId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buildWidgetAreasPostId", function() { return buildWidgetAreasPostId; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buildWidgetAreasQuery", function() { return buildWidgetAreasQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buildWidgetsQuery", function() { return buildWidgetsQuery; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createStubPost", function() { return createStubPost; });
/**
...
function ComplementaryArea(_ref3) {
  let {
    children,
    className,
    closeLabel = Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('关闭插件'),
    identifier,
    header,
    headerClassName,
    icon,
  ...
  return Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, isPinnable && Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_pinned_items__WEBPACK_IMPORTED_MODULE_12__["default"], {
    ...
    label: isPinned ? Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('从工具栏移除') : Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('固定至工具栏'),
...
function InterfaceSkeleton(_ref, ref) {
  ...
  const defaultLabels = {
    ...
    drawer: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('抽屉'),

    /* translators: accessibility text for the top bar landmark region. */
    header: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('页眉'),

    /* translators: accessibility text for the content landmark region. */
    body: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('内容'),

    /* translators: accessibility text for the secondary sidebar landmark region. */
    secondarySidebar: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('区块库'),

    /* translators: accessibility text for the settings landmark region. */
    sidebar: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('设置'),

    /* translators: accessibility text for the publish landmark region. */
    actions: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('发布'),

    /* translators: accessibility text for the footer landmark region. */
    footer: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('页脚')
  };
...
function MoreMenuDropdown(_ref) {
  let {
    ...
    /* translators: button label text should, if possible, be under 16 characters. */
    label = Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('选项'),
    popoverProps,
    toggleProps,
    children
  } = _ref;
...
function MoreMenuFeatureToggle(_ref) {
  ...
  const speakMessage = () => {
    if (isActive) {
      Object(_gechiui_a11y__WEBPACK_IMPORTED_MODULE_5__["speak"])(messageDeactivated || Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('功能已禁用'));
    } else {
      Object(_gechiui_a11y__WEBPACK_IMPORTED_MODULE_5__["speak"])(messageActivated || Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('功能已启用'));
    }
  };
