...
/***/ "./node_modules/@gechiui/media-utils/build-module/components/index.js":
/*!****************************************************************************!*\
  !*** ./node_modules/@gechiui/media-utils/build-module/components/index.js ***!
  \****************************************************************************/
...
/* harmony import */ var _media_upload__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./media-upload */ "./node_modules/@gechiui/media-utils/build-module/components/media-upload/index.js");
...
/***/ "./node_modules/@gechiui/media-utils/build-module/components/media-upload/index.js":
/*!*****************************************************************************************!*\
  !*** ./node_modules/@gechiui/media-utils/build-module/components/media-upload/index.js ***!
  \*****************************************************************************************/
  ...
  return gc.media.view.MediaFrame.Post.extend({
    ...
    createStates: function createStates() {
      ...
      this.states.add([new gc.media.controller.Library({
        ...
        multiple: 'add',
        editable: false,
        library: gc.media.query(Object(lodash__WEBPACK_IMPORTED_MODULE_0__["defaults"])({
          type: 'image'
...
const slimImageObject = img => {
  ...
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["pick"])(img, attrSet);
};
...
class MediaUpload extends _gechiui_element__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(_ref) {
    let {
      allowedTypes,
      gallery = false,
      ...
      modalClass,
      multiple = false,
      title = Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('选择或上传媒体')
    } = _ref;
    super(...arguments);
  ...
  onOpen() {
    ...
    if (!isGallery) {
      Object(lodash__WEBPACK_IMPORTED_MODULE_0__["castArray"])(this.props.value).forEach(id => {
        selection.add(gc.media.attachment(id));
      });
    } // Load the images so they are available in the media modal.


    const attachments = getAttachmentsCollection(Object(lodash__WEBPACK_IMPORTED_MODULE_0__["castArray"])(this.props.value)); // Once attachments are loaded, set the current selection.
...
/***/ "./node_modules/@gechiui/media-utils/build-module/index.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@gechiui/media-utils/build-module/index.js ***!
  \*****************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components */ "./node_modules/@gechiui/media-utils/build-module/components/index.js");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./node_modules/@gechiui/media-utils/build-module/utils/index.js");
...
/***/ "./node_modules/@gechiui/media-utils/build-module/utils/index.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@gechiui/media-utils/build-module/utils/index.js ***!
  \***********************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _upload_media__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./upload-media */ "./node_modules/@gechiui/media-utils/build-module/utils/upload-media.js");
...
/***/ "./node_modules/@gechiui/media-utils/build-module/utils/upload-media.js":
/*!******************************************************************************!*\
  !*** ./node_modules/@gechiui/media-utils/build-module/utils/upload-media.js ***!
  \******************************************************************************/
...
/* harmony import */ var _gechiui_blob__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @gechiui/blob */ "@gechiui/blob");
/* harmony import */ var _gechiui_blob__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_gechiui_blob__WEBPACK_IMPORTED_MODULE_3__);
...
function getMimeTypesArray(gcMimeTypesObject) {
  ...
  return Object(lodash__WEBPACK_IMPORTED_MODULE_1__["flatMap"])(gcMimeTypesObject, (mime, extensionsString) => {
    const [type] = mime.split('/');
    const extensions = extensionsString.split('|');
    return [mime, ...Object(lodash__WEBPACK_IMPORTED_MODULE_1__["map"])(extensions, extension => `${type}/${extension}`)];
  });
}
/**
...
async function uploadMedia(_ref) {
  let {
    ...
    filesList,
    maxUploadFileSize,
    onError = lodash__WEBPACK_IMPORTED_MODULE_1__["noop"],
    onFileChange,
  ...
  const setAndUpdateFiles = (idx, value) => {
    Object(_gechiui_blob__WEBPACK_IMPORTED_MODULE_3__["revokeBlobURL"])(Object(lodash__WEBPACK_IMPORTED_MODULE_1__["get"])(filesSet, [idx, 'url']));
    filesSet[idx] = value;
    onFileChange(Object(lodash__WEBPACK_IMPORTED_MODULE_1__["compact"])(filesSet));
  ...
  const isAllowedType = fileType => {
    ...
    return Object(lodash__WEBPACK_IMPORTED_MODULE_1__["some"])(allowedTypes, allowedType => {
      // If a complete mimetype is specified verify if it matches exactly the mime type of the file.
      if (Object(lodash__WEBPACK_IMPORTED_MODULE_1__["includes"])(allowedType, '/')) {
        return allowedType === fileType;
      } // Otherwise a general mime type is used and we should verify if the file mimetype starts with it.


      return Object(lodash__WEBPACK_IMPORTED_MODULE_1__["startsWith"])(fileType, `${allowedType}/`);
    });
  ...
  const isAllowedMimeTypeForUser = fileType => {
    return Object(lodash__WEBPACK_IMPORTED_MODULE_1__["includes"])(allowedMimeTypesForUser, fileType);
  }; // Build the error message including the filename


  const triggerError = error => {
    error.message = [Object(_gechiui_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("strong", {
      key: "filename"
  ...
  for (const mediaFile of files) {
    ...
    if (allowedMimeTypesForUser && mediaFile.type && !isAllowedMimeTypeForUser(mediaFile.type)) {
      triggerError({
        ...
        message: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('抱歉，您无权上传此文件类型。'),
        file: mediaFile
      });
      continue;
    ...
    if (mediaFile.type && !isAllowedType(mediaFile.type)) {
      triggerError({
        ...
        message: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('抱歉，不支持此文件类型。'),
        file: mediaFile
      });
      continue;
    ...
    if (maxUploadFileSize && mediaFile.size > maxUploadFileSize) {
      triggerError({
        ...
        message: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('此文件超过了本站点的最大上传大小。'),
        file: mediaFile
      });
      continue;
    ...
    if (mediaFile.size <= 0) {
      triggerError({
        code: 'EMPTY_FILE',
        message: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('此文件为空。'),
        file: mediaFile
      });
      continue;
    }
    ...
    filesSet.push({
      url: Object(_gechiui_blob__WEBPACK_IMPORTED_MODULE_3__["createBlobURL"])(mediaFile)
    });
  ...
  for (let idx = 0; idx < validFiles.length; ++idx) {
    ...
    try {
      ...
      const mediaObject = { ...Object(lodash__WEBPACK_IMPORTED_MODULE_1__["omit"])(savedMedia, ['alt_text', 'source_url']),
        alt: savedMedia.alt_text,
        caption: Object(lodash__WEBPACK_IMPORTED_MODULE_1__["get"])(savedMedia, ['caption', 'raw'], ''),
      ...
      if (Object(lodash__WEBPACK_IMPORTED_MODULE_1__["has"])(error, ['message'])) {
        message = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["get"])(error, ['message']);
      } else {
        message = Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["sprintf"])( // translators: %s: file name
        Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('在将文件%s上传至媒体库时出现错误。'), mediaFile.name);
      }
...
function createMediaFromFile(file, additionalData) {
  ...
  Object(lodash__WEBPACK_IMPORTED_MODULE_1__["forEach"])(additionalData, (value, key) => data.append(key, value));
  return _gechiui_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()({
    path: '/gc/v2/media',
    body: data,
    method: 'POST'
  });
