this["gc"] = this["gc"] || {}; this["gc"]["annotations"] =
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/@gechiui/annotations/build-module/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/@gechiui/annotations/build-module/block/index.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@gechiui/annotations/build-module/block/index.js ***!
  \***********************************************************************/
/*! no exports provided */
...
/* harmony import */ var _store_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../store/constants */ "./node_modules/@gechiui/annotations/build-module/store/constants.js");
/**
...
const addAnnotationClassName = OriginalComponent => {
  return Object(_gechiui_data__WEBPACK_IMPORTED_MODULE_1__["withSelect"])((select, _ref) => {
    let {
      clientId,
      className
    } = _ref;
...
Object(_gechiui_hooks__WEBPACK_IMPORTED_MODULE_0__["addFilter"])('editor.BlockListBlock', 'core/annotations', addAnnotationClassName);


/***/ }),

/***/ "./node_modules/@gechiui/annotations/build-module/format/annotation.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@gechiui/annotations/build-module/format/annotation.js ***!
  \*****************************************************************************/
...
/* harmony import */ var _gechiui_rich_text__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @gechiui/rich-text */ "@gechiui/rich-text");
/* harmony import */ var _gechiui_rich_text__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_gechiui_rich_text__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _store_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../store/constants */ "./node_modules/@gechiui/annotations/build-module/store/constants.js");
/**
 * GeChiUI dependencies
 */
...
function applyAnnotations(record) {
  ...
  annotations.forEach(annotation => {
    ...
    record = Object(_gechiui_rich_text__WEBPACK_IMPORTED_MODULE_1__["applyFormat"])(record, {
      type: FORMAT_NAME,
      attributes: {
        className,
        id
...
function removeAnnotations(record) {
  return Object(_gechiui_rich_text__WEBPACK_IMPORTED_MODULE_1__["removeFormat"])(record, 'core/annotation', 0, record.text.length);
}
/**
...
const annotation = {
  name: FORMAT_NAME,
  title: Object(_gechiui_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('批注'),
  tagName: 'mark',
...
/***/ "./node_modules/@gechiui/annotations/build-module/format/index.js":
/*!************************************************************************!*\
  !*** ./node_modules/@gechiui/annotations/build-module/format/index.js ***!
  \************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _annotation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./annotation */ "./node_modules/@gechiui/annotations/build-module/format/annotation.js");
/**
 * GeChiUI dependencies
 */
...
Object(_gechiui_rich_text__WEBPACK_IMPORTED_MODULE_0__["registerFormatType"])(name, settings);


/***/ }),

/***/ "./node_modules/@gechiui/annotations/build-module/index.js":
/*!*****************************************************************!*\
  !*** ./node_modules/@gechiui/annotations/build-module/index.js ***!
  \*****************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _format__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./format */ "./node_modules/@gechiui/annotations/build-module/format/index.js");
/* harmony import */ var _block__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block */ "./node_modules/@gechiui/annotations/build-module/block/index.js");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./store */ "./node_modules/@gechiui/annotations/build-module/store/index.js");
...
/***/ "./node_modules/@gechiui/annotations/build-module/store/actions.js":
/*!*************************************************************************!*\
  !*** ./node_modules/@gechiui/annotations/build-module/store/actions.js ***!
  \*************************************************************************/
 ...
 * @param {GCAnnotationRange} annotation.range              The range at which to apply this annotation.
...
/***/ "./node_modules/@gechiui/annotations/build-module/store/constants.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@gechiui/annotations/build-module/store/constants.js ***!
  \***************************************************************************/
...
/***/ "./node_modules/@gechiui/annotations/build-module/store/index.js":
/*!***********************************************************************!*\
  !*** ./node_modules/@gechiui/annotations/build-module/store/index.js ***!
  \***********************************************************************/
/*! exports provided: store */
...
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reducer */ "./node_modules/@gechiui/annotations/build-module/store/reducer.js");
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./selectors */ "./node_modules/@gechiui/annotations/build-module/store/selectors.js");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./actions */ "./node_modules/@gechiui/annotations/build-module/store/actions.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./constants */ "./node_modules/@gechiui/annotations/build-module/store/constants.js");
/**
 * GeChiUI dependencies
 */
...
/***/ "./node_modules/@gechiui/annotations/build-module/store/reducer.js":
/*!*************************************************************************!*\
  !*** ./node_modules/@gechiui/annotations/build-module/store/reducer.js ***!
  \*************************************************************************/
...
function isValidAnnotationRange(annotation) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isNumber"])(annotation.start) && Object(lodash__WEBPACK_IMPORTED_MODULE_0__["isNumber"])(annotation.end) && annotation.start <= annotation.end;
}
/**
...
function annotations() {
  ...
  switch (action.type) {
    ...
    case 'ANNOTATION_REMOVE':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["mapValues"])(state, annotationsForBlock => {
...
/***/ "./node_modules/@gechiui/annotations/build-module/store/selectors.js":
/*!***************************************************************************!*\
  !*** ./node_modules/@gechiui/annotations/build-module/store/selectors.js ***!
  \***************************************************************************/
...
const __experimentalGetAnnotationsForBlock = Object(rememo__WEBPACK_IMPORTED_MODULE_0__["default"])((state, blockClientId) => {
  var _state$blockClientId;
...
const __experimentalGetAnnotationsForRichText = Object(rememo__WEBPACK_IMPORTED_MODULE_0__["default"])((state, blockClientId, richTextIdentifier) => {
...
function __experimentalGetAnnotations(state) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_1__["flatMap"])(state, annotations => {
    return annotations;
  });
}
