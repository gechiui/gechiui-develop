 ...
 * @method GC_Comment create_and_get( $args = array(), $generation_definitions = null )
 * @method int[] create_many( $count, $args = array(), $generation_definitions = null )
 */
class GC_UnitTest_Factory_For_Comment extends GC_UnitTest_Factory_For_Thing {

	public function __construct( $factory = null ) {
		parent::__construct( $factory );
		$this->default_generation_definitions = array(
			'comment_author'     => new GC_UnitTest_Generator_Sequence( 'Commenter %s' ),
			'comment_author_url' => new GC_UnitTest_Generator_Sequence( 'http://example.com/%s/' ),
			'comment_approved'   => 1,
	...
	public function create_object( $args ) {
		return gc_insert_comment( $this->addslashes_deep( $args ) );
	}
	...
	public function update_object( $comment_id, $fields ) {
		...
		return gc_update_comment( $this->addslashes_deep( $fields ) );
	}
	 ...
	 *
	 * @return GC_Comment|null GC_Comment object on success, null on failure.
	 */
