...
abstract class GC_Test_XML_TestCase extends GC_UnitTestCase {
	/**
	 ...
	 * `$actualXml = "<root xmlns='urn:www.gechiui.com'><child/></root>";` and
	 * `$expectedXml = "<ns0:root xmlns:ns0='urn:www.gechiui.com'><ns0:child></ns0:root>";`
	 ...
	 */
	public function assertXMLEquals( $expectedXml, $actualXml, $message = '' ) { // phpcs:ignore GeChiUI.NamingConventions.ValidVariableName.VariableNotSnakeCase
		$this->assertSame( $this->normalizeXML( $expectedXml ), $this->normalizeXML( $actualXml ), $message ); //phpcs:ignore GeChiUI.NamingConventions.ValidVariableName.VariableNotSnakeCase
	}
	 ...
	 * @param string $message   Optional. Message to display when the assertion fails.
	 */
	public function assertXMLNotEquals( $expectedXml, $actualXml, $message = '' ) { //phpcs:ignore GeChiUI.NamingConventions.ValidVariableName.VariableNotSnakeCase
		$this->assertNotEquals( $this->normalizeXML( $expectedXml ), $this->normalizeXML( $actualXml ), $message ); //phpcs:ignore GeChiUI.NamingConventions.ValidVariableName.VariableNotSnakeCase
	}
}
