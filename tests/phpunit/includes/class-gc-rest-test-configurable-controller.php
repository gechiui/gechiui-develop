<?php
/**
 * Unit tests covering GC_REST_Controller functionality using a flexible schema.
 *
 * @package GeChiUI
 * @subpackage REST API
 * @since 5.4.0
...
/**
 * GC_REST_Test_Configurable_Controller class.
 *
 * @group restapi
 *
 * @since 5.4.0
 */
class GC_REST_Test_Configurable_Controller extends GC_REST_Controller {
