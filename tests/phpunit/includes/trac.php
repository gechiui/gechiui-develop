...
class TracTickets {
	 ...
	 */
	public static function isTracTicketClosed( $trac_url, $ticket_id ) { // phpcs:ignore GeChiUI.NamingConventions.ValidFunctionName.MethodNameInvalid
	...
	// phpcs:ignore GeChiUI.NamingConventions.ValidFunctionName.MethodNameInvalid
