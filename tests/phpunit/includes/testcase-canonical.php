...
abstract class GC_Canonical_UnitTestCase extends GC_UnitTestCase {
	 ...
	 * @since 4.1.0
	 */
	public static function generate_shared_fixtures( GC_UnitTest_Factory $factory ) {
	...
	/**
	 * Assert that a given URL is the same a the canonical URL generated by GC.
	 *
	 * @since 4.1.0
	 *
	...
	public function assertCanonical( $test_url, $expected, $ticket = 0, $expected_doing_it_wrong = array() ) {
		...
		$query_vars = array_diff( $gc->query_vars, $gc->extra_query_vars );
