...
/**
 * Class GC_Sitemaps_Test_Provider.
 *
 * Provides test data for additional registered providers.
 */
class GC_Sitemaps_Test_Provider extends GC_Sitemaps_Provider {
	/**
	 ...
	 *
	 * @return array Map of object subtype objects (GC_Post_Type) keyed by their name.
	 */
