...
abstract class GC_Import_UnitTestCase extends GC_UnitTestCase {
	/**
	 * Import a WXR file.
	 *
	 ...
	 */
	protected function _import_gc( $filename, $users = array(), $fetch_files = true ) {
		$importer = new GC_Import();
