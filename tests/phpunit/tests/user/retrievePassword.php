...
/**
 * Test retrieve_password(), in gc-includes/user.php.
 *
 * @since 6.0.0
 *
 * @group user
 ...
 */
class Tests_User_RetrievePassword extends GC_UnitTestCase {
	/**
	 * Test user.
	 *
	 * @since 6.0.0
	 ...
	 * @ticket 54690
	 */
	public function test_retrieve_password_should_return_gc_error_on_failed_email() {
		add_filter(
