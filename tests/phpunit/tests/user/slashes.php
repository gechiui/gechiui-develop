 ...
 * @ticket 21767
 */
class Tests_User_Slashes extends GC_UnitTestCase {
	 ...
	 */
	public function test_gc_insert_user() {
		$user_id = gc_insert_user(
			array(
		...
		$this->assertSame( gc_unslash( $this->slash_1 ), $user->first_name );
		$this->assertSame( gc_unslash( $this->slash_3 ), $user->last_name );
		$this->assertSame( gc_unslash( $this->slash_5 ), $user->nickname );
		$this->assertSame( gc_unslash( $this->slash_7 ), $user->display_name );
		$this->assertSame( gc_unslash( $this->slash_3 ), $user->description );
		...
		$this->assertSame( gc_unslash( $this->slash_2 ), $user->first_name );
		$this->assertSame( gc_unslash( $this->slash_4 ), $user->last_name );
		$this->assertSame( gc_unslash( $this->slash_6 ), $user->nickname );
		$this->assertSame( gc_unslash( $this->slash_2 ), $user->display_name );
		$this->assertSame( gc_unslash( $this->slash_4 ), $user->description );
	}

	/**
	 * Tests the model function that expects slashed data.
	 */
	public function test_gc_update_user() {
		$user_id = self::$user_id;
		$user_id = gc_update_user(
			array(
				'ID'           => $user_id,
				'role'         => 'subscriber',
				'first_name'   => $this->slash_1,
