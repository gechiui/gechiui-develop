 ...
 * @group user
 */
class Tests_User_ListAuthors extends GC_UnitTestCase {
	...
	public function test_gc_list_authors_default() {
		$expected['default'] =
		...
		$this->assertSame( $expected['default'], gc_list_authors( array( 'echo' => false ) ) );
	}

	public function test_gc_list_authors_orderby() {
		$expected['post_count'] =
			'<li><a href="' . self::$user_urls[0] . '" title="Posts by zack">zack</a></li>' .
			'<li><a href="' . self::$user_urls[1] . '" title="Posts by bob">bob</a></li>' .
			'<li><a href="' . self::$user_urls[2] . '" title="Posts by paul">paul</a></li>';
	...
	public function test_gc_list_authors_order() {
		$expected['id'] =
			'<li><a href="' . self::$user_urls[2] . '" title="Posts by paul">paul</a></li>' .
			'<li><a href="' . self::$user_urls[1] . '" title="Posts by bob">bob</a></li>' .
			'<li><a href="' . self::$user_urls[0] . '" title="Posts by zack">zack</a></li>';
	...
	public function test_gc_list_authors_optioncount() {
	...
	public function test_gc_list_authors_exclude_admin() {
	...
	public function test_gc_list_authors_show_fullname() {
	...
	public function test_gc_list_authors_hide_empty() {
	...
	public function test_gc_list_authors_echo() {
		$expected['echo'] =
			'<li><a href="' . self::$user_urls[1] . '" title="Posts by bob">bob</a></li>' .
			'<li><a href="' . self::$user_urls[2] . '" title="Posts by paul">paul</a></li>' .
			'<li><a href="' . self::$user_urls[0] . '" title="Posts by zack">zack</a></li>';
		...
		gc_list_authors( array( 'echo' => true ) );
	}

	public function test_gc_list_authors_feed() {
	...
	public function test_gc_list_authors_feed_image() {
		$url0 = get_author_feed_link( self::$user_ids[0] );
		$url1 = get_author_feed_link( self::$user_ids[1] );
		$url2 = get_author_feed_link( self::$user_ids[2] );

		$expected['feed_image'] =
			'<li><a href="' . self::$user_urls[1] . '" title="Posts by bob">bob</a> <a href="' . $url1 . '"><img src="http://' . GC_TESTS_DOMAIN . '/path/to/a/graphic.png" style="border: none;" /></a></li>' .
			'<li><a href="' . self::$user_urls[2] . '" title="Posts by paul">paul</a> <a href="' . $url2 . '"><img src="http://' . GC_TESTS_DOMAIN . '/path/to/a/graphic.png" style="border: none;" /></a></li>' .
			'<li><a href="' . self::$user_urls[0] . '" title="Posts by zack">zack</a> <a href="' . $url0 . '"><img src="http://' . GC_TESTS_DOMAIN . '/path/to/a/graphic.png" style="border: none;" /></a></li>';
		...
		$this->assertSame(
			...
			gc_list_authors(
				array(
					'echo'       => false,
					'feed_image' => GC_TESTS_DOMAIN . '/path/to/a/graphic.png',
				)
			)
		);
	}
	 ...
	 * @ticket 26538
	 */
	public function test_gc_list_authors_feed_type() {
	...
	public function test_gc_list_authors_style() {
		$expected['style'] =
	...
	public function test_gc_list_authors_html() {
