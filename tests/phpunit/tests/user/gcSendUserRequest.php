<?php
/**
 * Test cases for the `gc_send_user_request()` function.
 *
 * @package GeChiUI
 * @since 4.9.9
 */
...
/**
 * Tests_User_GcSendUserRequest class.
 *
 * @since 4.9.9
 *
 * @group privacy
 * @group user
 * @covers ::gc_send_user_request
 */
class Tests_User_GcSendUserRequest extends GC_UnitTestCase {
	 ...
	 * @since 4.9.9
	 *
	 * @param GC_UnitTest_Factory $factory Test fixture factory.
	 */
	...
	public function test_should_error_when_invalid_request_id() {
		$result = gc_send_user_request( null );
	...
	public function test_should_send_user_request_export_email_when_requester_registered_user() {
		$request_id = gc_create_user_request( self::$test_user->user_email, 'export_personal_data' );
	...
	public function test_should_send_user_request_erase_email_when_requester_registered_user() {
		$request_id = gc_create_user_request( self::$test_user->user_email, 'remove_personal_data' );
	 ...
	 * @ticket 43985
	 */
	public function test_return_gc_error_when_sending_fails() {
		$request_id = gc_create_user_request( 'erase.request.from.unregistered.user@example.com', 'remove_personal_data' );
	...
	public function test_should_send_user_request_email_in_site_locale_when_not_en_us_and_admin_has_different_locale() {
		...
		$request_id = gc_create_user_request( 'export-user-not-registered@example.com', 'remove_personal_data' );
