 ...
 * @group user
 */
class Tests_User_GcDeleteUser extends GC_UnitTestCase {
	 ...
	 * @ticket 20447
	 */
	public function test_gc_delete_user_reassignment_clears_post_caches() {
		...
		gc_delete_user( $user_id, $reassign );
	...
	public function test_numeric_string_user_id() {
		...
		$u_string = (string) $u;
		$this->assertTrue( gc_delete_user( $u_string ) );
	...
	public function test_should_return_false_for_non_numeric_string_user_id() {
		$this->assertFalse( gc_delete_user( 'abcde' ) );
	}
	...
	public function test_should_return_false_for_object_user_id() {
		...
		$this->assertFalse( gc_delete_user( $u_obj ) );
