 ...
 * @group user
 */
class Tests_User_GcDropdownUsers extends GC_UnitTestCase {
	...
	public function test_show_should_display_display_name_show_is_specified_as_empty() {
		...
		// Get the result of a non-default, but acceptable input for 'show' parameter to gc_dropdown_users().
		$found = gc_dropdown_users(
			array(
				'echo' => false,
				'show' => '',
