...
if ( is_multisite() ) :
	 ...
	 * @group multisite
	 */
	class Tests_Multisite_getActiveBlogForUser extends GC_UnitTestCase {
		...
		public function test_get_active_blog_for_user_with_primary_site() {
			...
			gc_delete_site( $site_id_one );
			gc_delete_site( $site_id_two );
		...
		public function test_get_active_blog_for_user_without_primary_site() {
			...
			gc_delete_site( $primary_site_id );
