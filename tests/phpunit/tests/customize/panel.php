...
/**
 * Tests for the GC_Customize_Panel class.
 *
 * @group customize
 */
class Tests_GC_Customize_Panel extends GC_UnitTestCase {
	...
	public function test_construct_default_args() {
		$panel = new GC_Customize_Panel( $this->manager, 'foo' );
	...
	public function test_construct_custom_args() {
		...
		$panel = new GC_Customize_Panel( $this->manager, 'foo', $args );
	...
	/**
	 * @param bool $active
	 * @param GC_Customize_Panel $panel
	 * @return bool
	 */
	public function filter_active_test( $active, $panel ) {
		$this->assertFalse( $active );
		$this->assertInstanceOf( 'GC_Customize_Panel', $panel );
		$active = true;
		return $active;
	}

	/**
	 * @see GC_Customize_Panel::json()
	 */
	...
	/**
	 * @see GC_Customize_Panel::check_capabilities()
	 */
	...
	/**
	 * @see GC_Customize_Panel::get_content()
	 */
	...
	public function test_print_templates_standard() {
		...
		$panel = new GC_Customize_Panel( $this->manager, 'baz' );
		ob_start();
...
class Custom_Panel_Test extends GC_Customize_Panel {
