<?php
/**
 * Test_GC_Customize_Partial tests.
 *
 * @package GeChiUI
 */

/**
 * Tests for the Test_GC_Customize_Partial class.
 *
 * @group customize
 */
class Test_GC_Customize_Partial extends GC_UnitTestCase {
	...
	/**
	 * Test GC_Customize_Partial::__construct().
	 *
	 * @see GC_Customize_Partial::__construct()
	 */
	public function test_construct_default_args() {
		$partial_id = 'blogname';
		$partial    = new GC_Customize_Partial( $this->selective_refresh, $partial_id );
	...
	public function test_construct_non_default_args() {
		...
		$partial    = new GC_Customize_Partial( $this->selective_refresh, $partial_id, $args );
		$this->assertSame( $partial_id, $partial->id );
		$this->assertSame( $this->selective_refresh, $partial->component );
		...
		$partial = new GC_Customize_Partial(
	...
	/**
	 * Test GC_Customize_Partial::id_data().
	 *
	 * @see GC_Customize_Partial::id_data()
	 */
	public function test_id_data() {
		$partial = new GC_Customize_Partial( $this->selective_refresh, 'foo' );
		$id_data = $partial->id_data();
		$this->assertSame( 'foo', $id_data['base'] );
		$this->assertSame( array(), $id_data['keys'] );

		$partial = new GC_Customize_Partial( $this->selective_refresh, 'bar[baz][quux]' );
		$id_data = $partial->id_data();
	...
	/**
	 * Test GC_Customize_Partial::render() with a bad return_callback.
	 *
	...
	/**
	 * Test GC_Customize_Partial::render() with a return_callback that echos.
	 *
	 * @see GC_Customize_Partial::render()
	 */
	...
	/**
	 * Test GC_Customize_Partial::render_callback() default.
	 *
	 * @see GC_Customize_Partial::render_callback()
	 */
	...
	/**
	 * Test GC_Customize_Partial::json().
	 *
	 * @see GC_Customize_Partial::json()
	 */
	...
	/**
	 * Test GC_Customize_Partial::check_capabilities().
	 *
	 * @see GC_Customize_Partial::check_capabilities()
	 */
