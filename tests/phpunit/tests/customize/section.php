...
/**
 * Tests for the GC_Customize_Section class.
 *
 * @group customize
 */
class Tests_GC_Customize_Section extends GC_UnitTestCase {
	...
	public function test_construct_default_args() {
		$section = new GC_Customize_Section( $this->manager, 'foo' );
	...
	public function test_construct_custom_args() {
		...
		$section = new GC_Customize_Section( $this->manager, 'foo', $args );
	 ...
	 * @see GC_Customize_Section::active_callback()
	 */
	...
	/**
	 * @param bool $active
	 * @param GC_Customize_Section $section
	 * @return bool
	 */
	public function filter_active_test( $active, $section ) {
		$this->assertFalse( $active );
		$this->assertInstanceOf( 'GC_Customize_Section', $section );
		$active = true;
		return $active;
	}

	/**
	 * @see GC_Customize_Section::json()
	 */
	...
	/**
	 * @see GC_Customize_Section::check_capabilities()
	 */
	...
	/**
	 * @see GC_Customize_Section::get_content()
	 */
	...
	/**
	 * @see GC_Customize_Section::maybe_render()
	 */
	public function test_maybe_render() {
		gc_set_current_user( self::$admin_id );
		$section                        = new GC_Customize_Section( $this->manager, 'bar' );
	...
	public function test_print_templates_standard() {
		...
		$section = new GC_Customize_Section( $this->manager, 'baz' );
		ob_start();
...
class Custom_Section_Test extends GC_Customize_Section {
