 ...
 * @since 4.9.6
 */
class Tests_Url_GetPrivacyPolicyUrl extends GC_UnitTestCase {
	/**
	...
	/**
	 * The function should return an empty string when `gc_page_for_privacy_policy` is _not_ set.
	 */
	...
	/**
	 * The function should return the privacy policy URL when `gc_page_for_privacy_policy` is set.
	 */
	...
	/**
	 * The function should return an empty string for an invalid `gc_page_for_privacy_policy` value.
	 */
	public function test_get_privacy_policy_url_should_return_empty_for_non_existing_page() {
		update_option( 'gc_page_for_privacy_policy', PHP_INT_MAX );
