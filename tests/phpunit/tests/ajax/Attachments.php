 ...
 * @group ajax
 */
class Tests_Ajax_Attachments extends GC_Ajax_UnitTestCase {
	/**
	 * @ticket 36578
	 */
	public function test_gc_ajax_send_attachment_to_editor_should_return_an_image() {
		...
		$_POST['nonce']      = gc_create_nonce( 'media-send-to-editor' );
		$_POST['html']       = 'Bar Baz';
		$_POST['post_id']    = 0;
	 ...
	 * @group ms-excluded
	 */
	public function test_gc_ajax_send_attachment_to_editor_should_return_a_link() {
		// Become an administrator.
		$post    = $_POST;
		$user_id = self::factory()->user->create(
			array(
		...
		$expected = sprintf(
			'<a href="%s" rel="attachment gc-att-%d">Foo bar</a>',
