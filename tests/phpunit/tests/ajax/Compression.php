 ...
 * @group      ajax
 */
class Tests_Ajax_CompressionTest extends GC_Ajax_UnitTestCase {
	...
	public function test_logged_out() {
		...
		$this->_handleAjax( 'gc-compression-test' );
	}
	...
	public function test_text() {
		...
		$this->assertStringContainsString( 'gcCompressionTest', $this->_last_response );
	}
	...
	public function test_gzdeflate() {
		...
		// Ensure we found the right match.
		$this->assertStringContainsString( 'gcCompressionTest', gzinflate( $this->_last_response ) );
	}
	...
	public function test_gzencode() {
		...
		// Ensure we found the right match.
		$this->assertStringContainsString( 'gcCompressionTest', $this->_gzdecode( $this->_last_response ) );
	}
	...
	public function test_set_yes() {
		...
		// Add a nonce.
		$_GET['_ajax_nonce'] = gc_create_nonce( 'update_can_compress_scripts' );
