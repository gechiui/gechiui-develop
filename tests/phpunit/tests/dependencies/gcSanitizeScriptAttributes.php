...
/**
 * Test gc_sanitize_script_attributes().
 *
 * @group dependencies
 * @group scripts
 * @covers ::gc_sanitize_script_attributes
 */
class Tests_Functions_gcSanitizeScriptAttributes extends GC_UnitTestCase {
	...
	public function test_sanitize_script_attributes_no_attributes() {
		...
		$this->assertSame(
			'',
			gc_sanitize_script_attributes( array() )
		);
