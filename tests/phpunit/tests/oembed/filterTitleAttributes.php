 ...
 * @group oembed
 */
class Tests_Filter_oEmbed_Iframe_Title_Attribute extends GC_UnitTestCase {
	...
	public function test_oembed_iframe_title_attribute( $html, $oembed_data, $url, $expected ) {
		$actual = gc_filter_oembed_iframe_title_attribute( $html, (object) $oembed_data, $url );
	...
	public function test_filter_oembed_iframe_title_attribute() {
		...
		$actual = gc_filter_oembed_iframe_title_attribute(
			'<iframe title="Foo" src=""></iframe>',
			(object) array(
				'type'  => 'rich',
				'title' => 'Bar',
