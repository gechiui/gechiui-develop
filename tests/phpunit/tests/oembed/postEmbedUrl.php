 ...
 * @group oembed
 */
class Tests_Post_Embed_URL extends GC_UnitTestCase {
	...
	public function test_page_conflicts_with_embed_slug() {
		...
		add_filter( 'gc_unique_post_slug', array( $this, 'filter_unique_post_slug' ) );
		...
		remove_filter( 'gc_unique_post_slug', array( $this, 'filter_unique_post_slug' ) );
