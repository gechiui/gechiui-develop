 ...
 * @group oembed
 */
class Tests_oEmbed_Discovery extends GC_UnitTestCase {
	public function test_add_oembed_discovery_links_non_singular() {
		$this->assertSame( '', get_echo( 'gc_oembed_add_discovery_links' ) );
	}
	...
	public function test_add_oembed_discovery_links_static_front_page() {
		...
		$this->assertSame( $expected, get_echo( 'gc_oembed_add_discovery_links' ) );
