...
/**
 * Tests for GC_Block_List.
 *
 * @since 5.5.0
 *
 * @group blocks
 */
class Tests_Blocks_gcBlockList extends GC_UnitTestCase {
	...
	public function test_array_access() {
		$parsed_blocks = parse_blocks( '<!-- gc:example /-->' );
		$context       = array();
		$blocks        = new GC_Block_List( $parsed_blocks, $context, $this->registry );
		...
		$blocks[0]                     = new GC_Block( $parsed_blocks[0], $context, $this->registry );
	...
	public function test_iterable() {
		$parsed_blocks = parse_blocks( '<!-- gc:example --><!-- gc:example /--><!-- /gc:example -->' );
		$context       = array();
		$blocks        = new GC_Block_List( $parsed_blocks, $context, $this->registry );
		$assertions    = 0;
