...
/**
 * Tests for GC_Block_Type_Registry.
 *
 * @since 5.0.0
 *
 * @group blocks
 */
class Tests_Blocks_gcBlockTypeRegistry extends GC_UnitTestCase {
	 ...
	 * @ticket 45097
	 *
	 * @expectedIncorrectUsage GC_Block_Type_Registry::register
	 */
	...
	/**
	 * Should accept a GC_Block_Type instance
	 *
	 * @ticket 45097
	 */
	public function test_register_block_type_instance() {
		$block_type = new GC_Fake_Block_Type( 'core/fake' );
	 ...
	 * @ticket 45097
	 *
	 * @expectedIncorrectUsage GC_Block_Type_Registry::unregister
	 */
