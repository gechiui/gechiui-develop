 ...
 * @group blocks
 */
class Tests_Blocks_SupportedStyles extends GC_UnitTestCase {
	 ...
	 *
	 * @param string|GC_Block_Type $name Block type name including namespace, or alternatively a
	 *                                   complete GC_Block_Type instance. In case a GC_Block_Type
	...
	private function render_example_block( $block ) {
		GC_Block_Supports::init();
		GC_Block_Supports::$block_to_render = $block;
	...
	public function test_named_color_support() {
		...
		$expected_classes = 'foo-bar-class gc-block-example has-text-color has-red-color has-background has-black-background-color';
	...
	public function test_custom_color_support() {
		...
		$expected_classes = 'foo-bar-class gc-block-example has-text-color has-background';
	...
	public function test_named_gradient_support() {
		...
		$expected_classes = 'foo-bar-class gc-block-example has-background has-red-gradient-background';
		$expected_styles  = 'test: style;';
	...
	public function test_custom_gradient_support() {
		...
		$expected_classes = 'foo-bar-class gc-block-example has-background';
	...
	public function test_color_unsupported() {
		...
		$expected_classes = 'foo-bar-class gc-block-example';
		$expected_styles  = 'test: style;';
	...
	public function test_named_font_size() {
		...
		$expected_classes = 'foo-bar-class gc-block-example has-large-font-size';
		$expected_styles  = 'test: style;';
	...
	public function test_block_alignment() {
		...
		$expected_classes = 'foo-bar-class gc-block-example alignwide';
		$expected_styles  = 'test: style;';
	...
	public function test_all_supported() {
		...
		$expected_classes = 'foo-bar-class gc-block-example has-text-color has-background alignwide';
	...
	public function test_custom_classnames_support() {
		...
		$expected_styles  = 'test: style;';
		$expected_classes = 'foo-bar-class gc-block-example my-custom-classname';
	...
	public function test_render_block_suppresses_warnings_without_at_suppression() {
		...
		apply_filters( 'render_block', '<div><time datetime="2020-06-18T04:01:43+10:00" class="gc-block-latest-posts__post-date">June 18, 2020</time></div>', $block );
