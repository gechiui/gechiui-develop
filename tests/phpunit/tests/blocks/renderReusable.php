 ...
 * @group blocks
 */
class Tests_Blocks_RenderReusable extends GC_UnitTestCase {
	/**
	 * Fake user ID.
	 *
	 * @var int
	 ...
	 * @since 5.0.0
	 *
	 * @param GC_UnitTest_Factory $factory Helper that creates fake data.
	 */
	...
	public function test_render() {
		$block_type = GC_Block_Type_Registry::get_instance()->get_registered( 'core/block' );
