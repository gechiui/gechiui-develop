 ...
 * @group blocks
 */
class Tests_Blocks_Context extends GC_UnitTestCase {
	...
	public function test_provides_block_context() {
		...
		$parsed_blocks = parse_blocks(
			'<!-- gc:gutenberg/test-context-provider {"contextWithAssigned":10} -->' .
			'<!-- gc:gutenberg/test-context-consumer /-->' .
			'<!-- /gc:gutenberg/test-context-provider -->'
		);
	...
	public function test_provides_default_context() {
		...
		$parsed_blocks = parse_blocks( '<!-- gc:gutenberg/test-context-consumer /-->' );
