 ...
 */
class Tests_Date_GetPostTime extends GC_UnitTestCase {
	...
	public function test_should_return_gc_timestamp() {
		...
		$this->assertSame( $gc_timestamp, get_post_time( 'U', false, $post_id ) );
		$this->assertSame( $gc_timestamp, get_post_time( 'G', false, $post_id ) );
		$this->assertSame( $timestamp, get_post_time( 'U', true, $post_id ) );
		$this->assertSame( $timestamp, get_post_time( 'G', true, $post_id ) );
		$this->assertSame( $gc_timestamp, get_post_modified_time( 'U', false, $post_id ) );
		$this->assertSame( $gc_timestamp, get_post_modified_time( 'G', false, $post_id ) );
