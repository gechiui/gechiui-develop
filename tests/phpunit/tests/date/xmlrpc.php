 ...
 * @covers IXR_Date
 */
class Tests_Date_XMLRPC extends GC_XMLRPC_UnitTestCase {

	/**
	 * @ticket 30429
	 *
	 * @covers gc_xmlrpc_server::mw_newPost
	 */
	public function test_date_new_post() {
		...
		$post = get_post(
			$this->myxmlrpcserver->gc_newPost(
				array(
					1,
					'editor',
					'editor',
	 ...
	 * @ticket 30429
	 *
	 * @covers gc_xmlrpc_server::mw_editPost
	 */
	 ...
	 * @ticket 30429
	 *
	 * @covers gc_xmlrpc_server::gc_editComment
	 */
	public function test_date_edit_comment() {
		...
		$comment_id   = gc_insert_comment( $comment_data );

		$result = $this->myxmlrpcserver->gc_editComment(
			array(
				1,
				'administrator',
				'administrator',
