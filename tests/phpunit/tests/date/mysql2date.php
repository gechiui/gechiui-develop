 ...
 * @covers ::mysql2date
 */
class Tests_Date_mysql2date extends GC_UnitTestCase {
	 ...
	 * @ticket 28992
	 */
	public function test_mysql2date_should_return_gc_timestamp() {
		$timezone = 'Europe/Kiev';
		update_option( 'timezone_string', $timezone );
		$datetime     = new DateTime( 'now', new DateTimeZone( $timezone ) );
		...
		$this->assertSame( $gc_timestamp, mysql2date( 'U', $mysql, false ) );
		$this->assertSame( $gc_timestamp, mysql2date( 'G', $mysql, false ) );
	}
