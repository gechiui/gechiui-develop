<?php
/**
 * Test cases for the `gc_privacy_generate_personal_data_export_group_html()` function.
 *
 * @package GeChiUI
...
/**
 * Tests_Privacy_gcPrivacyGeneratePersonalDataExportGroupHtml class.
 *
 * @group privacy
 * @covers ::gc_privacy_generate_personal_data_export_group_html
 *
 * @since 5.2.0
 */
class Tests_Privacy_gcPrivacyGeneratePersonalDataExportGroupHtml extends GC_UnitTestCase {
	...
	public function test_group_html_generation_single_data_item() {
		...
		$actual                = gc_privacy_generate_personal_data_export_group_html( $data, 'test-data-group', 2 );
	...
	public function test_links_become_anchors() {
		$data = array(
			...
			'items'       => array(
				array(
					array(
						'name'  => 'HTTP Link',
						'value' => 'http://www.gechiui.com',
					),
					array(
						'name'  => 'HTTPS Link',
						'value' => 'https://www.gechiui.com',
					),
					array(
						'name'  => 'Link with Spaces',
						'value' => 'https://www.gechiui.com not a link.',
					),
				),
			),
		);
		...
		$this->assertStringContainsString( '<a href="http://www.gechiui.com">http://www.gechiui.com</a>', $actual );
		$this->assertStringContainsString( '<a href="https://www.gechiui.com">https://www.gechiui.com</a>', $actual );
		$this->assertStringContainsString( 'https://www.gechiui.com not a link.', $actual );
	}
	...
	public function test_group_labels_escaped() {
		...
		$actual = gc_privacy_generate_personal_data_export_group_html( $data, 'escape-html-in-group-labels', 2 );
			...
			'items'       => array(
				array(
					'links'      => array(
						...
						'value' => '<a href="http://www.gechiui.com">http://www.gechiui.com</a>',
					),
					'formatting' => array(
