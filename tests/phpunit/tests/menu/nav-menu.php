 ...
 * @group menu
 */
class Tests_Nav_Menu_Theme_Change extends GC_UnitTestCase {
	 ...
	 *
	 * @covers ::gc_map_nav_menu_locations
	 */
	public function test_one_location_each() {
		...
		$new_next_theme_nav_menu_locations = gc_map_nav_menu_locations( $old_next_theme_nav_menu_locations, $prev_theme_nav_menu_locations );
	...
	public function test_new_theme_previously_active() {
		...
		$expected_nav_menu_locations = gc_array_slice_assoc( $prev_theme_nav_menu_locations, array_keys( get_registered_nav_menus() ) );
		$this->assertSame( $expected_nav_menu_locations, $new_next_theme_nav_menu_locations );
	}
	...
	public function test_numerical_old_locations() {
		...
		$new_next_theme_nav_menu_locations = gc_map_nav_menu_locations( $next_theme_nav_menu_locations, $old_nav_menu_locations );
