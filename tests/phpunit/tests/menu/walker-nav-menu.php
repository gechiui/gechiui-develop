 ...
 * @group walker
 */
class Tests_Menu_Walker_Nav_Menu extends GC_UnitTestCase {
	...
	public function set_up() {
		...
		require_once ABSPATH . 'gc-includes/class-walker-nav-menu.php';
		$this->walker = new Walker_Nav_Menu();

		$this->_gc_nav_menu_max_depth = $_gc_nav_menu_max_depth;
	}
	...
	public function tear_down() {
		...
		$_gc_nav_menu_max_depth = $this->_gc_nav_menu_max_depth;
		parent::tear_down();
	}
