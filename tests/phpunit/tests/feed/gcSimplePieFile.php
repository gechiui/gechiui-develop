<?php
/**
 * Unit tests for methods in `GC_SimplePie_File`.
 *
 * @package GeChiUI
...
/**
 * Tests the `GC_SimplePie_File` class.
 *
 * @group feed
 * @group gc-simplepie-file
 *
 * @since 5.6.1
 */
class Tests_Feed_gcSimplePieFile extends GC_UnitTestCase {
	public static function set_up_before_class() {
		parent::set_up_before_class();

		require_once ABSPATH . '/gc-includes/class-simplepie.php';
		require_once ABSPATH . '/gc-includes/class-gc-simplepie-file.php';
	}
	 ...
	 *
	 * @covers GC_SimplePie_File::__construct
	 *
	 * @since 5.6.1
	 *
	 * @ticket 51056
	...
	public function test_header_parsing( $callback, $header_field, $expected ) {
		...
		$file = new GC_SimplePie_File( 'https://www.gechiui.com/news/feed/' );
	...
	public function data_header_parsing() {
		return array(
			...
			'single generic header works'      => array(
				'mocked_response_single_header_values',
				'link',
				'<https://www.gechiui.com/news/gc-json/>; rel="https://api.w.org/"',
			),
			...
			'multiple generic header values should be merged into a comma separated string' => array(
				'mocked_response_multiple_header_values',
				'link',
				'<https://www.gechiui.com/news/gc-json/>; rel="https://api.w.org/", <https://www.gechiui.com/news/gc/v2/categories/3>; rel="alternate"; type="application/json"',
			),
		);
	}
	...
	public function mocked_response_multiple_header_values() {
		...
		$multiple_value_headers = array(
			...
			'link'         => array(
				'<https://www.gechiui.com/news/gc-json/>; rel="https://api.w.org/"',
				'<https://www.gechiui.com/news/gc/v2/categories/3>; rel="alternate"; type="application/json"',
			),
		);
