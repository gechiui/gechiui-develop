 ...
 * @group scripts
 */
class Tests_Dependencies extends GC_UnitTestCase {
	public function test_add() {
		$dep = new GC_Dependencies;

		$this->assertTrue( $dep->add( 'one', '' ) );
		$this->assertTrue( $dep->add( 'two', '' ) );

		$this->assertInstanceOf( '_GC_Dependency', $dep->query( 'one' ) );
		$this->assertInstanceOf( '_GC_Dependency', $dep->query( 'two' ) );
	...
	public function test_query_and_registered_enqueued() {
		...
		$this->assertTrue( $dep->add( 'one', '' ) );
		$this->assertInstanceOf( '_GC_Dependency', $dep->query( 'one' ) );
		$this->assertInstanceOf( '_GC_Dependency', $dep->query( 'one', 'registered' ) );
		$this->assertInstanceOf( '_GC_Dependency', $dep->query( 'one', 'scripts' ) );
