 ...
 * @group i18n
 */
class Tests_L10n extends GC_UnitTestCase {
	 ...
	 * @ticket 35284
	 */
	public function test_gc_get_installed_translations_for_core() {
		$installed_translations = gc_get_installed_translations( 'core' );
	 ...
	 * @ticket 35294
	 */
	public function test_gc_dropdown_languages() {
		$args   = array(
			'id'           => 'foo',
			'name'         => 'bar',
			'languages'    => array( 'de_DE' ),
			'translations' => $this->gc_dropdown_languages_filter(),
			'selected'     => 'de_DE',
			'echo'         => false,
		);
		$actual = gc_dropdown_languages( $args );
	 ...
	 * @ticket 38632
	 */
	public function test_gc_dropdown_languages_site_default() {
		$args   = array(
			'id'                       => 'foo',
			'name'                     => 'bar',
			'languages'                => array( 'de_DE' ),
	 ...
	 * @ticket 44494
	 */
	public function test_gc_dropdown_languages_exclude_en_us() {
		$args   = array(
			'id'                => 'foo',
			'name'              => 'bar',
			'languages'         => array( 'de_DE' ),
	 ...
	 * @ticket 38632
	 */
	public function test_gc_dropdown_languages_en_US_selected() {
		$args   = array(
			'id'           => 'foo',
			'name'         => 'bar',
			'languages'    => array( 'de_DE' ),
	 ...
	 */
	public function test_gc_dropdown_languages_site_default_ja_JP() {
		$args   = array(
			'id'                       => 'foo',
			'name'                     => 'bar',
	 ...
	 */
	public function test_gc_dropdown_languages_ja_JP_selected() {
		$args   = array(
			'id'           => 'foo',
			'name'         => 'bar',
			'languages'    => array( 'de_DE' ),
	 ...
	 * @return array
	 */
	private function gc_dropdown_languages_filter() {
		return array(
			'de_DE' => array(
				'language'    => 'de_DE',
				'native_name' => 'Deutsch',
	 ...
	 * @ticket 35284
	 */
	public function test_gc_get_pomo_file_data() {
		$file  = DIR_TESTDATA . '/pomo/empty.po';
		$array = gc_get_pomo_file_data( $file );
