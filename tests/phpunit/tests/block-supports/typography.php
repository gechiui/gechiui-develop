 ...
 */
class Tests_Block_Supports_Typography extends GC_UnitTestCase {
	...
	function test_font_size_slug_with_numbers_is_kebab_cased_properly() {
		...
		$actual   = gc_apply_typography_support( $block_type, $block_atts );
	...
	function test_font_family_with_legacy_inline_styles_using_a_css_var() {
		...
		$actual   = gc_apply_typography_support( $block_type, $block_atts );
		$expected = array( 'style' => 'font-family: var(--gc--preset--font-family--h-1);' );
