 ...
 */
class Tests_Media_GetAdjacentImageLink extends GC_Test_Adjacent_Image_Link_TestCase {
	...
	public function data_get_adjacent_image_link() {
		return array(
			...
			'when has previous link'           => array(
				...
				'expected'                  => '<a href=\'http://example.org/?attachment_id=%%ID%%\'><img width="1" height="1" src="http://example.org/gc-content/uploads/image2.jpg" class="attachment-thumbnail size-thumbnail" alt="" loading="lazy" /></a>',
			),
			...
			'when has next link'               => array(
				...
				'expected'                  => '<a href=\'http://example.org/?attachment_id=%%ID%%\'><img width="1" height="1" src="http://example.org/gc-content/uploads/image5.jpg" class="attachment-thumbnail size-thumbnail" alt="" loading="lazy" /></a>',
