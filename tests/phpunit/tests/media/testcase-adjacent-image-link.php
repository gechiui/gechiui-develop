...
abstract class GC_Test_Adjacent_Image_Link_TestCase extends GC_UnitTestCase {
	/**
	 ...
	 *
	 * @var int[]|GC_Error[] Array of attachment IDs.
	 */
	 ...
	 *
	 * @param GC_UnitTest_Factory $factory Instance of the factory.
	 */
