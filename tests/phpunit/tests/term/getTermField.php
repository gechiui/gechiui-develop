 ...
 * @group taxonomy
 */
class Tests_Term_getTermField extends GC_UnitTestCase {

	public $taxonomy = 'gctests_tax';
	 ...
	 * @ticket 34245
	 */
	public function test_get_term_field_should_accept_a_GC_Term_id_or_object() {
		$term = self::factory()->term->create_and_get( array( 'taxonomy' => $this->taxonomy ) );
	 ...
	 * @ticket 34245
	 */
	public function test_get_term_field_invalid_taxonomy_should_return_GC_Error() {
		$term = self::factory()->term->create_and_get( array( 'taxonomy' => $this->taxonomy ) );
	 ...
	 * @ticket 34245
	 */
	public function test_get_term_field_invalid_term_should_return_GC_Error() {
