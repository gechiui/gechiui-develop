 ...
 * @group taxonomy
 */
class Tests_Term_GcInsertTerm extends GC_UnitTestCase {
	public function set_up() {
		...
		foreach ( get_object_taxonomies( 'post' ) as $tax ) {
			gc_insert_term( $term, $tax );
		}
	}

	public function test_gc_insert_delete_term() {
		...
		$initial_count = gc_count_terms( array( 'taxonomy' => $taxonomy ) );

		$t = gc_insert_term( $term, $taxonomy );
		$this->assertIsArray( $t );
		$this->assertNotWPError( $t );
		$this->assertGreaterThan( 0, $t['term_id'] );
		$this->assertGreaterThan( 0, $t['term_taxonomy_id'] );
		$this->assertEquals( $initial_count + 1, gc_count_terms( array( 'taxonomy' => $taxonomy ) ) );
		...
		$this->assertTrue( gc_delete_term( $t['term_id'], $taxonomy ) );
		remove_filter( 'delete_term', array( $this, 'deleted_term_cb' ), 10, 5 );
		$this->assertNull( term_exists( $term ) );
		$this->assertNull( term_exists( $t['term_id'] ) );
		$this->assertSame( $initial_count, gc_count_terms( array( 'taxonomy' => $taxonomy ) ) );
	}

	public function test_gc_insert_term_taxonomy_does_not_exist() {
		$found = gc_insert_term( 'foo', 'bar' );

		$this->assertWPError( $found );
		$this->assertSame( 'invalid_taxonomy', $found->get_error_code() );
	}

	public function test_gc_insert_term_pre_insert_term_filter_returns_gc_error() {
		add_filter( 'pre_insert_term', array( $this, '_pre_insert_term_callback' ) );
		$found = gc_insert_term( 'foo', 'post_tag' );
	...
	public function test_gc_insert_term_term_0() {
		$found = gc_insert_term( 0, 'post_tag' );

		$this->assertWPError( $found );
		$this->assertSame( 'invalid_term_id', $found->get_error_code() );
	}

	public function test_gc_insert_term_term_trims_to_empty_string() {
		$found = gc_insert_term( '  ', 'post_tag' );

		$this->assertWPError( $found );
		$this->assertSame( 'empty_term_name', $found->get_error_code() );
	}

	public function test_gc_insert_term_parent_does_not_exist() {
		$found = gc_insert_term(
			'foo',
			'post_tag',
			array(
				'parent' => 999999,
	...
	public function test_gc_insert_term_unslash_name() {
		register_taxonomy( 'gctests_tax', 'post' );
		$found = gc_insert_term( 'Let\\\'s all say \\"Hooray\\" for GeChiUI taxonomy', 'gctests_tax' );
	...
	public function test_gc_insert_term_unslash_description() {
		register_taxonomy( 'gctests_tax', 'post' );
		$found = gc_insert_term(
			'Quality',
			'gctests_tax',
	...
	public function test_gc_insert_term_parent_string() {
		register_taxonomy( 'gctests_tax', 'post' );
		$found = gc_insert_term(
			'Quality',
			'gctests_tax',
	...
	public function test_gc_insert_term_slug_empty_string() {
		register_taxonomy( 'gctests_tax', 'post' );
		$found = gc_insert_term(
			'Quality',
			'gctests_tax',
	...
	public function test_gc_insert_term_slug_whitespace_string() {
		register_taxonomy( 'gctests_tax', 'post' );
		$found = gc_insert_term(
			'Quality',
			'gctests_tax',
	...
	public function test_gc_insert_term_slug_0() {
		register_taxonomy( 'gctests_tax', 'post' );
		$found = gc_insert_term(
			'Quality',
			'gctests_tax',
	 ...
	 * @ticket 17689
	 */
	public function test_gc_insert_term_duplicate_name() {
		...
		$this->assertCount( 4, array_unique( gc_list_pluck( $terms, 'slug' ) ) );
	 ...
	 * @ticket 31328
	 */
	public function test_gc_insert_term_should_not_allow_duplicate_names_when_slug_is_a_duplicate_of_the_same_term_in_non_hierarchical_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post' );
	 ...
	 * @ticket 31328
	 */
	public function test_gc_insert_term_should_not_allow_duplicate_names_when_slug_is_a_duplicate_of_a_different_term_in_non_hierarchical_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post' );
		$t1 = self::factory()->term->create(
			array(
				'name'     => 'Foo',
	 ...
	 * @ticket 31328
	 */
	public function test_gc_insert_term_should_allow_duplicate_names_when_a_unique_slug_has_been_provided_in_non_hierarchical_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post' );
		$t1 = self::factory()->term->create(
			array(
				'name'     => 'Foo',
		...
		$t2_term = get_term( $t2['term_id'], 'gctests_tax' );
	 ...
	 * @ticket 31328
	 */
	public function test_gc_insert_term_should_not_allow_duplicate_names_when_the_slug_is_not_provided_in_non_hierarchical_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post' );
		$t1 = self::factory()->term->create(
			array(
				'name'     => 'Foo',
		...
		$t2 = gc_insert_term( 'Foo', 'gctests_tax' );
	 ...
	 * @ticket 31328
	 */
	public function test_gc_insert_term_should_not_allow_duplicate_names_when_slug_is_a_duplicate_of_the_same_term_in_hierarchical_taxonomy() {
	 ...
	 * @ticket 31328
	 */
	public function test_gc_insert_term_should_not_allow_duplicate_names_when_slug_is_a_duplicate_of_a_different_term_at_same_hierarchy_level_in_hierarchical_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post', array( 'hierarchical' => true ) );
		$t1 = self::factory()->term->create(
			array(
				'name'     => 'Foo',
	 ...
	 * @ticket 31328
	 */
	public function test_gc_insert_term_should_allow_duplicate_names_when_slug_is_a_duplicate_of_a_term_at_different_hierarchy_level_in_hierarchical_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post', array( 'hierarchical' => true ) );
		$t1 = self::factory()->term->create(
			array(
				'name'     => 'Foo',
		...
		$t4_term = get_term( $t4['term_id'], 'gctests_tax' );

		// `gc_unique_term_slug()` allows term creation but iterates the slug.
	...
	public function test_duplicate_name_check_should_fail_when_no_slug_is_provided_even_when_slugs_would_not_clash() {
		...
		$error = gc_insert_term( 'Foo', 'gctests_tax' );
	 ...
	 * @ticket 31328
	 */
	public function test_gc_insert_term_should_allow_duplicate_names_when_a_unique_slug_has_been_provided_in_hierarchical_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post', array( 'hierarchical' => true ) );
		$t1 = self::factory()->term->create(
			array(
				'name'     => 'Foo',
	 ...
	 * @ticket 31328
	 */
	public function test_gc_insert_term_should_not_allow_duplicate_names_when_the_slug_is_not_provided_in_hierarchical_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post', array( 'hierarchical' => true ) );
		$t1 = self::factory()->term->create(
			array(
				'name'     => 'Foo',
	 ...
	 * @ticket 5809
	 */
	public function test_gc_insert_term_duplicate_slug_same_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post' );
		...
		$created_term = get_term( $created['term_id'], 'gctests_tax' );
	 ...
	 * @ticket 5809
	 */
	public function test_gc_insert_term_duplicate_slug_different_taxonomy() {
		register_taxonomy( 'gctests_tax', 'post' );
		...
		$new_term = get_term( $created['term_id'], 'gctests_tax_2' );
	 ...
	 * @ticket 5809
	 */
	public function test_gc_insert_term_duplicate_slug_different_taxonomy_before_410_schema_change() {
	...
	public function test_gc_insert_term_alias_of_no_term_group() {
		register_taxonomy( 'gctests_tax', 'post' );
		$t1     = self::factory()->term->create(
			array(
				'taxonomy' => 'gctests_tax',
		...
		$created_term_ids = gc_insert_term(
			'Foo',
			'gctests_tax',
			array(
		...
		$updated_term_1 = get_term( $term_1->term_id, 'gctests_tax' );

		$term = get_term( $created_term_ids['term_id'], 'gctests_tax' );
		_unregister_taxonomy( 'gctests_tax' );
	...
	public function test_gc_insert_term_alias_of_existing_term_group() {
		register_taxonomy( 'gctests_tax', 'post' );
		$t1     = self::factory()->term->create(
			array(
				'taxonomy' => 'gctests_tax',
	...
	public function test_gc_insert_term_alias_of_nonexistent_term() {
		register_taxonomy( 'gctests_tax', 'post' );
		$created_term_ids = gc_insert_term(
			'Foo',
			'gctests_tax',
	 ...
	 * @ticket 5809
	 */
	public function test_gc_insert_term_should_not_create_shared_term() {
		register_taxonomy( 'gctests_tax', 'post' );
		register_taxonomy( 'gctests_tax_2', 'post' );
	...
	public function test_gc_insert_term_should_return_term_id_and_term_taxonomy_id() {
		register_taxonomy( 'gctests_tax', 'post' );
		$found = gc_insert_term( 'foo', 'gctests_tax' );
	...
	public function test_gc_insert_term_should_clean_term_cache() {
		register_taxonomy(
			'gctests_tax',
			'post',
			array(
	 ...
	 * @ticket 33864
	 */
	public function test_gc_insert_term_with_and_without_accents() {
		register_taxonomy( 'gctests_tax', 'post' );
	...
	public function test_term_whose_slug_matches_existing_term_but_name_does_not_should_get_suffixed_slug() {
		...
		$created = gc_insert_term( 'Foo$bar', 'gctests_tax' );
	 ...
	 * @ticket 35321
	 */
	public function test_gc_insert_term_with_null_description() {
		...
		$this->assertInstanceOf( 'GC_Term', $term_object );
	...
	public function _pre_insert_term_callback() {
		return new GC_Error( 'custom_error' );
	}
}
