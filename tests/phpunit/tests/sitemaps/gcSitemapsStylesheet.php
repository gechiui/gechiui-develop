 ...
 * @group sitemaps
 */
class Tests_Sitemaps_gcSitemapsStylesheet extends GC_UnitTestCase {
	...
	public function test_filter_sitemaps_stylesheet_content() {
		...
		add_filter( 'gc_sitemaps_stylesheet_content', '__return_empty_string' );
	...
	public function test_filter_sitemaps_stylesheet_index_content() {
		...
		add_filter( 'gc_sitemaps_stylesheet_index_content', '__return_empty_string' );
	...
	public function test_filter_sitemaps_stylesheet_css() {
		...
		add_filter( 'gc_sitemaps_stylesheet_css', '__return_empty_string' );
