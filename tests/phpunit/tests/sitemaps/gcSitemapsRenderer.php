 ...
 * @group sitemaps
 */
class Tests_Sitemaps_gcSitemapsRenderer extends GC_Test_XML_TestCase {

	public function test_get_sitemap_stylesheet_url() {
		$sitemap_renderer = new GC_Sitemaps_Renderer();
	...
	public function test_get_sitemap_stylesheet_url_pretty_permalinks() {
		...
		$this->assertStringEndsWith( '/gc-sitemap.xsl', $stylesheet_url );
	}
	...
	public function test_get_sitemap_index_stylesheet_url_pretty_permalinks() {
		...
		$this->assertStringEndsWith( '/gc-sitemap-index.xsl', $stylesheet_url );
	}
	...
	public function test_get_sitemap_index_xml() {
		$entries = array(
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/gc-sitemap-posts-post-1.xml',
			),
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/gc-sitemap-posts-page-1.xml',
			),
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/gc-sitemap-taxonomies-category-1.xml',
			),
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/gc-sitemap-taxonomies-post_tag-1.xml',
			),
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/gc-sitemap-users-1.xml',
			),
		);

		$renderer = new GC_Sitemaps_Renderer();

		$actual   = $renderer->get_sitemap_index_xml( $entries );
		$expected = '<?xml version="1.0" encoding="UTF-8"?>' .
					'<?xml-stylesheet type="text/xsl" href="http://' . GC_TESTS_DOMAIN . '/?sitemap-stylesheet=index" ?>' .
					'<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">' .
					'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-posts-post-1.xml</loc></sitemap>' .
					'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-posts-page-1.xml</loc></sitemap>' .
					'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-taxonomies-category-1.xml</loc></sitemap>' .
					'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-taxonomies-post_tag-1.xml</loc></sitemap>' .
					'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-users-1.xml</loc></sitemap>' .
					'</sitemapindex>';
	...
	public function test_get_sitemap_index_xml_with_lastmod() {
		...
		$expected = '<?xml version="1.0" encoding="UTF-8"?>' .
			'<?xml-stylesheet type="text/xsl" href="http://' . GC_TESTS_DOMAIN . '/?sitemap-stylesheet=index" ?>' .
			'<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">' .
			'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-posts-post-1.xml</loc><lastmod>2005-01-01</lastmod></sitemap>' .
			'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-posts-page-1.xml</loc><lastmod>2005-01-01</lastmod></sitemap>' .
			'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-taxonomies-category-1.xml</loc><lastmod>2005-01-01</lastmod></sitemap>' .
			'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-taxonomies-post_tag-1.xml</loc><lastmod>2005-01-01</lastmod></sitemap>' .
			'<sitemap><loc>http://' . GC_TESTS_DOMAIN . '/gc-sitemap-users-1.xml</loc><lastmod>2005-01-01</lastmod></sitemap>' .
			'</sitemapindex>';
	 ...
	 *
	 * @expectedIncorrectUsage GC_Sitemaps_Renderer::get_sitemap_index_xml
	 */
	...
	public function test_get_sitemap_index_xml_without_stylesheet() {
		...
		add_filter( 'gc_sitemaps_stylesheet_index_url', '__return_false' );
	...
	public function test_get_sitemap_xml() {
		$url_list = array(
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/2019/10/post-1',
			),
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/2019/10/post-2',
			),
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/2019/10/post-3',
			),
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/2019/10/post-4',
			),
			array(
				'loc' => 'http://' . GC_TESTS_DOMAIN . '/2019/10/post-5',
			),
		);
		...
		$expected = '<?xml version="1.0" encoding="UTF-8"?>' .
					'<?xml-stylesheet type="text/xsl" href="http://' . GC_TESTS_DOMAIN . '/?sitemap-stylesheet=sitemap" ?>' .
					'<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">' .
					'<url><loc>http://' . GC_TESTS_DOMAIN . '/2019/10/post-1</loc></url>' .
					'<url><loc>http://' . GC_TESTS_DOMAIN . '/2019/10/post-2</loc></url>' .
					'<url><loc>http://' . GC_TESTS_DOMAIN . '/2019/10/post-3</loc></url>' .
					'<url><loc>http://' . GC_TESTS_DOMAIN . '/2019/10/post-4</loc></url>' .
					'<url><loc>http://' . GC_TESTS_DOMAIN . '/2019/10/post-5</loc></url>' .
					'</urlset>';
	...
	public function test_get_sitemap_xml_without_stylesheet() {
		...
		add_filter( 'gc_sitemaps_stylesheet_url', '__return_false' );
	 ...
	 * this test will need to be updated accordingly.
	 *
	 * @expectedIncorrectUsage GC_Sitemaps_Renderer::get_sitemap_xml
	 */
