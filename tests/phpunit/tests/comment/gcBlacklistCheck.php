 ...
 * @group comment
 */
class Tests_GC_Blocklist_Check extends GC_UnitTestCase {
	...
	public function test_should_return_true_when_content_matches_disallowed_keys() {
		...
		$result = gc_check_comment_disallowed_list( $author, $author_email, $author_url, $comment, $author_ip, $user_agent );
