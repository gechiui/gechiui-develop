 ...
 * @ticket 38027
 */
class Tests_Comment_Last_Modified extends GC_UnitTestCase {
	...
	public function test_data_is_cached() {
		...
		$this->assertSame( strtotime( '2015-04-01 10:00:00' ), strtotime( gc_cache_get( 'lastcommentmodified:server', 'timeinfo' ) ) );
	}
	...
	public function test_cache_is_cleared() {
		...
		$this->assertSame( strtotime( '2000-01-01 10:00:00' ), strtotime( gc_cache_get( 'lastcommentmodified:server', 'timeinfo' ) ) );
		...
		$this->assertFalse( gc_cache_get( 'lastcommentmodified:server', 'timeinfo' ) );
		$this->assertSame( strtotime( '2000-01-02 10:00:00' ), strtotime( get_lastcommentmodified() ) );
		$this->assertSame( strtotime( '2000-01-02 10:00:00' ), strtotime( gc_cache_get( 'lastcommentmodified:server', 'timeinfo' ) ) );
	}
	...
	public function test_cache_is_cleared_when_comment_is_trashed() {
		...
		gc_trash_comment( $comment_2->comment_ID );

		$this->assertFalse( gc_cache_get( 'lastcommentmodified:server', 'timeinfo' ) );
		$this->assertSame( strtotime( '1998-01-01 10:00:00' ), strtotime( get_lastcommentmodified() ) );
		$this->assertSame( strtotime( '1998-01-01 10:00:00' ), strtotime( gc_cache_get( 'lastcommentmodified:server', 'timeinfo' ) ) );
	}
}
