 ...
 * @group comment
 */
class Tests_Comment_Template extends GC_UnitTestCase {
	/**
	 * Shared post ID.
	 *
	 * @var int
	 ...
	 *
	 * @param GC_UnitTest_Factory $factory Unit test factory.
	 */
	...
	public function data_get_comments_number_text_declension() {
		return array(
			...
			array(
				2,
				'2 Comments<span class="screen-reader-text"> on Hello % world!</span>',
				'2 Comments<span class="screen-reader-text"> on Hello 2 world!</span>', // See #GC37103.
			),
			array(
				2,
