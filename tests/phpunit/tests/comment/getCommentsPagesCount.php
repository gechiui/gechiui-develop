 ...
 * @group comment
 */
class Tests_Comment_GetCommentsPagesCount extends GC_UnitTestCase {
	...
	/**
	 * Validate $gc_query logic of get_comment_pages_count
	 */
	public function test_gc_query_comments_per_page() {
		global $gc_query;
		...
		$gc_query->query_vars['comments_per_page'] = null;
	...
	public function test_max_num_comment_pages() {
		...
		$org_max_num_comment_pages = $gc_query->max_num_comment_pages;

		$gc_query->max_num_comment_pages = 7;
		...
		$gc_query->max_num_comment_pages = $org_max_num_comment_pages;
	}
}
