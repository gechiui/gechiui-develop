 ...
 * @group option
 */
class Tests_Sanitize_Option extends GC_UnitTestCase {
	...
	public function test_emoji_in_blogname_and_description() {
		...
		if ( 'utf8mb4' === $gcdb->get_col_charset( $gcdb->options, 'option_value' ) ) {
			$expected = $value;
		} else {
			$expected = 'whee&#x1f608;';
		}
	...
	public function permalink_structure_provider() {
		return array(
			...
			array( new GC_Error( 'gcdb_get_table_charset_failure' ), false, false ), // @ticket 53986
		);
	}
