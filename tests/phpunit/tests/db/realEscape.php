...
/**
 * Test GCDB _real_escape() method.
 *
 * @group  gcdb
 * @covers gcdb::_real_escape
 */
class Tests_DB_RealEscape extends GC_UnitTestCase {

	/**
	 * Test that various types of input passed to `gcdb::_real_escape()` are handled correctly.
	 *
	...
	public function test_real_escape_input_type_handling( $input, $expected ) {
		...
		$this->assertSame( $expected, $gcdb->_real_escape( $input ) );
	}
