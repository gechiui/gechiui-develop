 ...
 * @group formatting
 */
class Tests_Post_Output extends GC_UnitTestCase {
...
EOF;
		...
		foreach ( array( true, false ) as $strip_teaser ) {
			...
			$this->assertStringNotContainsString( 'gc:more', $actual );
			$this->assertStringNotContainsString( 'gc:paragraph', $actual );
		}
	}
