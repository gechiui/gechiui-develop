 ...
 * @group post
 */
class Tests_Post_gcListPages extends GC_UnitTestCase {
	/**
	 * Editor user ID.
	 *
	 * @var int
	...
	public function test_gc_list_pages_default() {
		$args = array(
			'echo' => false,
		);
...
<ul class=\'children\'>
	...
	<li class="page_item page-item-' . self::$children[ self::$parent_3 ][2] . '"><a href="' . get_permalink( self::$children[ self::$parent_3 ][2] ) . '">Child 3</a></li>
		...
		$this->assertSameIgnoreEOL( $expected, gc_list_pages( $args ) );
	}

	public function test_gc_list_pages_depth() {
		$args = array(
			'echo'  => false,
			'depth' => 1,
		);
...
<li class="page_item page-item-' . self::$parent_3 . ' page_item_has_children"><a href="' . get_permalink( self::$parent_3 ) . '">Parent 3</a></li>
	...
	public function test_gc_list_pages_show_date() {
		$args = array(
			'echo'      => false,
			'depth'     => 1,
			'show_date' => true,
...
<li class="page_item page-item-' . self::$parent_3 . ' page_item_has_children"><a href="' . get_permalink( self::$parent_3 ) . '">Parent 3</a> ' . $date . '</li>
	...
	public function test_gc_list_pages_date_format() {
		$args = array(
			'echo'        => false,
			'show_date'   => true,
			'date_format' => 'l, F j, Y',
...
<ul class=\'children\'>
	...
	public function test_gc_list_pages_child_of() {
		$args = array(
			'echo'     => false,
...
<li class="page_item page-item-' . self::$children[ self::$parent_2 ][2] . '"><a href="' . get_permalink( self::$children[ self::$parent_2 ][2] ) . '">Child 3</a></li>
	...
	public function test_gc_list_pages_exclude() {
		$args = array(
			'echo'    => false,
...
<li class="page_item page-item-' . self::$children[ self::$parent_2 ][2] . '"><a href="' . get_permalink( self::$children[ self::$parent_2 ][2] ) . '">Child 3</a></li>
	...
	public function test_gc_list_pages_title_li() {
		$args = array(
			'echo'     => false,
			'depth'    => 1,
			'title_li' => 'PageTitle',
...
<li class="page_item page-item-' . self::$parent_3 . ' page_item_has_children"><a href="' . get_permalink( self::$parent_3 ) . '">Parent 3</a></li>
	...
	public function test_gc_list_pages_echo() {
		$args = array(
			'echo'  => true,
			'depth' => 1,
		);
...
<li class="page_item page-item-' . self::$parent_3 . ' page_item_has_children"><a href="' . get_permalink( self::$parent_3 ) . '">Parent 3</a></li>
	...
	public function test_gc_list_pages_authors() {
		$args = array(
			'echo'    => false,
			'authors' => self::$author,
		);
	...
	public function test_gc_list_pages_number() {
		$args = array(
			'echo'        => false,
			'number'      => 1,
			'sort_column' => 'ID',
	...
	public function test_gc_list_pages_sort_column() {
		$args = array(
			'echo'        => false,
			'depth'       => 1,
...
<li class="page_item page-item-' . self::$parent_2 . ' page_item_has_children"><a href="' . get_permalink( self::$parent_2 ) . '">Parent 2</a></li>
	...
	public function test_gc_list_pages_link_before() {
		$args = array(
			'echo'        => false,
			'link_before' => 'BEFORE',
		);
...
<ul class=\'children\'>
	...
	public function test_gc_list_pages_link_after() {
		$args = array(
			'echo'       => false,
			'link_after' => 'AFTER',
		);
...
<ul class=\'children\'>
	...
	public function test_gc_list_pages_include() {
		$args = array(
			'echo'    => false,
...
<li class="page_item page-item-' . self::$parent_3 . '"><a href="' . get_permalink( self::$parent_3 ) . '">Parent 3</a></li>
	...
	public function test_gc_list_pages_exclude_tree() {
		$args = array(
			'echo'         => false,
...
<ul class=\'children\'>
	...
	public function test_gc_list_pages_discarded_whitespace() {
		$args = array(
			'echo'         => false,
...
<ul class=\'children\'><li class="page_item page-item-' . self::$children[ self::$parent_3 ][0] . '"><a href="' . get_permalink( self::$children[ self::$parent_3 ][0] ) . '">Child 1</a></li>
	...
	<li class="page_item page-item-' . self::$children[ self::$parent_3 ][2] . '"><a href="' . get_permalink( self::$children[ self::$parent_3 ][2] ) . '">Child 3</a></li>
		...
		$this->assertSame( $expected, gc_list_pages( $args ) );
	}
}
