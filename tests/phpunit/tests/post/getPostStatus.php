 ...
 * @group post
 */
class Tests_Post_GetPostStatus extends GC_UnitTestCase {
	...
	public static function gcSetUpBeforeClass( GC_UnitTest_Factory $factory ) {
		...
		gc_trash_post( self::$post_ids['trash-attachment-no-parent'] );

		// Force delete parent and unattached post objects.
		gc_delete_post( self::$post_ids['delete'], true );
		gc_delete_post( self::$post_ids['delete-attachment-no-parent'], true );
	}
