 ...
 * @group post
 */
class Tests_Post_gcUniquePostSlug extends GC_UnitTestCase {
	...
	public function test_with_multiple_hierarchies() {
		...
		$this->assertSame( 'some-other-slug', gc_unique_post_slug( 'some-other-slug', $one, 'publish', 'post-type-1', 0 ) );
		$this->assertSame( 'some-other-slug', gc_unique_post_slug( 'some-other-slug', $one, 'publish', 'post-type-2', 0 ) );
	...
	public function test_with_hierarchy() {
		...
		$this->assertSame( 'some-slug-3', gc_unique_post_slug( 'some-slug', 0, 'publish', 'post-type-1', 0 ) );
	 ...
	 * @ticket 18962
	 */
	public function test_gc_unique_post_slug_with_hierarchy_and_attachments() {
		register_post_type( 'post-type-1', array( 'hierarchical' => true ) );
		...
		$this->assertSame( 'image', gc_unique_post_slug( 'image', 0, 'publish', 'post-type-1', $two ) );
	...
	public function test_allowed_post_statuses_should_not_be_forced_to_be_unique( $status ) {
		...
		$actual = gc_unique_post_slug( 'foo', $p2, $status, 'post', 0 );
	...
	public function test_revisions_should_not_be_forced_to_be_unique() {
		...
		$actual = gc_unique_post_slug( 'foo', $p2, 'inherit', 'revision', 0 );
	...
	public function test_slugs_resulting_in_permalinks_that_resemble_year_archives_should_be_suffixed() {
		...
		$found = gc_unique_post_slug( '2015', $p, 'publish', 'post', 0 );
	...
	public function test_slugs_resulting_in_permalinks_that_resemble_month_archives_should_be_suffixed() {
		...
		$found = gc_unique_post_slug( '11', $p, 'publish', 'post', 0 );
	...
	public function test_monthlike_slugs_should_not_be_suffixed_for_invalid_month_numbers() {
		...
		$found = gc_unique_post_slug( '13', $p, 'publish', 'post', 0 );
	...
	public function test_slugs_resulting_in_permalinks_that_resemble_day_archives_should_be_suffixed() {
		...
		$found = gc_unique_post_slug( '30', $p, 'publish', 'post', 0 );
	...
	public function test_daylike_slugs_should_not_be_suffixed_for_invalid_day_numbers() {
		...
		$found = gc_unique_post_slug( '32', $p, 'publish', 'post', 0 );
	...
	public function test_embed_slug_should_be_suffixed_for_posts() {
		...
		$found = gc_unique_post_slug( 'embed', $p, 'publish', 'post', 0 );
	...
	public function test_embed_slug_should_be_suffixed_for_pages() {
		...
		$found = gc_unique_post_slug( 'embed', $p, 'publish', 'paage', 0 );
		$this->assertSame( 'embed-2', $found );
	}
	...
	public function test_embed_slug_should_be_suffixed_for_attachments() {
		...
		$found = gc_unique_post_slug( 'embed', $p, 'publish', 'attachment', 0 );
		$this->assertSame( 'embed-2', $found );
	}
}
