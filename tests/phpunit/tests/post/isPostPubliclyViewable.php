 ...
 * @group post
 */
class Tests_Post_IsPostPubliclyViewable extends GC_UnitTestCase {
	...
	public static function gcSetUpBeforeClass( GC_UnitTest_Factory $factory ) {
		...
		gc_trash_post( self::$parent_post_ids['trash'] );
		gc_delete_post( self::$parent_post_ids['delete'], true );
	}
