 ...
 * @group post
 */
class Tests_Post_Types extends GC_UnitTestCase {
	...
	public function test_register_post_type() {
		...
		$this->assertInstanceOf( 'GC_Post_Type', $pobj );
	...
	public function test_register_post_type_return_value() {
		$this->assertInstanceOf( 'GC_Post_Type', register_post_type( 'foo' ) );
	}
	...
	public function test_register_post_type_with_too_long_name() {
		// Post type too long.
		$this->assertInstanceOf( 'GC_Error', register_post_type( 'abcdefghijklmnopqrstuvwxyz0123456789' ) );
	}
	...
	public function test_register_post_type_with_empty_name() {
		// Post type too short.
		$this->assertInstanceOf( 'GC_Error', register_post_type( '' ) );
	}
	...
	public function test_register_taxonomy_for_object_type() {
		...
		$GLOBALS['gc_taxonomies']['category']->object_type = array( 'post' );
	...
	public function test_post_type_with_no_feed() {
		...
		$this->assertFalse( $gc_rewrite->extra_permastructs['foo']['feed'] );
	...
	public function test_unregister_post_type_removes_rewrite_rules() {
		...
		$this->assertContains( 'index.php?post_type=foo', $gc_rewrite->extra_rules_top );
		$this->assertTrue( unregister_post_type( 'foo' ) );
		$this->assertNotContains( 'index.php?post_type=foo', $gc_rewrite->extra_rules_top );
	}
	...
	public function test_unregister_post_type_removes_post_type_supports() {
		...
		$this->assertSameSetsWithIndex(
			...
			$_gc_post_type_features['foo']
		);
		$this->assertTrue( unregister_post_type( 'foo' ) );
		$this->assertArrayNotHasKey( 'foo', $_gc_post_type_features );
	}
	...
	public function test_unregister_post_type_removes_post_type_from_taxonomies() {
		...
		$this->assertIsInt( array_search( 'foo', $gc_taxonomies['category']->object_type, true ) );
		$this->assertIsInt( array_search( 'foo', $gc_taxonomies['post_tag']->object_type, true ) );
		$this->assertTrue( unregister_post_type( 'foo' ) );
		$this->assertFalse( array_search( 'foo', $gc_taxonomies['category']->object_type, true ) );
		$this->assertFalse( array_search( 'foo', $gc_taxonomies['post_tag']->object_type, true ) );
	...
	public function test_unregister_post_type_removes_the_future_post_hooks() {
		...
		$this->assertArrayHasKey( 'future_foo', $gc_filter );
		$this->assertCount( 1, $gc_filter['future_foo']->callbacks );
		$this->assertTrue( unregister_post_type( 'foo' ) );
		$this->assertArrayNotHasKey( 'future_foo', $gc_filter );
	}
	...
	public function test_unregister_post_type_removes_meta_box_callback() {
		...
		$this->assertArrayHasKey( 'add_meta_boxes_foo', $gc_filter );
		$this->assertCount( 1, $gc_filter['add_meta_boxes_foo']->callbacks );
		$this->assertTrue( unregister_post_type( 'foo' ) );
		$this->assertArrayNotHasKey( 'add_meta_boxes_foo', $gc_filter );
	}
	...
	public function test_unregister_post_type_removes_post_type_from_global() {
		...
		$this->assertIsObject( $gc_post_types['foo'] );
		$this->assertIsObject( get_post_type_object( 'foo' ) );

		$this->assertTrue( unregister_post_type( 'foo' ) );

		$this->assertArrayNotHasKey( 'foo', $gc_post_types );
		$this->assertNull( get_post_type_object( 'foo' ) );
	}
