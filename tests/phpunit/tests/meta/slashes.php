 ...
 * @ticket 21767
 */
class Tests_Meta_Slashes extends GC_UnitTestCase {
	...
	public function test_edit_post() {
		...
		if ( function_exists( 'gc_add_post_meta' ) ) {
			$meta_1 = gc_add_post_meta( $post_id, 'slash_test_1', 'foo' );
			$meta_2 = gc_add_post_meta( $post_id, 'slash_test_2', 'foo' );
			$meta_3 = gc_add_post_meta( $post_id, 'slash_test_3', 'foo' );
		} else {
	...
	public function test_add_comment_meta() {
		...
		$this->assertSame( gc_unslash( $this->slash_1 ), get_comment_meta( $comment_id, 'slash_test_1', true ) );
		$this->assertSame( gc_unslash( $this->slash_3 ), get_comment_meta( $comment_id, 'slash_test_2', true ) );
		$this->assertSame( gc_unslash( $this->slash_5 ), get_comment_meta( $comment_id, 'slash_test_3', true ) );
		...
		$this->assertSame( gc_unslash( $this->slash_2 ), get_comment_meta( $comment_id, 'slash_test_4', true ) );
		$this->assertSame( gc_unslash( $this->slash_4 ), get_comment_meta( $comment_id, 'slash_test_5', true ) );
		$this->assertSame( gc_unslash( $this->slash_6 ), get_comment_meta( $comment_id, 'slash_test_6', true ) );
	}
	...
	public function test_update_comment_meta() {
		...
		$this->assertSame( gc_unslash( $this->slash_2 ), get_comment_meta( $comment_id, 'slash_test_1', true ) );
		$this->assertSame( gc_unslash( $this->slash_4 ), get_comment_meta( $comment_id, 'slash_test_2', true ) );
		$this->assertSame( gc_unslash( $this->slash_6 ), get_comment_meta( $comment_id, 'slash_test_3', true ) );
	}
	...
	public function test_add_user_meta() {
		...
		$this->assertSame( gc_unslash( $this->slash_1 ), get_user_meta( $user_id, 'slash_test_1', true ) );
		$this->assertSame( gc_unslash( $this->slash_3 ), get_user_meta( $user_id, 'slash_test_2', true ) );
		$this->assertSame( gc_unslash( $this->slash_5 ), get_user_meta( $user_id, 'slash_test_3', true ) );
		...
		$this->assertSame( gc_unslash( $this->slash_2 ), get_user_meta( $user_id, 'slash_test_4', true ) );
		$this->assertSame( gc_unslash( $this->slash_4 ), get_user_meta( $user_id, 'slash_test_5', true ) );
		$this->assertSame( gc_unslash( $this->slash_6 ), get_user_meta( $user_id, 'slash_test_6', true ) );
	}
	...
	public function test_update_user_meta() {
		...
		$this->assertSame( gc_unslash( $this->slash_2 ), get_user_meta( $user_id, 'slash_test_1', true ) );
		$this->assertSame( gc_unslash( $this->slash_4 ), get_user_meta( $user_id, 'slash_test_2', true ) );
		$this->assertSame( gc_unslash( $this->slash_6 ), get_user_meta( $user_id, 'slash_test_3', true ) );
	}
}
