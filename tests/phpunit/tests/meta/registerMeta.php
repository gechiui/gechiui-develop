 ...
 * @group meta
 */
class Tests_Meta_Register_Meta extends GC_UnitTestCase {
	...
	public static function gcTearDownAfterClass() {
		...
		gc_delete_term( self::$term_id, 'category' );
		gc_delete_comment( self::$comment_id, true );
	...
	public function test_register_meta_with_post_object_type_populates_gc_meta_keys() {
		global $gc_meta_keys;
	...
	public function test_register_meta_with_term_object_type_populates_gc_meta_keys() {
		global $gc_meta_keys;
	...
	public function test_register_meta_with_deprecated_sanitize_callback_does_not_populate_gc_meta_keys() {
		global $gc_meta_keys;
	...
	public function test_register_meta_with_current_sanitize_callback_populates_gc_meta_keys() {
		global $gc_meta_keys;
	...
	public function test_unregister_meta_key_clears_key_from_gc_meta_keys() {
		global $gc_meta_keys;
		register_meta( 'post', 'registered_key', array() );
		unregister_meta_key( 'post', 'registered_key' );

		$this->assertSame( array(), $gc_meta_keys );
	}
	 ...
	 */
	public function test_register_meta_with_subtype_populates_gc_meta_keys( $type, $subtype ) {
		global $gc_meta_keys;
	 ...
	 * @dataProvider data_get_types_and_subtypes
	 */
	public function test_unregister_meta_with_subtype_unpopulates_gc_meta_keys( $type, $subtype ) {
		global $gc_meta_keys;
