 ...
 * @group rewrite
 */
class Tests_Rewrite_AddRewriteEndpoint extends GC_UnitTestCase {
	private $qvs;
	...
	public function set_up() {
		...
		$this->qvs = $GLOBALS['gc']->public_query_vars;
	}

	public function tear_down() {
		$GLOBALS['gc']->public_query_vars = $this->qvs;
		parent::tear_down();
	}

	public function test_should_register_query_using_name_param_by_default() {
		add_rewrite_endpoint( 'foo', EP_ALL );
		$this->assertContains( 'foo', $GLOBALS['gc']->public_query_vars );
	}
	...
	public function test_should_register_query_using_query_var_param_if_not_null() {
		...
		$this->assertContains( 'bar', $GLOBALS['gc']->public_query_vars );
	}
	...
	public function test_should_not_register_query_var_if_query_var_param_is_false() {
		$qvs = $GLOBALS['gc']->public_query_vars;
		add_rewrite_endpoint( 'foo', EP_ALL, false );
		$this->assertSame( $qvs, $GLOBALS['gc']->public_query_vars );
	}
