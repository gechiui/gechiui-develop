 ...
 * @group upload
 */
class Tests_Image_Dimensions extends GC_UnitTestCase {
	...
	public function test_640x480() {
		...
		add_filter( 'gc_image_resize_identical_dimensions', '__return_true' );
		...
		remove_filter( 'gc_image_resize_identical_dimensions', '__return_true' );
	}
