 ...
 * @group header
 */
class Tests_Image_Header extends GC_UnitTestCase {
	...
	public function test_header_image_has_correct_dimensions_with_max_width() {
		...
		$_gc_theme_features['custom-header'][0]['max-width']   = 1600;
		$_gc_theme_features['custom-header'][0]['width']       = 1200;
		$_gc_theme_features['custom-header'][0]['height']      = 230;
		$_gc_theme_features['custom-header'][0]['flex-width']  = false;
		$_gc_theme_features['custom-header'][0]['flex-height'] = false;
	...
	public function test_header_image_has_correct_dimensions_with_fixed() {
		...
		unset( $_gc_theme_features['custom-header'][0]['max-width'] );
		$_gc_theme_features['custom-header'][0]['width']       = 1200;
		$_gc_theme_features['custom-header'][0]['height']      = 230;
		$_gc_theme_features['custom-header'][0]['flex-width']  = false;
		$_gc_theme_features['custom-header'][0]['flex-height'] = false;
	...
	public function test_header_image_has_correct_dimensions_with_flex_height() {
		...
		$_gc_theme_features['custom-header'][0]['height']      = 230;
		$_gc_theme_features['custom-header'][0]['flex-width']  = false;
		$_gc_theme_features['custom-header'][0]['flex-height'] = true;
	...
	public function test_header_image_has_correct_dimensions_with_flex_width() {
		...
		$_gc_theme_features['custom-header'][0]['width']       = 1200;
		$_gc_theme_features['custom-header'][0]['height']      = 230;
		$_gc_theme_features['custom-header'][0]['flex-width']  = true;
		$_gc_theme_features['custom-header'][0]['flex-height'] = false;
	...
	public function test_header_image_has_correct_dimensions_with_flex_width_and_height() {
		...
		$_gc_theme_features['custom-header'][0]['max-width']   = 1800;
		$_gc_theme_features['custom-header'][0]['width']       = 1200;
		$_gc_theme_features['custom-header'][0]['height']      = 230;
		$_gc_theme_features['custom-header'][0]['flex-width']  = true;
		$_gc_theme_features['custom-header'][0]['flex-height'] = true;
	...
	public function test_check_get_previous_crop() {
		...
		update_post_meta( $cropped_1_id, '_gc_attachment_is_custom_header', get_stylesheet() );
