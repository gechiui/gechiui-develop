...
/**
 * Test the GC_Image_Editor_GD class
 *
 * @group image
 * @group media
 * @group gc-image-editor-gd
 */
require_once __DIR__ . '/base.php';

class Tests_Image_Editor_GD extends GC_Image_UnitTestCase {
	...
	public function test_supports_mime_type_jpeg() {
		$gd_image_editor = new GC_Image_Editor_GD( null );
	...
	public function test_resize() {
		...
		$gd_image_editor = new GC_Image_Editor_GD( $file );
	...
	/**
	 * Test should return GC_Error when dimensions are not integer or are <= 0.
	 *
	 * @ticket 51937
	 *
	...
	public function test_crop_invalid_dimensions( $src_x, $src_y, $src_w, $src_h, $dst_w = null, $dst_h = null, $src_abs = false ) {
		...
		$this->assertInstanceOf( 'GC_Error', $actual );
	...
	/**
	 * Test the image created with GC_Image_Editor_GD preserves alpha when resizing
	 *
	 * @ticket 23039
	 */
	...
	/**
	 * Test the image created with GC_Image_Editor_GD preserves alpha with no resizing etc
	 *
	 * @ticket 23039
	 */
	...
	public function test_image_preserves_alpha_on_rotate() {
		...
		$editor = new GC_Image_Editor_GD( $file );
				$editor->load();
				$editor->rotate( 180 );
				$save_to_file = tempnam( get_temp_dir(), '' ) . '.png';
	...
	/**
	 * Test GC_Image_Editor_GD handles extension-less images
	 *
	 * @ticket 39195
	 */
	public function test_image_non_existent_extension() {
		$image_editor = new GC_Image_Editor_GD( DIR_TESTDATA . '/images/test-image-no-extension' );
