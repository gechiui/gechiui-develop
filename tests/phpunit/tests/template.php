<?php
/**
 * test gc-includes/template.php
 *
 * @group themes
 */
class Tests_Template extends GC_UnitTestCase {
	 ...
	 * @since 5.2.0
	 *
	 * @var GC_Post $page_for_privacy_policy
	 */
	...
	public static function gcSetUpBeforeClass( GC_UnitTest_Factory $factory ) {
		...
		add_post_meta( self::$page->ID, '_gc_page_template', 'templates/page.php' );
		...
		add_post_meta( self::$post->ID, '_gc_page_template', 'templates/post.php' );
	...
	public function test_privacy_template_hierarchy() {
		update_option( 'gc_page_for_privacy_policy', self::$page_for_privacy_policy->ID );
	...
	public function test_single_template_hierarchy_for_custom_post_type_with_template() {
		...
		add_post_meta( $cpt->ID, '_gc_page_template', 'templates/cpt.php' );
	...
	public function test_attachment_template_hierarchy_with_template() {
		...
		add_post_meta( $attachment, '_gc_page_template', 'templates/cpt.php' );
