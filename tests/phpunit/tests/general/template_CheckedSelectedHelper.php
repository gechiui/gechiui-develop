<?php
/**
 * A set of unit tests for the __checked_selected_helper() and associated functions in gc-includes/general-template.php.
 *
 * @group general
 */

class Tests_General_Template_CheckedSelectedHelper extends GC_UnitTestCase {
	...
	/**
	 * Tests that the return value for gc_readonly() is as expected with equal values.
	 *
	 * @ticket 53858
	 * @covers ::gc_readonly
	 */
	public function test_gc_readonly_with_equal_values() {
		$this->assertSame( " readonly='readonly'", gc_readonly( 'foo', 'foo', false ) );
	}
