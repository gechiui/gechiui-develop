 ...
 * @covers ::gc_get_document_title
 * @covers ::_gc_render_title_tag
 */
class Tests_General_gcGetDocumentTitle extends GC_UnitTestCase {
	...
	public function test__gc_render_title_tag() {
		$this->go_to( '/' );

		$this->expectOutputString( sprintf( "<title>%s &#8211; %s</title>\n", $this->blog_name, get_option( 'blogdescription' ) ) );
		_gc_render_title_tag();
	}

	public function test__gc_render_title_no_theme_support() {
		$this->go_to( '/' );
	...
	public function test_short_circuiting_title() {
		...
		$this->assertSame( 'A Wild Title', gc_get_document_title() );
	}
	...
	public function test_front_page_title() {
		...
		$this->go_to( '/' );
		$this->assertSame( sprintf( '%s &#8211; Just another GeChiUI site', $this->blog_name ), gc_get_document_title() );
	...
	public function test_home_title() {
		...
		$this->assertSame( sprintf( 'blog-page &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}
	...
	public function test_paged_title() {
		...
		$this->assertSame( sprintf( '%s &#8211; Page 4 &#8211; Just another GeChiUI site', $this->blog_name ), gc_get_document_title() );
	}
	...
	public function test_singular_title() {
		...
		$this->assertSame( sprintf( 'test_title &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}
	...
	public function test_category_title() {
		...
		$this->assertSame( sprintf( 'test_category &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}

	public function test_search_title() {
		$this->go_to( '?s=test_title' );

		$this->assertSame( sprintf( 'Search Results for &#8220;test_title&#8221; &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}

	public function test_author_title() {
		$this->go_to( '?author=' . self::$author_id );

		$this->assertSame( sprintf( 'test_author &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}
	...
	public function test_post_type_archive_title() {
		...
		$this->assertSame( sprintf( 'test_cpt &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}

	public function test_year_title() {
		$this->go_to( '?year=2015' );

		$this->assertSame( sprintf( '2015 &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}

	public function test_month_title() {
		$this->go_to( '?monthnum=09' );

		$this->assertSame( sprintf( 'September 2015 &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}

	public function test_day_title() {
		$this->go_to( '?day=22' );

		$this->assertSame( sprintf( 'September 22, 2015 &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}

	public function test_404_title() {
		$this->go_to( '?m=404' );

		$this->assertSame( sprintf( 'Page not found &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}
	...
	public function test_paged_post_title() {
		...
		$this->assertSame( sprintf( 'test_title &#8211; Page 4 &#8211; %s', $this->blog_name ), gc_get_document_title() );
	}
	...
	public function test_rearrange_title_parts() {
		...
		$this->assertSame( sprintf( '%s &#8211; test_title', $this->blog_name ), gc_get_document_title() );
	}
