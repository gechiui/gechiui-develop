 ...
 * @covers ::gc_title
 */
class Tests_General_GcTitle extends GC_UnitTestCase {

	/**
	 * @ticket 31521
	 *
	 * @dataProvider data_gc_title_archive
	 */
	public function test_gc_title_archive( $query, $expected ) {
		...
		$this->assertSame( $expected, gc_title( '&raquo;', false ) );
	}
	 ...
	 * @return array
	 */
	public function data_gc_title_archive() {
		return array(
