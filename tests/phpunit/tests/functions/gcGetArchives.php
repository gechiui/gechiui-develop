 ...
 */
class Tests_Functions_gcGetArchives extends GC_UnitTestCase {
	...
	public function test_gc_get_archives_default() {
		$expected['default'] = "<li><a href='" . $this->month_url . "'>" . gmdate( 'F Y' ) . '</a></li>';
		$this->assertSame( $expected['default'], trim( gc_get_archives( array( 'echo' => false ) ) ) );
	}

	public function test_gc_get_archives_type() {
	...
	public function test_gc_get_archives_limit() {
...
EOF;
	...
	public function test_gc_get_archives_format() {
	...
	public function test_gc_get_archives_before_and_after() {
	...
	public function test_gc_get_archives_show_post_count() {
	...
	public function test_gc_get_archives_echo() {
		$expected['echo'] = "\t<li><a href='" . $this->month_url . "'>" . gmdate( 'F Y' ) . '</a></li>' . "\n";
		$this->expectOutputString( $expected['echo'] );
		gc_get_archives( array( 'echo' => true ) );
	}

	public function test_gc_get_archives_order() {
...
EOF;
	 ...
	 * @ticket 21596
	 */
	public function test_gc_get_archives_post_type() {
