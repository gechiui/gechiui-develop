 ...
 * @covers ::do_enclose
 */
class Tests_Functions_DoEnclose extends GC_UnitTestCase {
	...
	public function data_test_do_enclose() {
		return array(
			...
			'single-unknown'        => array(
				'content'  => 'https://example.com/gc-content/uploads/2018/06/file.unknown',
				'expected' => '',
			),
			'single-movie'          => array(
				'content'  => 'https://example.com/gc-content/uploads/2018/06/movie.mp4',
				'expected' => "https://example.com/gc-content/uploads/2018/06/movie.mp4\n123\nvideo/mp4\n",
			),
			'single-audio'          => array(
				'content'  => 'https://example.com/gc-content/uploads/2018/06/audio.ogg',
				'expected' => "https://example.com/gc-content/uploads/2018/06/audio.ogg\n321\naudio/ogg\n",
			),
			'single-movie-query'    => array(
				'content'  => 'https://example.com/gc-content/uploads/2018/06/movie.mp4?test=1',
				'expected' => "https://example.com/gc-content/uploads/2018/06/movie.mp4?test=1\n123\nvideo/mp4\n",
			),
			'multi'                 => array(
				'content'  => "https://example.com/gc-content/uploads/2018/06/audio.ogg\n" .
								'https://example.com/gc-content/uploads/2018/06/movie.mp4',
				'expected' => "https://example.com/gc-content/uploads/2018/06/audio.ogg\n321\naudio/ogg\n" .
								"https://example.com/gc-content/uploads/2018/06/movie.mp4\n123\nvideo/mp4\n",
			),
			'no-path'               => array(
