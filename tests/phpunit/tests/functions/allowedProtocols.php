 ...
 * @group formatting
 * @group functions.php
 * @covers ::gc_allowed_protocols
 */
class Tests_Functions_AllowedProtocols extends GC_UnitTestCase {
	...
	public function test_allowed_protocol_has_an_example() {
		...
		$this->assertSameSets( $example_protocols, gc_allowed_protocols() );
	}
	...
	public function test_allowed_protocols( $protocol, $url ) {
		...
		$this->assertSame( $url, esc_url( $url, gc_allowed_protocols() ) );
	}
	...
	public function data_example_urls() {
		return array(
			...
			array( 'irc', 'irc://example.com/gechiui' ),
			array( 'irc6', 'irc6://example.com/gechiui' ),
			array( 'ircs', 'ircs://example.com/gechiui' ),
			...
			array( 'rtsp', 'rtsp://media.example.com:554/gechiui/audiotrack' ),  // RFC2326
			array( 'svn', 'svn://core.svn.gechiui.com/' ),
