<?php
/**
 * Unit tests covering GC_REST_Posts_Types_Controller functionality.
 *
 * @package GeChiUI
 * @subpackage REST API
 */
 ...
 * @group restapi
 */
class GC_Test_REST_Post_Types_Controller extends GC_Test_REST_Controller_Testcase {

	public function test_register_routes() {
		$routes = rest_get_server()->get_routes();
		$this->assertArrayHasKey( '/gc/v2/types', $routes );
		$this->assertArrayHasKey( '/gc/v2/types/(?P<type>[\w-]+)', $routes );
	}

	public function test_context_param() {
		// Collection.
		$request  = new GC_REST_Request( 'OPTIONS', '/gc/v2/types' );
		$response = rest_get_server()->dispatch( $request );
		$data     = $response->get_data();
		$this->assertSame( 'view', $data['endpoints'][0]['args']['context']['default'] );
		$this->assertSameSets( array( 'view', 'edit', 'embed' ), $data['endpoints'][0]['args']['context']['enum'] );
		// Single.
		$request  = new GC_REST_Request( 'OPTIONS', '/gc/v2/types/post' );
		$response = rest_get_server()->dispatch( $request );
		$data     = $response->get_data();
		$this->assertSame( 'view', $data['endpoints'][0]['args']['context']['default'] );
		$this->assertSameSets( array( 'view', 'edit', 'embed' ), $data['endpoints'][0]['args']['context']['enum'] );
	...
	public function test_get_items() {
		$request  = new GC_REST_Request( 'GET', '/gc/v2/types' );
		$response = rest_get_server()->dispatch( $request );
	...
	public function test_get_item() {
		$request  = new GC_REST_Request( 'GET', '/gc/v2/types/post' );
		$response = rest_get_server()->dispatch( $request );
	...
	public function test_get_item_cpt() {
		...
		$request  = new GC_REST_Request( 'GET', '/gc/v2/types/cpt' );
		$response = rest_get_server()->dispatch( $request );
		$this->check_post_type_object_response( 'view', $response, 'cpt' );
	}

	public function test_get_item_page() {
		$request  = new GC_REST_Request( 'GET', '/gc/v2/types/page' );
		$response = rest_get_server()->dispatch( $request );
	...
	public function test_get_item_invalid_type() {
		$request  = new GC_REST_Request( 'GET', '/gc/v2/types/invalid' );
		$response = rest_get_server()->dispatch( $request );
	...
	public function test_create_item() {
		...
		$request  = new GC_REST_Request( 'POST', '/gc/v2/types' );
		$response = rest_get_server()->dispatch( $request );
	...
	public function test_update_item() {
		...
		$request  = new GC_REST_Request( 'POST', '/gc/v2/types/post' );
		$response = rest_get_server()->dispatch( $request );
		$this->assertSame( 404, $response->get_status() );
	}
	...
	public function test_delete_item() {
		...
		$request  = new GC_REST_Request( 'DELETE', '/gc/v2/types/post' );
		$response = rest_get_server()->dispatch( $request );
		$this->assertSame( 404, $response->get_status() );
	}
	...
	public function test_prepare_item() {
		...
		$endpoint = new GC_REST_Post_Types_Controller;
	...
	public function test_get_additional_field_registration() {
		...
		$request = new GC_REST_Request( 'OPTIONS', '/gc/v2/types/schema' );
	...
	protected function check_post_type_obj( $context, $post_type_obj, $data, $links ) {
		...
		$this->assertSame( rest_url( 'gc/v2/types' ), $links['collection'][0]['href'] );
