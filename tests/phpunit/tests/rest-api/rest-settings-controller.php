<?php
/**
 * Unit tests covering GC_Test_REST_Settings_Controller functionality.
 *
 * @package GeChiUI
 * @subpackage REST API
 */
 ...
 * @group restapi
 */
class GC_Test_REST_Settings_Controller extends GC_Test_REST_Controller_Testcase {
	...
	public function set_up() {
		parent::set_up();
		$this->endpoint = new GC_REST_Settings_Controller();
	}
	...
	public function test_register_routes() {
		...
		$this->assertArrayHasKey( '/gc/v2/settings', $routes );
	}

	public function test_get_item() {
		/** Individual settings can't be gotten */
		gc_set_current_user( self::$administrator );
		$request  = new GC_REST_Request( 'GET', '/gc/v2/settings/title' );
	...
	public function test_get_item_is_not_public_not_authenticated() {
		$request  = new GC_REST_Request( 'GET', '/gc/v2/settings' );
		$response = rest_get_server()->dispatch( $request );
		$this->assertSame( 401, $response->get_status() );
	}

	public function test_get_item_is_not_public_no_permission() {
		gc_set_current_user( self::$author );
		$request  = new GC_REST_Request( 'GET', '/gc/v2/settings' );
		$response = rest_get_server()->dispatch( $request );
	...
	public function test_get_items() {
		...
		$expected = array(
			...
			'site_icon', // Registered in gc-includes/blocks/site-logo.php
		);
	...
	public function test_update_item() {
		gc_set_current_user( self::$administrator );
		$request = new GC_REST_Request( 'PUT', '/gc/v2/settings' );
	...
	public function test_delete_item() {
		...
		$request  = new GC_REST_Request( 'DELETE', '/gc/v2/settings/title' );
		$response = rest_get_server()->dispatch( $request );
		$this->assertSame( 404, $response->get_status() );
	}
