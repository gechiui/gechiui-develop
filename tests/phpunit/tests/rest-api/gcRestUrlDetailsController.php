<?php
/**
 * GC_REST_URL_Details_Controller tests.
 *
 * @package GeChiUI
 * @subpackage REST_API
 * @since 5.9.0
...
/**
 * Tests for GC_REST_URL_Details_Controller.
 *
 * @since 5.9.0
 *
 * @covers GC_REST_URL_Details_Controller
 *
 * @group url-details
 * @group restapi
 */
class Tests_REST_GcRestUrlDetailsController extends GC_Test_REST_Controller_Testcase {
	 ...
	 * @var string
	 */
	const REQUEST_ROUTE = '/gc-block-editor/v1/url-details';
	...
	/**
	 * @covers GC_REST_URL_Details_Controller::get_routes
	 *
	 * @ticket 54358
	 */
	...
	/**
	 * @covers GC_REST_URL_Details_Controller::parse_url_details
	 *
	 * @ticket 54358
	 */
	public function test_get_items() {
		...
		$request = new GC_REST_Request( 'GET', static::REQUEST_ROUTE );
	...
	/**
	 * @covers GC_REST_URL_Details_Controller::permissions_check
	 *
	 * @ticket 54358
	 */
	public function test_get_items_fails_for_unauthenticated_user() {
		...
		$this->assertSame( GC_Http::UNAUTHORIZED, $response->get_status(), 'Response status is not ' . GC_Http::UNAUTHORIZED );
	...
	public function test_get_items_fails_for_user_with_insufficient_permissions() {
		...
		$this->assertSame( GC_Http::FORBIDDEN, $response->get_status(), 'Response status is not ' . GC_Http::FORBIDDEN );
	...
	public function test_get_items_fails_for_invalid_url( $invalid_url ) {
		...
		$this->assertSame( GC_Http::BAD_REQUEST, $response->get_status(), 'Response status is not ' . GC_Http::BAD_REQUEST );
	...
	public function data_get_items_fails_for_invalid_url() {
		return array(
			...
			'invalid scheme' => array( 'invalid.proto://www.gechiui.com' ),
		);
	}
	...
	/**
	 * @covers GC_REST_URL_Details_Controller::get_item_schema
	 *
	 * @ticket 54358
	 */
	public function test_get_item_schema() {
		...
		$request  = new GC_REST_Request( 'OPTIONS', static::REQUEST_ROUTE );
		$response = rest_get_server()->dispatch( $request );
		$data     = $response->get_data();
	 ...
	 *
	 * @covers GC_REST_URL_Details_Controller::get_title
	 *
	 * @ticket 54358
	 *
	...
	public function test_get_title( $html, $expected ) {
		$controller = new GC_REST_URL_Details_Controller();
	...
	public function data_get_title() {
		return array(
			...
			'with other elements'            => array(
				...
				<title>Testing &lt;title&gt;</title>
				<link rel="shortcut icon" href="https://www.gechiui.com/favicon.ico" />',
				'Testing',
			),
			'multiline'                      => array(
				'<title>
	 ...
	 *
	 * @covers GC_REST_URL_Details_Controller::get_icon
	 *
	 * @ticket 54358
	 *
	 * @param string $html       Given HTML string.
	 * @param string $expected   Expected found icon.
	 * @param string $target_url Optional. Target URL. Default 'https://www.gechiui.com'.
	 */
	public function test_get_icon( $html, $expected, $target_url = 'https://www.gechiui.com' ) {
		$controller = new GC_REST_URL_Details_Controller();
	...
	public function data_get_icon() {
		return array(
			...
			'default'                               => array(
				'<link rel="shortcut icon" href="https://www.gechiui.com/favicon.ico" />',
				'https://www.gechiui.com/favicon.ico',
			),
			...
			'default with href first'               => array(
				'<link href="https://www.gechiui.com/favicon.ico" rel="shortcut icon" />',
				'https://www.gechiui.com/favicon.ico',
			),
			'default with type last'                => array(
				'<link href="https://www.gechiui.com/favicon.png" rel="icon" type="image/png" />',
				'https://www.gechiui.com/favicon.png',
			),
			'default with type first'               => array(
				'<link type="image/png" href="https://www.gechiui.com/favicon.png" rel="icon" />',
				'https://www.gechiui.com/favicon.png',
			),
			...
			'with query string'                     => array(
				'<link rel="shortcut icon" href="https://www.gechiui.com/favicon.ico?somequerystring=foo&another=bar" />',
				'https://www.gechiui.com/favicon.ico?somequerystring=foo&another=bar',
			),
			'with another link'                     => array(
				'<link rel="shortcut icon" href="https://www.gechiui.com/favicon.ico" /><link rel="canonical" href="https://example.com">',
				'https://www.gechiui.com/favicon.ico',
			),
			...
			'relative url with path'                => array(
				'<link rel="shortcut icon" href="favicon.ico" />',
				'https://www.gechiui.com/favicon.ico',
				'https://www.gechiui.com/my/path/here/',
			),
			'rel reverse order'                     => array(
				'<link rel="icon shortcut" href="https://www.gechiui.com/favicon.ico" />',
				'https://www.gechiui.com/favicon.ico',
			),
			'rel icon only'                         => array(
				'<link rel="icon" href="https://www.gechiui.com/favicon.ico" />',
				'https://www.gechiui.com/favicon.ico',
			),
			...
			'multiline attributes'                  => array(
				'<link
					rel="icon"
					href="https://www.gechiui.com/favicon.ico"
				/>',
				'https://www.gechiui.com/favicon.ico',
			),
			...
			// Unhappy paths.
			'empty rel'                             => array(
				'<link rel="" href="https://www.gechiui.com/favicon.ico" />',
				'',
			),
			'empty href'                            => array(
				'<link rel="icon" href="" />',
			...
			'no rel'                                => array(
				'<link href="https://www.gechiui.com/favicon.ico" />',
				'',
			),
	 ...
	 *
	 * @covers GC_REST_URL_Details_Controller::get_description
	 *
	 * @ticket 54358
	 *
	 * @param string $html     Given HTML string.
	...
	public function data_get_description() {
		return array(
			...
			'with multiple elements'                     => array(
				'<meta property="og:image" content="https://www.gechiui.com/images/myimage.jpg" />
				<link rel="stylesheet" href="https://example.com/assets/style.css" />
				<meta name="description" content="This is a description.">
	 ...
	 *
	 * @covers GC_REST_URL_Details_Controller::get_image
	 *
	 * @ticket 54358
	 *
	 * @param string $html       Given HTML string.
	 ...
	 * @param string $target_url Optional. Target URL. Default 'https://www.gechiui.com'.
	 */
	public function test_get_image( $html, $expected, $target_url = 'https://www.gechiui.com' ) {
		$controller = new GC_REST_URL_Details_Controller();
	...
	public function data_get_image() {
		return array(
			...
			'default'                                      => array(
				'<meta property="og:image" content="https://www.gechiui.com/images/myimage.jpg">',
				'https://www.gechiui.com/images/myimage.jpg',
			),
			'with whitespace'                              => array(
				'<meta  property=" og:image "   content="  https://www.gechiui.com/images/myimage.jpg "  >',
				'https://www.gechiui.com/images/myimage.jpg',
			...
			'with url modifier'                            => array(
				'<meta property="og:image:url" content="https://www.gechiui.com/images/url-modifier.jpg" />
				<meta property="og:image" content="https://www.gechiui.com/images/myimage.jpg">',
				'https://www.gechiui.com/images/url-modifier.jpg',
			),
			'with query string'                            => array(
				'<meta property="og:image" content="https://www.gechiui.com/images/withquerystring.jpg?foo=bar&bar=foo" />',
				'https://www.gechiui.com/images/withquerystring.jpg?foo=bar&bar=foo',
			),

			// Happy paths with changing attributes order or adding attributes.
			'with content first'                           => array(
				'<meta content="https://www.gechiui.com/images/myimage.jpg" property="og:image">',
				'https://www.gechiui.com/images/myimage.jpg',
			),
			'with other attributes'                        => array(
				'<meta first="first" property="og:image" third="third" content="https://www.gechiui.com/images/myimage.jpg" fifth="fifth">',
				'https://www.gechiui.com/images/myimage.jpg',
			),
			...
			'with multiline attributes'                    => array(
				'<meta
					property="og:image"
					content="https://www.gechiui.com/images/myimage.jpg"
				>',
				'https://www.gechiui.com/images/myimage.jpg',
			),
			'with multiline attributes in reverse order'   => array(
			...
			'without a property attribute'                 => array(
				'<meta content="https://www.gechiui.com/images/myimage.jpg">',
				'',
			),
			'without a content attribute empty property'   => array(
				'<meta property="og:image" href="https://www.gechiui.com/images/myimage.jpg">',
				'',
			),
		);
	}
	...
	/**
	 * Mocks the HTTP response for the `gc_safe_remote_get()` which
	 ...
	 * the GC_REST_URL_Details_Controller class.
	 *
	...
	protected function get_reflective_method( $method_name ) {
		$class  = new ReflectionClass( GC_REST_URL_Details_Controller::class );
