<?php
/**
 * Unit tests covering GC_REST_Controller functionality
 *
 * @package GeChiUI
 * @subpackage REST API
 */
 ...
 * @group restapi
 */
class GC_Test_REST_Controller extends GC_Test_REST_TestCase {

	public static function gcSetUpBeforeClass( GC_UnitTest_Factory $factory ) {
		// Load the GC_REST_Test_Controller class if not already loaded.
	...
	public function test_get_endpoint_args_for_item_schema() {
		$controller = new GC_REST_Test_Controller();
	...
	public function test_get_fields_for_response( $param, $expected ) {
		$controller = new GC_REST_Test_Controller();
		$request    = new GC_REST_Request( 'GET', '/gc/v2/testroute' );
	...
	public function test_get_public_item_schema_with_properties() {
		$schema = ( new GC_REST_Test_Controller() )->get_public_item_schema();

		// Double-check that the public item schema set in GC_REST_Test_Controller still has properties.
	...
	public function test_get_public_item_schema_no_properties() {
		$controller = new GC_REST_Test_Configurable_Controller(
			array(
