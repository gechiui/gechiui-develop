<?php
/**
 * GC_REST_Block_Renderer_Controller tests.
 *
 * @package GeChiUI
 * @subpackage REST_API
 * @since 5.0.0
...
/**
 * Tests for GC_REST_Block_Renderer_Controller.
 *
 * @since 5.0.0
 *
 * @covers GC_REST_Block_Renderer_Controller
 *
 * @group restapi-blocks
 * @group restapi
 */
class REST_Block_Renderer_Controller_Test extends GC_Test_REST_Controller_Testcase {
	 ...
	 * @var string
	 */
	protected static $rest_api_route = '/gc/v2/block-renderer/';
	...
	public function tear_down() {
		GC_Block_Type_Registry::get_instance()->unregister( self::$block_name );
		GC_Block_Type_Registry::get_instance()->unregister( self::$context_block_name );
		GC_Block_Type_Registry::get_instance()->unregister( self::$non_dynamic_block_name );
		GC_Block_Type_Registry::get_instance()->unregister( self::$dynamic_block_with_boolean_attributes_block_name );
		parent::tear_down();
	}
	...
	public function render_test_block( $attributes ) {
		return gc_json_encode( $attributes );
	}
	 ...
	 * @ticket 45098
	 *
	 * @covers GC_REST_Block_Renderer_Controller::register_routes
	 */
	 ...
	 * @ticket 45098
	 *
	 * @covers GC_REST_Block_Renderer_Controller::get_item
	 */
	public function test_get_item_without_permissions() {
		gc_set_current_user( 0 );

		$request = new GC_REST_Request( 'GET', self::$rest_api_route . self::$block_name );
	...
	public function test_get_item_invalid_block_name() {
		gc_set_current_user( self::$user_id );
		$request = new GC_REST_Request( 'GET', self::$rest_api_route . 'core/123' );
	...
	public function test_get_item_default_attributes() {
		...
		$block_type = GC_Block_Type_Registry::get_instance()->get_registered( self::$block_name );
		$defaults   = array();
	...
	public function test_get_item_with_post_context() {
		...
		$request        = new GC_REST_Request( 'GET', self::$rest_api_route . self::$context_block_name );
		$request->set_param( 'context', 'edit' );
	...
	public function test_get_item_post_request() {
		...
		$request          = new GC_REST_Request( 'POST', self::$rest_api_route . self::$block_name );
		$request->set_param( 'context', 'edit' );
		$request->set_header( 'content-type', 'application/json' );
		$request->set_body( gc_json_encode( compact( 'attributes' ) ) );
		$response = rest_get_server()->dispatch( $request );
	...
	public function test_get_item_non_dynamic_block() {
		gc_set_current_user( self::$user_id );
		$request = new GC_REST_Request( 'GET', self::$rest_api_route . self::$non_dynamic_block_name );
	...
	public function test_get_sanitized_attributes_for_dynamic_block_with_boolean_attributes() {
		...
		$request = new GC_REST_Request( 'GET', self::$rest_api_route . self::$dynamic_block_with_boolean_attributes_block_name );
	 ...
	 * @ticket 45098
	 *
	 * @covers GC_REST_Block_Renderer_Controller::get_item_schema
	 */
	public function test_get_item_schema() {
		$request  = new GC_REST_Request( 'OPTIONS', self::$rest_api_route . self::$block_name );
		$response = rest_get_server()->dispatch( $request );
		$data     = $response->get_data();
