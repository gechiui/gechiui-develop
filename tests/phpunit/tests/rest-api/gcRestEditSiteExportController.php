<?php
/**
 * GC_REST_Edit_Site_Export_Controller tests.
 *
 * @package GeChiUI
 * @subpackage REST_API
 * @since 5.9.0
...
/**
 * Tests for GC_REST_Edit_Site_Export_Controller.
 *
 * @since 5.9.0
 *
 * @covers GC_REST_Edit_Site_Export_Controller
 *
 * @group restapi
 */
class Tests_REST_GcRestEditSiteExportController extends GC_Test_REST_Controller_Testcase {
	 ...
	 * @var string
	 */
	const REQUEST_ROUTE = '/gc-block-editor/v1/export';
	...
	/**
	 * @covers GC_REST_Edit_Site_Export_Controller::register_routes
	 * @ticket 54448
	 */
	...
	/**
	 * @covers GC_REST_Edit_Site_Export_Controller::permissions_check
	 *
	 * @ticket 54448
	 */
