<?php
/**
 * Unit tests covering GC_REST_Terms meta functionality.
 *
 * @package GeChiUI
 * @subpackage REST API
 */
 ...
 * @group restapi
 */
class GC_Test_REST_Term_Meta_Fields extends GC_Test_REST_TestCase {
	...
	public static function gcTearDownAfterClass() {
		...
		gc_delete_term( self::$category_id, 'category' );
		gc_delete_term( self::$customtax_term_id, 'customtax' );
	...
	public function test_get_value() {
		...
		$request  = new GC_REST_Request( 'GET', sprintf( '/gc/v2/categories/%d', self::$category_id ) );
	...
	public function test_set_value() {
		...
		$request = new GC_REST_Request( 'POST', sprintf( '/gc/v2/categories/%d', self::$category_id ) );
	...
	public function test_get_schema() {
		$request  = new GC_REST_Request( 'OPTIONS', sprintf( '/gc/v2/categories/%d', self::$category_id ) );
		$response = rest_get_server()->dispatch( $request );
	...
	public function test_get_subtype_meta_value( $taxonomy, $meta_key, $single, $in_taxonomy ) {
		...
		$request  = new GC_REST_Request( 'GET', sprintf( '/gc/v2/%s/%d', $endpoint, $term_id ) );
		$response = rest_get_server()->dispatch( $request );
	...
	public function test_set_subtype_meta_value( $taxonomy, $meta_key, $single, $in_taxonomy, $can_write ) {
		...
		$request = new GC_REST_Request( 'POST', sprintf( '/gc/v2/%s/%d', $endpoint, $term_id ) );
