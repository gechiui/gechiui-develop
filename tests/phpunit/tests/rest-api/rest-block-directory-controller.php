<?php
/**
 * Unit tests covering GC_REST_Block_Directory_Controller functionality.
 *
 * @package GeChiUI
 * @subpackage REST API
 */
 ...
 * @group restapi
 */
class GC_REST_Block_Directory_Controller_Test extends GC_Test_REST_Controller_Testcase {
	...
	public function test_register_routes() {
		...
		$this->assertArrayHasKey( '/gc/v2/block-directory/search', $routes );
	}
	...
	public function test_context_param() {
		// Collection.
		$request  = new GC_REST_Request( 'OPTIONS', '/gc/v2/block-directory/search' );
	...
	public function test_get_items() {
		...
		$request = new GC_REST_Request( 'GET', '/gc/v2/block-directory/search' );
	...
	private function get_mock_plugin() {
		return array(
			...
			'author_profile'           => 'https://profiles.gechiui.com/sortabrilliant',
			'requires'                 => '5.0',
			'tested'                   => '5.4.0',
			'requires_php'             => '5.6',
			'rating'                   => 86,
			...
			'download_link'            => 'https://downloads.gechiui.com/plugin/guidepost.1.2.1.zip',
			'tags'                     => array(
				'block'   => 'block',
				'heading' => 'heading',
				'style'   => 'style',
