...
if ( is_multisite() ) :
	 ...
	 * @group post
	 */
	class Tests_Multisite_AvoidBlogPagePermalinkCollision extends GC_UnitTestCase {
		...
		public static function gcTearDownAfterClass() {
			gc_delete_site( self::$site_id );

			gc_delete_post( self::$root_page->ID );
			gc_delete_post( self::$child_page->ID );
		}
