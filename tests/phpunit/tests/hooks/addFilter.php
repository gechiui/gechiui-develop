...
/**
 * Test the add_filter method of GC_Hook
 *
 * @group hooks
 * @covers GC_Hook::add_filter
 */
class Tests_Hooks_AddFilter extends GC_UnitTestCase {
	...
	public function test_add_filter_with_function() {
		...
		$function_index = _gc_filter_build_unique_id( $tag, $callback, $priority );
