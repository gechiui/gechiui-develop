...
/**
 * @group formatting
 * @expectedDeprecated gc_htmledit_pre
 */
class Tests_Formatting_gcHtmleditPre extends GC_UnitTestCase {
	 ...
	 * @ticket 23688
	 */
	public function test_gc_htmledit_pre_charset_iso_8859_1() {
		add_filter( 'pre_option_blog_charset', array( $this, 'charset_iso_8859_1' ) );
		$iso8859_1 = 'Fran' . chr( 135 ) . 'ais';
		$this->assertSame( $iso8859_1, gc_htmledit_pre( $iso8859_1 ) );
	 ...
	 * @ticket 23688
	 */
	public function test_gc_htmledit_pre_charset_utf_8() {
		add_filter( 'pre_option_blog_charset', array( $this, 'charset_utf_8' ) );
		$utf8 = 'Fran' . chr( 195 ) . chr( 167 ) . 'ais';
		$this->assertSame( $utf8, gc_htmledit_pre( $utf8 ) );
