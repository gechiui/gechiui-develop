 ...
 * @group formatting
 */
class Tests_Formatting_gcMakeLinkRelative extends GC_UnitTestCase {

	public function test_gc_make_link_relative_with_http_scheme() {
		$link          = 'http://example.com/this-is-a-test-http-url/';
		$relative_link = gc_make_link_relative( $link );
		$this->assertSame( '/this-is-a-test-http-url/', $relative_link );
	}

	public function test_gc_make_link_relative_with_https_scheme() {
	 ...
	 * @ticket 30373
	 */
	public function test_gc_make_link_relative_with_no_scheme() {
	 ...
	 * @ticket 30373
	 */
	public function test_gc_make_link_relative_should_retain_URL_param_that_is_also_a_URL() {
	 ...
	 * @ticket 26819
	 */
	public function test_gc_make_link_relative_with_no_path() {
