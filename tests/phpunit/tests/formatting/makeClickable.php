 ...
 * @group formatting
 */
class Tests_Formatting_MakeClickable extends GC_UnitTestCase {
	 ...
	 * and (semi-)colons in URLs with protocol (i.e. http://www.gechiui.com).
	 */
	public function test_strip_trailing_with_protocol() {
		$urls_before   = array(
			'http://www.gechiui.com/hello.html',
			'There was a spoon named http://www.gechiui.com. Alice!',
			'There was a spoon named http://www.gechiui.com, said Alice.',
			'There was a spoon named http://www.gechiui.com; said Alice.',
			'There was a spoon named http://www.gechiui.com: said Alice.',
			'There was a spoon named (http://www.gechiui.com) said Alice.',
		);
		$urls_expected = array(
			'<a href="http://www.gechiui.com/hello.html" rel="nofollow">http://www.gechiui.com/hello.html</a>',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>. Alice!',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>, said Alice.',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>; said Alice.',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>: said Alice.',
			'There was a spoon named (<a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>) said Alice.',
		);
	...
	public function test_strip_trailing_with_protocol_nothing_afterwards() {
		$urls_before   = array(
			'http://www.gechiui.com/hello.html',
			'There was a spoon named http://www.gechiui.com.',
			'There was a spoon named http://www.gechiui.com,',
			'There was a spoon named http://www.gechiui.com;',
			'There was a spoon named http://www.gechiui.com:',
			'There was a spoon named (http://www.gechiui.com)',
			'There was a spoon named (http://www.gechiui.com)x',
		);
		$urls_expected = array(
			'<a href="http://www.gechiui.com/hello.html" rel="nofollow">http://www.gechiui.com/hello.html</a>',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>.',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>,',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>;',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>:',
			'There was a spoon named (<a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>)',
			'There was a spoon named (<a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>)x',
		);
	...
	/**
	 * Tests that make_clickable() will not link trailing periods, commas,
	 * and (semi-)colons in URLs without protocol (i.e. www.gechiui.com).
	 */
	public function test_strip_trailing_without_protocol() {
		$urls_before   = array(
			'www.gechiui.com',
			'There was a spoon named www.gechiui.com. Alice!',
			'There was a spoon named www.gechiui.com, said Alice.',
			'There was a spoon named www.gechiui.com; said Alice.',
			'There was a spoon named www.gechiui.com: said Alice.',
			'There was a spoon named www.gechiui.com) said Alice.',
		);
		$urls_expected = array(
			'<a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>. Alice!',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>, said Alice.',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>; said Alice.',
			'There was a spoon named <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>: said Alice.',
	...
	public function test_strip_trailing_without_protocol_nothing_afterwards() {
		$urls_before   = array(
			'www.gechiui.com',
			'There was a spoon named www.gechiui.com.',
			'There was a spoon named www.gechiui.com,',
			'There was a spoon named www.gechiui.com;',
			'There was a spoon named www.gechiui.com:',
			'There was a spoon named www.gechiui.com)',
	...
	public function test_real_world_examples() {
		$urls_before   = array(
			'Example: GeChiUI, test (some text), I love example.com (http://example.org), it is brilliant',
			'Example: GeChiUI, test (some text), I love example.com (http://example.com), it is brilliant',
		...
		$urls_expected = array(
			'Example: GeChiUI, test (some text), I love example.com (<a href="http://example.org" rel="nofollow">http://example.org</a>), it is brilliant',
			'Example: GeChiUI, test (some text), I love example.com (<a href="http://example.com" rel="nofollow">http://example.com</a>), it is brilliant',
	...
	public function test_twitter_hash_bang() {
		$urls_before   = array(
			'http://twitter.com/#!/gechiui/status/25907440233',
			'This is a really good tweet http://twitter.com/#!/gechiui/status/25907440233 !',
			'This is a really good tweet http://twitter.com/#!/gechiui/status/25907440233!',
		);
		$urls_expected = array(
			'<a href="http://twitter.com/#!/gechiui/status/25907440233" rel="nofollow">http://twitter.com/#!/gechiui/status/25907440233</a>',
			'This is a really good tweet <a href="http://twitter.com/#!/gechiui/status/25907440233" rel="nofollow">http://twitter.com/#!/gechiui/status/25907440233</a> !',
			'This is a really good tweet <a href="http://twitter.com/#!/gechiui/status/25907440233" rel="nofollow">http://twitter.com/#!/gechiui/status/25907440233</a>!',
		);
		foreach ( $urls_before as $key => $url ) {
			$this->assertSame( $urls_expected[ $key ], make_clickable( $url ) );
	...
	public function test_dont_break_attributes() {
		$urls_before   = array(
			"<img src='http://trunk.domain/gc-includes/images/smilies/icon_smile.gif' alt=':)' class='gc-smiley'>",
			"(<img src='http://trunk.domain/gc-includes/images/smilies/icon_smile.gif' alt=':)' class='gc-smiley'>)",
			"http://trunk.domain/testing#something (<img src='http://trunk.domain/gc-includes/images/smilies/icon_smile.gif' alt=':)' class='gc-smiley'>)",
		...
		$urls_expected = array(
			"<img src='http://trunk.domain/gc-includes/images/smilies/icon_smile.gif' alt=':)' class='gc-smiley'>",
			"(<img src='http://trunk.domain/gc-includes/images/smilies/icon_smile.gif' alt=':)' class='gc-smiley'>)",
			"<a href=\"http://trunk.domain/testing#something\" rel=\"nofollow\">http://trunk.domain/testing#something</a> (<img src='http://trunk.domain/gc-includes/images/smilies/icon_smile.gif' alt=':)' class='gc-smiley'>)",
	...
	public function test_no_links_inside_pre_or_code() {
		$before = array(
			'<pre>http://www.gechiui.com</pre>',
			'<code>http://www.gechiui.com</code>',
			'<pre class="foobar" id="foo">http://www.gechiui.com</pre>',
			'<code class="foobar" id="foo">http://www.gechiui.com</code>',
			'<precustomtag>http://www.gechiui.com</precustomtag>',
			'<codecustomtag>http://www.gechiui.com</codecustomtag>',
			'URL before pre http://www.gechiui.com<pre>http://www.gechiui.com</pre>',
			'URL before code http://www.gechiui.com<code>http://www.gechiui.com</code>',
			'URL after pre <PRE>http://www.gechiui.com</PRE>http://www.gechiui.com',
			'URL after code <code>http://www.gechiui.com</code>http://www.gechiui.com',
			'URL before and after pre http://www.gechiui.com<pre>http://www.gechiui.com</pre>http://www.gechiui.com',
			'URL before and after code http://www.gechiui.com<code>http://www.gechiui.com</code>http://www.gechiui.com',
			'code inside pre <pre>http://www.gechiui.com <code>http://www.gechiui.com</code> http://www.gechiui.com</pre>',
		);
		...
		$expected = array(
			...
			'<pre class="foobar" id="foo">http://www.gechiui.com</pre>',
			'<code class="foobar" id="foo">http://www.gechiui.com</code>',
			'<precustomtag><a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a></precustomtag>',
			'<codecustomtag><a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a></codecustomtag>',
			'URL before pre <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a><pre>http://www.gechiui.com</pre>',
			'URL before code <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a><code>http://www.gechiui.com</code>',
			'URL after pre <PRE>http://www.gechiui.com</PRE><a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>',
			'URL after code <code>http://www.gechiui.com</code><a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>',
			'URL before and after pre <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a><pre>http://www.gechiui.com</pre><a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>',
			'URL before and after code <a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a><code>http://www.gechiui.com</code><a href="http://www.gechiui.com" rel="nofollow">http://www.gechiui.com</a>',
			'code inside pre <pre>http://www.gechiui.com <code>http://www.gechiui.com</code> http://www.gechiui.com</pre>',
		);
	...
	public function test_no_links_within_links() {
		$in = array(
			...
			// '<a href="http://www.gechiui.com">This is already a link www.gechiui.com</a>', // Fails in 3.3.1 too.
		);
		foreach ( $in as $text ) {
	...
	public function data_script_and_style_tags() {
		return array(
			array(
				'<script>http://www.gechiui.com</script>',
			),
			array(
				'<style>http://www.gechiui.com</style>',
			),
			array(
				'<script type="text/javascript">http://www.gechiui.com</script>',
			),
			array(
				'<style type="text/css">http://www.gechiui.com</style>',
			),
		);
	}
	...
	public function data_add_rel_ugc_in_comments() {
		return array(
			array(
				'http://www.gechiui.com',
				'<a href="http://www.gechiui.com" rel="nofollow ugc">http://www.gechiui.com</a>',
			),
			array(
				'www.gechiui.com',
				'<p><a href="http://www.gechiui.com" rel="nofollow ugc">http://www.gechiui.com</a>',
			),
		);
	}
