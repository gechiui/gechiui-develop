 ...
 * @group formatting
 */
class Tests_Formatting_GetUrlInContent extends GC_UnitTestCase {
	...
	public function get_input_output() {
		return array(
			...
			array( // Escape link.
				'ABC<div><a href="http://example.com/Mr%20GeChiUI 2">LINK</a> CONTENT </div>',
				'http://example.com/Mr%20GeChiUI%202',
			),
		);
	}
