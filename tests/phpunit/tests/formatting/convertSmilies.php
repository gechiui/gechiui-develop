 ...
 * @group emoji
 */
class Tests_Formatting_ConvertSmilies extends GC_UnitTestCase {
	...
	public function get_custom_smilies_input_output() {
		...
		return array(
			array(
				...
				'Peter Brian Gabriel (born 13 February 1950) is a British singer, musician, and songwriter who rose to fame as the lead vocalist and flautist of the progressive rock group Genesis. <img src="' . $includes_path . 'icon_shock_the_monkey.gif" alt=":monkey:" class="gc-smiley" style="height: 1em; max-height: 1em;" />',
			),
			array(
			...
			array(
				...
				'<img src="' . $includes_path . 'icon_arrow.gif" alt=":arrow:" class="gc-smiley" style="height: 1em; max-height: 1em;" /> monkey: Lorem ipsum dolor sit amet enim. Etiam ullam <img src="' . $includes_path . 'icon_tongue.gif" alt=":PP" class="gc-smiley" style="height: 1em; max-height: 1em;" /> <br />corper. Suspendisse a pellentesque dui, non felis.<a> <img src="' . $includes_path . 'icon_arrow.gif" alt=":arrow:" class="gc-smiley" style="height: 1em; max-height: 1em;" /> :arrow</a>',
			),
		);
	}
	...
	public function test_convert_custom_smilies( $in_txt, $converted_txt ) {
		global $gcsmiliestrans;

		// Custom smilies, use_smilies: ON.
		update_option( 'use_smilies', 1 );

		if ( ! isset( $gcsmiliestrans ) ) {
			smilies_init();
		}

		$trans_orig = $gcsmiliestrans; // Save original translations array.

		$gcsmiliestrans = array(
			':PP'      => 'icon_tongue.gif',
		...
		$gcsmiliestrans = $trans_orig; // Reset original translations array.
	}
	...
	public function get_smilies_combinations() {
		...
		return array(
			...
			array(
				...
				"\xf0\x9f\x98\xaf \xf0\x9f\x98\x88 \xf0\x9f\x99\x81 \xf0\x9f\x98\x95 \xf0\x9f\x99\x84 <img src=\"{$includes_path}mrgreen.png\" alt=\":mrgreen:\" class=\"gc-smiley\" style=\"height: 1em; max-height: 1em;\" />",
			),
		);
	}
	...
	public function get_single_smilies_input_output() {
		...
		return array(
			...
			array(
				...
				'8O <img src="' . $includes_path . 'simple-smile.png" alt=":)" class="gc-smiley" style="height: 1em; max-height: 1em;" /> additional text here <img src="' . $includes_path . 'simple-smile.png" alt=":)" class="gc-smiley" style="height: 1em; max-height: 1em;" />',
			),
			array(
				':) :) :) :)',
				'<img src="' . $includes_path . 'simple-smile.png" alt=":)" class="gc-smiley" style="height: 1em; max-height: 1em;" /> <img src="' . $includes_path . 'simple-smile.png" alt=":)" class="gc-smiley" style="height: 1em; max-height: 1em;" /> <img src="' . $includes_path . 'simple-smile.png" alt=":)" class="gc-smiley" style="height: 1em; max-height: 1em;" /> <img src="' . $includes_path . 'simple-smile.png" alt=":)" class="gc-smiley" style="height: 1em; max-height: 1em;" />',
			),
		);
	}
	 ...
	 * the $gcsmiliestrans global array
	 *
	 * @ticket 25303
	 * @dataProvider get_single_smilies_input_output
	 */
	public function test_single_smilies_in_gcsmiliestrans( $in_txt, $converted_txt ) {
		global $gcsmiliestrans;
		...
		$orig_trans = $gcsmiliestrans; // Save original tranlations array.
		...
		$gcsmiliestrans = $orig_trans; // Reset original translations array.
	}
	...
	/**
	 * Check that $gc_smiliessearch pattern will match smilies
	...
	public function _filter_remove_smilies( $gcsmiliestrans ) {
		unset( $gcsmiliestrans[':oops:'] );
		return $gcsmiliestrans;
	}

	public function _filter_add_smilies( $gcsmiliestrans ) {
		$gcsmiliestrans['<3'] = '\xe2\x9d\xa4';
		return $gcsmiliestrans;
	}
}
