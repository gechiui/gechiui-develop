 ...
 * @ticket 43187
 */
class Tests_Formatting_gcTargetedLinkRel extends GC_UnitTestCase {
	...
	public function test_add_to_links_with_target_blank() {
		...
		$this->assertSame( $expected, gc_targeted_link_rel( $content ) );
	}
	 ...
	 * @ticket 45352
	 */
	public function test_ignore_if_gc_targeted_link_rel_nulled() {
		add_filter( 'gc_targeted_link_rel', '__return_empty_string' );
	 ...
	 * @ticket 45292
	 */
	public function test_gc_targeted_link_rel_filters_run() {
		$content  = '<p>Links: <a href="/" target="_blank">No rel</a></p>';
		$expected = '<p>Links: <a href="/" target="_blank" rel="noopener">No rel</a></p>';
	 ...
	 * @ticket 46316
	 */
	public function test_gc_targeted_link_rel_should_preserve_json() {
		$content  = '<p>Links: <a href=\"\/\" target=\"_blank\">No rel<\/a><\/p>';
		$expected = '<p>Links: <a href=\"\/\" target=\"_blank\" rel=\"noopener\">No rel<\/a><\/p>';
		$this->assertSame( $expected, gc_targeted_link_rel( $content ) );
	}
	 ...
	 * @ticket 47244
	 */
	public function test_gc_targeted_link_rel_skips_style_and_scripts() {
	...
	public function test_gc_targeted_link_rel_tab_separated_values_are_split() {
