 ...
 * @group taxonomy
 */
class Tests_Category_GcListCategories extends GC_UnitTestCase {
	public function test_class() {
		$c = self::factory()->category->create();

		$found = gc_list_categories(
			array(
				'hide_empty' => false,
				'echo'       => false,
			)
	...
	public function test_show_option_all_link_should_link_to_post_type_archive_when_taxonomy_does_not_apply_to_posts() {
		register_post_type( 'gctests_pt', array( 'has_archive' => true ) );
		register_post_type( 'gctests_pt2', array( 'has_archive' => true ) );
		register_taxonomy( 'gctests_tax', array( 'foo', 'gctests_pt', 'gctests_pt2' ) );
		...
		$pt_archive = get_post_type_archive_link( 'gctests_pt' );
	...
	public function test_show_option_all_link_should_not_link_to_post_type_archive_if_has_archive_is_false() {
		register_post_type( 'gctests_pt', array( 'has_archive' => false ) );
		register_post_type( 'gctests_pt2', array( 'has_archive' => true ) );
		register_taxonomy( 'gctests_tax', array( 'foo', 'gctests_pt', 'gctests_pt2' ) );
		...
		$pt_archive = get_post_type_archive_link( 'gctests_pt2' );
	...
	public function test_show_option_all_link_should_link_to_post_archive_if_available() {
		register_post_type( 'gctests_pt', array( 'has_archive' => true ) );
		register_post_type( 'gctests_pt2', array( 'has_archive' => true ) );
		register_taxonomy( 'gctests_tax', array( 'foo', 'gctests_pt', 'post', 'gctests_pt2' ) );
	...
	public function test_show_option_all_link_should_link_to_post_archive_if_no_associated_post_types_have_archives() {
		register_post_type( 'gctests_pt', array( 'has_archive' => false ) );
		register_post_type( 'gctests_pt2', array( 'has_archive' => false ) );
		register_taxonomy( 'gctests_tax', array( 'foo', 'gctests_pt', 'gctests_pt2' ) );
	...
	public function test_exclude_tree_should_be_respected() {
		...
		$actual = gc_list_categories( $args );
