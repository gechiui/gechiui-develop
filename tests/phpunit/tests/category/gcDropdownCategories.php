 ...
 * @group category.php
 */
class Tests_Category_GcDropdownCategories extends GC_UnitTestCase {
	/**
	 * @ticket 30306
	 */
	public function test_gc_dropdown_categories_value_field_should_default_to_term_id() {
		...
		// Get the default functionality of gc_dropdown_categories().
		$dropdown_default = gc_dropdown_categories(
			array(
				'echo'       => 0,
				'hide_empty' => 0,
			)
	 ...
	 * @ticket 30306
	 */
	public function test_gc_dropdown_categories_value_field_term_id() {
		// Create a test category.
		$cat_id = self::factory()->category->create(
			array(
				'name' => 'Test Category',
	 ...
	 * @ticket 30306
	 */
	public function test_gc_dropdown_categories_value_field_slug() {
		// Create a test category.
		$cat_id = self::factory()->category->create(
			array(
				'name' => 'Test Category',
	 ...
	 * @ticket 30306
	 */
	public function test_gc_dropdown_categories_value_field_should_fall_back_on_term_id_when_an_invalid_value_is_provided() {
		// Create a test category.
		$cat_id = self::factory()->category->create(
			array(
				'name' => 'Test Category',
	 ...
	 * @ticket 32330
	 */
	public function test_gc_dropdown_categories_selected_should_respect_custom_value_field() {
	 ...
	 * @ticket 33452
	 */
	public function test_gc_dropdown_categories_show_option_all_should_be_selected_if_no_selected_value_is_explicitly_passed_and_value_field_does_not_have_string_values() {
	 ...
	 * @ticket 33452
	 */
	public function test_gc_dropdown_categories_show_option_all_should_be_selected_if_selected_value_of_0_string_is_explicitly_passed_and_value_field_does_not_have_string_values() {
		$cats = self::factory()->category->create_many( 3 );
	...
	public function test_required_true_should_add_required_attribute() {
		...
		$dropdown_categories = gc_dropdown_categories( $args );
