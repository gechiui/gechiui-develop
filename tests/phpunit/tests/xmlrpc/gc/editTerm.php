 ...
 * @group xmlrpc
 */
class Tests_XMLRPC_gc_editTerm extends GC_XMLRPC_UnitTestCase {
	...
	public function test_invalid_username_password() {
		$result = $this->myxmlrpcserver->gc_editTerm( array( 1, 'username', 'password', 'category', 1 ) );
	...
	public function test_empty_taxonomy() {
		...
		$result = $this->myxmlrpcserver->gc_editTerm( array( 1, 'subscriber', 'subscriber', '', array( 'taxonomy' => '' ) ) );
		$this->assertIXRError( $result );
		$this->assertSame( 403, $result->code );
	...
	public function test_invalid_taxonomy() {
		...
		$result = $this->myxmlrpcserver->gc_editTerm( array( 1, 'subscriber', 'subscriber', self::$parent_term, array( 'taxonomy' => 'not_existing' ) ) );
		$this->assertIXRError( $result );
		$this->assertSame( 403, $result->code );
		$this->assertSame( __( 'Invalid taxonomy.' ), $result->message );
	}
	...
	public function test_incapable_user() {
		...
		$result = $this->myxmlrpcserver->gc_editTerm( array( 1, 'subscriber', 'subscriber', self::$parent_term, array( 'taxonomy' => 'category' ) ) );
		$this->assertIXRError( $result );
	...
	public function test_term_not_exists() {
		...
		$result = $this->myxmlrpcserver->gc_editTerm( array( 1, 'editor', 'editor', 9999, array( 'taxonomy' => 'category' ) ) );
		$this->assertIXRError( $result );
	...
	public function test_empty_term() {
		...
		$result = $this->myxmlrpcserver->gc_editTerm( array( 1, 'editor', 'editor', '', array( 'taxonomy' => 'category' ) ) );
		$this->assertIXRError( $result );
	...
	public function test_empty_term_name() {
		...
		$result = $this->myxmlrpcserver->gc_editTerm(
			array(
				1,
				'editor',
				'editor',
	...
	public function test_edit_all_fields() {
		...
		$result = $this->myxmlrpcserver->gc_editTerm( array( 1, 'editor', 'editor', self::$child_term, $fields ) );
