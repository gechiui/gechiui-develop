 ...
 * @group xmlrpc
 */
class Tests_XMLRPC_gc_getPost extends GC_XMLRPC_UnitTestCase {
	public $post_data;
	public $post_id;
	public $post_date_ts;
	...
	public function set_up() {
		...
		$this->post_id                 = gc_insert_post( $this->post_data );
	...
	public function test_invalid_username_password() {
		$result = $this->myxmlrpcserver->gc_getPost( array( 1, 'username', 'password', 1 ) );
	...
	public function test_valid_post() {
		...
		$result = $this->myxmlrpcserver->gc_getPost( array( 1, 'author', 'author', $this->post_id, $fields ) );
	...
	public function test_default_fields() {
		$result = $this->myxmlrpcserver->gc_getPost( array( 1, 'author', 'author', $this->post_id ) );
		$this->assertNotIXRError( $result );
	...
	public function test_valid_page() {
		...
		$result = $this->myxmlrpcserver->gc_getPost( array( 1, 'editor', 'editor', $child_page_id ) );
		$this->assertNotIXRError( $result );
