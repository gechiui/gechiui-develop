 ...
 * @group xmlrpc
 */
class Tests_XMLRPC_gc_editComment extends GC_XMLRPC_UnitTestCase {
	...
	public function test_author_cannot_edit_others_comment() {
		...
		$result = $this->myxmlrpcserver->gc_editComment( array( 1, 'author', 'author', $comment_id, array( 'status' => 'hold' ) ) );
	...
	public function test_trash_comment() {
		...
		$this->myxmlrpcserver->gc_editComment(
			array(
				1,
				'administrator',
				'administrator',
