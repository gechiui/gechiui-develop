 ...
 * @group xmlrpc
 */
class Tests_XMLRPC_gc_newComment extends GC_XMLRPC_UnitTestCase {
	...
	public function test_valid_comment() {
		$result = $this->myxmlrpcserver->gc_newComment(
			array(
				1,
				'administrator',
				'administrator',
	...
	public function test_new_comment_duplicated() {
		...
		$result = $this->myxmlrpcserver->gc_newComment( $comment_args );
		$this->assertNotIXRError( $result );
	...
	public function test_allowed_anon_comments() {
		...
		$comment_args = array(
			...
			array(
				'author'       => 'GeChiUI',
				'author_email' => 'noreply@www.gechiui.com',
	...
	public function test_anon_comments_require_email() {
		...
		$comment_args = array(
			...
			array(
				'author'       => 'GeChiUI',
				'author_email' => 'noreply at www.gechiui.com',
				'content'      => 'Test Anon Comments',
			),
		);
