 ...
 * @group user
 */
class Tests_XMLRPC_gc_getProfile extends GC_XMLRPC_UnitTestCase {

	public function test_invalid_username_password() {
		$result = $this->myxmlrpcserver->gc_getProfile( array( 1, 'username', 'password' ) );
	...
	public function test_subscriber() {
		...
		$result = $this->myxmlrpcserver->gc_getProfile( array( 1, 'subscriber', 'subscriber' ) );
	...
	public function test_administrator() {
		...
		$result = $this->myxmlrpcserver->gc_getProfile( array( 1, 'administrator', 'administrator' ) );
		$this->assertNotIXRError( $result );
	...
	public function test_arbitrary_fields() {
		...
		$result = $this->myxmlrpcserver->gc_getProfile( array( 1, 'editor', 'editor', $fields ) );
		$this->assertNotIXRError( $result );
