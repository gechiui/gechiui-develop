 ...
 * @group xmlrpc
 */
class Tests_XMLRPC_gc_getPageList extends GC_XMLRPC_UnitTestCase {
	...
	public function test_invalid_username_password() {
		$result = $this->myxmlrpcserver->gc_getPageList( array( 1, 'username', 'password' ) );
	...
	public function test_incapable_user() {
		...
		$result = $this->myxmlrpcserver->gc_getPageList( array( 1, 'contributor', 'contributor' ) );
		$this->assertIXRError( $result );
	...
	public function test_date() {
		...
		$results = $this->myxmlrpcserver->gc_getPageList( array( 1, 'editor', 'editor' ) );
