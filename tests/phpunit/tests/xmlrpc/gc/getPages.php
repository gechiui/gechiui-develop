 ...
 * @group xmlrpc
 */
class Tests_XMLRPC_gc_getPages extends GC_XMLRPC_UnitTestCase {
	...
	public function test_invalid_username_password() {
		$result = $this->myxmlrpcserver->gc_getPages( array( 1, 'username', 'password' ) );
	...
	public function test_incapable_user() {
		...
		$result = $this->myxmlrpcserver->gc_getPages( array( 1, 'contributor', 'contributor' ) );
		$this->assertIXRError( $result );
		$this->assertSame( 401, $result->code );
	}

	public function test_capable_user() {
		$results = $this->myxmlrpcserver->gc_getPages( array( 1, 'administrator', 'administrator' ) );
	...
	public function test_semi_capable_user() {
		...
		$results = $this->myxmlrpcserver->gc_getPages( array( 1, 'editor', 'editor' ) );
		$this->assertNotIXRError( $results );
