 ...
 * @group xmlrpc
 */
class Tests_XMLRPC_gc_getOptions extends GC_XMLRPC_UnitTestCase {

	public function test_invalid_username_password() {
		$result = $this->myxmlrpcserver->gc_getOptions( array( 1, 'username', 'password' ) );
	...
	public function test_valid_username_password() {
		...
		$result = $this->myxmlrpcserver->gc_getOptions( array( 1, 'subscriber', 'subscriber' ) );
		$this->assertIsArray( $result );
		$this->assertSame( 'GeChiUI', $result['software_name']['value'] );
	}

	public function test_option_value() {
		$this->make_user_by_role( 'administrator' );

		$result = $this->myxmlrpcserver->gc_getOptions( array( 1, 'administrator', 'administrator', 'default_comment_status' ) );
		$this->assertIsArray( $result );
	...
	public function test_option_values_subscriber() {
		...
		$this->assertSame( $gc_version, $result['software_version']['value'] );
		...
		$this->assertSame( gc_login_url(), $result['login_url']['value'] );
	...
	public function test_option_values_admin() {
		...
		$result = $this->myxmlrpcserver->gc_getOptions( array( 1, 'administrator', 'administrator' ) );
		$this->assertIsArray( $result );
