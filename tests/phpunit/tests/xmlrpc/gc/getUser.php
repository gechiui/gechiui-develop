 ...
 * @group user
 */
class Tests_XMLRPC_gc_getUser extends GC_XMLRPC_UnitTestCase {
	...
	public function test_invalid_username_password() {
		$result = $this->myxmlrpcserver->gc_getUser( array( 1, 'username', 'password', 1 ) );
		$this->assertIXRError( $result );
		$this->assertSame( 403, $result->code );
	}

	public function test_invalid_user() {
		$result = $this->myxmlrpcserver->gc_getUser( array( 1, 'administrator', 'administrator', 34902348908234 ) );
		$this->assertIXRError( $result );
	...
	public function test_incapable_user() {
		...
		$result = $this->myxmlrpcserver->gc_getUser( array( 1, 'subscriber', 'subscriber', $editor_id ) );
		$this->assertIXRError( $result );
	...
	public function test_subscriber_self() {
		...
		$result = $this->myxmlrpcserver->gc_getUser( array( 1, 'subscriber', 'subscriber', $subscriber_id ) );
	...
	public function test_valid_user() {
		...
		$result = $this->myxmlrpcserver->gc_getUser( array( 1, 'administrator', 'administrator', $user_id ) );
		$this->assertNotIXRError( $result );
	...
	public function test_no_fields() {
		...
		$result = $this->myxmlrpcserver->gc_getUser( array( 1, 'administrator', 'administrator', $editor_id, array() ) );
		$this->assertNotIXRError( $result );
	...
	public function test_basic_fields() {
		...
		$result = $this->myxmlrpcserver->gc_getUser( array( 1, 'administrator', 'administrator', $editor_id, array( 'basic' ) ) );
		$this->assertNotIXRError( $result );
		$this->assertEquals( $editor_id, $result['user_id'] );
	...
	public function test_arbitrary_fields() {
		...
		$result = $this->myxmlrpcserver->gc_getUser( array( 1, 'administrator', 'administrator', $editor_id, $fields ) );
		$this->assertNotIXRError( $result );
		$this->assertEquals( $editor_id, $result['user_id'] );
