 ...
 * @group xmlrpc
 */
class Tests_XMLRPC_gc_getComments extends GC_XMLRPC_UnitTestCase {
	public $post_id;

	public function test_invalid_username_password() {
		$result = $this->myxmlrpcserver->gc_getComments( array( 1, 'username', 'password', array() ) );
	...
	public function test_incapable_user() {
		...
		$result = $this->myxmlrpcserver->gc_getComments( array( 1, 'contributor', 'contributor', array() ) );
		$this->assertIXRError( $result );
	...
	public function test_capable_user() {
		...
		$results = $this->myxmlrpcserver->gc_getComments( array( 1, 'editor', 'editor', array() ) );
	...
	public function test_post_filter() {
		...
		$results = $this->myxmlrpcserver->gc_getComments(
			array(
				1,
				'editor',
				'editor',
	...
	public function test_number_filter() {
		...
		$results2 = $this->myxmlrpcserver->gc_getComments(
			array(
				1,
				'editor',
				'editor',
	...
	public function test_contributor_capabilities() {
		...
		$result = $this->myxmlrpcserver->gc_getComments( array( 1, 'contributor', 'contributor' ) );
		$this->assertIXRError( $result );
		$this->assertSame( 401, $result->code );
	}
	...
	public function test_author_capabilities() {
		...
		$result1 = $this->myxmlrpcserver->gc_getComments(
			array(
				1,
				'author',
				'author',
		...
		$result2 = $this->myxmlrpcserver->gc_getComments(
			array(
				1,
				'author',
				'author',
		...
		$result3 = $this->myxmlrpcserver->gc_getComments(
			array(
				1,
				'author',
				'author',
		...
		$result4 = $this->myxmlrpcserver->gc_getComments(
			array(
				1,
				'author',
				'author',
	...
	public function test_editor_capabilities() {
		...
		$result = $this->myxmlrpcserver->gc_getComments(
			array(
				1,
				'editor',
				'editor',
