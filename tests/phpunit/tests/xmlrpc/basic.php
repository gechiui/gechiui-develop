 ...
 * @group xmlrpc
 */
class Tests_XMLRPC_Basic extends GC_XMLRPC_UnitTestCase {
	...
	public function test_login_pass_ok() {
		...
		$this->assertInstanceOf( 'GC_User', $this->myxmlrpcserver->login( 'subscriber', 'subscriber' ) );
	}
	...
	public function test_disabled() {
		...
		$testcase_xmlrpc_server = new gc_xmlrpc_server();
		$result                 = $testcase_xmlrpc_server->gc_getOptions( array( 1, 'username', 'password' ) );
