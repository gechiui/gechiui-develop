 ...
 * @group hooks
 */
class Tests_Filters extends GC_UnitTestCase {
	...
	public function current_priority_action() {
		global $gc_filter;
		$this->current_priority = $gc_filter[ current_filter() ]->current_priority();
	}
	...
	public function other_priority_action() {
		global $gc_filter;
		$this->current_priority = $gc_filter['the_content']->current_priority();
	}
}
