 ...
 * @group admin
 */
class Tests_Admin_gcPostsListTable extends GC_UnitTestCase {
	...
	/**
	 * @var GC_Posts_List_Table
	 */
	protected $table;

	function set_up() {
		parent::set_up();
		$this->table = _get_list_table( 'GC_Posts_List_Table', array( 'screen' => 'edit-page' ) );
	}
	 ...
	 * @ticket 15459
	 *
	 * @covers GC_Posts_List_Table::display_rows
	 * @covers GC_Posts_List_Table::set_hierarchical_display
	 */
	...
	/**
	 * Helper function to test the output of a page which uses `GC_Posts_List_Table`.
	 *
	...
	protected function _test_list_hierarchical_page( array $args, array $expected_ids ) {
		...
		// Mimic the behaviour of `gc_edit_posts_query()`:
	 ...
	 * @ticket 37407
	 *
	 * @covers GC_Posts_List_Table::extra_tablenav
	 */
