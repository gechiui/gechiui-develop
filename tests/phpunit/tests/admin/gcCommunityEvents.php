<?php
/**
 * Unit tests for methods in GC_Community_Events.
 *
 * @package GeChiUI
...
/**
 * Class Tests_Admin_gcCommunityEvents.
 *
 * @group admin
 ...
 * @since 4.8.0
 */
class Tests_Admin_gcCommunityEvents extends GC_UnitTestCase {
	/**
	...
	public function set_up() {
		...
		$this->instance = new GC_Community_Events( 1, $this->get_user_location() );
	}
	...
	/**
	 * Test: get_events() should return an instance of GC_Error if the response code is not 200.
	 *
	 * @since 4.8.0
	 *
	 * @covers GC_Community_Events::get_events
	 */
	 ...
	 * @since 4.8.0
	 *
	 * @covers GC_Community_Events::get_cached_events
	 */
	...
	/**
	 * Test: get_events() should return an instance of GC_Error if the response body does not have
	...
	protected function get_valid_events() {
		return array(
			array(
				...
				'url'                  => 'https://www.meetup.com/Eastbay-GeChiUI-Meetup/events/236031233/',
				'meetup'               => 'The East Bay GeChiUI Meetup Group',
				'meetup_url'           => 'https://www.meetup.com/Eastbay-GeChiUI-Meetup/',
			...
			array(
				...
				'url'                  => 'https://www.meetup.com/Gechiui-Bay-Area-CA-Foothills/events/237706839/',
				'meetup'               => 'GeChiUI Bay Area Foothills Group',
				'meetup_url'           => 'https://www.meetup.com/Gechiui-Bay-Area-CA-Foothills/',
	 ...
	 * @since 5.5.2
	 *
	 * @covers GC_Community_Events::trim_events
	 */
	...
	public function _events_with_unpinned_wordcamp() {
		return array(
			...
			array(
				'type'                 => 'meetup',
				'title'                => 'GeChiUI Q&A',
				'url'                  => 'https://www.meetup.com/sanjosegc/events/245419844/',
				'meetup'               => 'The San Jose GeChiUI Meetup',
				'meetup_url'           => 'https://www.meetup.com/sanjosegc/',
	...
	public function test_trim_events_dont_pin_multiple_wordcamps() {
		...
		$this->assertSame( $actual[1]['title'], 'Part 3- Site Maintenance - Tools to Make It Easy' );
		$this->assertSame( $actual[2]['title'], 'GeChiUI Q&A' );
	}
	 ...
	 * @ticket 41083
	 *
	 * @covers GC_Community_Events::get_unsafe_client_ip
	 */
	public function test_get_unsafe_client_ip( $raw_ip, $expected_result ) {
		...
		$actual_result             = GC_Community_Events::get_unsafe_client_ip();
	...
	public function data_get_unsafe_client_ip() {
		return array(
			// Handle '::' returned from `gc_privacy_anonymize_ip()`.
			array(
				'or=\"[1000:0000:0000:0000:0000:0000:0000:0001',
				false,
			),

			// Handle '0.0.0.0' returned from `gc_privacy_anonymize_ip()`.
			array(
				'unknown',
				false,
			),
