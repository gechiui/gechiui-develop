 ...
 * @group admin
 */
class Tests_Admin_gcMediaListTable extends GC_UnitTestCase {

	public static function set_up_before_class() {
		parent::set_up_before_class();

		require_once ABSPATH . 'gc-admin/includes/class-gc-media-list-table.php';
	}

	/**
	 * Tests that a call to GC_Media_List_Table::prepare_items() on a site without any scheduled events
	 ...
	 *
	 * Note: This does not test the actual functioning of the GC_Media_List_Table::prepare_items() method.
	 * It just and only tests for/against the PHP warning.
	 *
	 * @ticket 53949
	 * @covers GC_Media_List_Table::prepare_items
	 */
	public function test_prepare_items_without_cron_option_does_not_throw_warning() {
		global $gc_query;

		// Note: setMethods() is deprecated in PHPUnit 9, but still supported.
		$mock = $this->getMockBuilder( GC_Media_List_Table::class )
		...
		$gc_query->query_vars['posts_per_page'] = 10;
		delete_option( 'cron' );
