<?php
/**
 * Test the `GC_Privacy_Requests_Table` class.
 *
...
/**
 * Tests_Admin_gcPrivacyRequestsTable class.
 *
 * @group admin
 * @group privacy
 *
 * @since 5.1.0
 */
class Tests_Admin_gcPrivacyRequestsTable extends GC_UnitTestCase {
	/**
	 * Get instance for mocked class.
	 *
	 * @since 5.1.0
	 *
	 * @return PHPUnit_Framework_MockObject_MockObject|GC_Privacy_Requests_Table Mocked class instance.
	 */
	public function get_mocked_class_instance() {
		...
		$instance = $this
			->getMockBuilder( 'GC_Privacy_Requests_Table' )
	 ...
	 * @covers GC_Privacy_Requests_Table::prepare_items
	 * @ticket 43960
	 */
	public function test_columns_should_be_sortable( $order, $orderby, $search, $expected ) {
		...
		$this->assertStringContainsString( "ORDER BY {$gcdb->posts}.{$expected}", $this->sql );
	}
