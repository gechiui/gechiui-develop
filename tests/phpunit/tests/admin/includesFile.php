 ...
 * @group admin
 */
class Tests_Admin_IncludesFile extends GC_UnitTestCase {
	...
	public function test_get_home_path() {
		...
		update_option( 'siteurl', 'http://localhost/gc' );

		$_SERVER['SCRIPT_FILENAME'] = 'D:\root\vhosts\site\httpdocs\wp\gc-admin\options-permalink.php';
		$this->assertSame( 'D:/root/vhosts/site/httpdocs/', get_home_path() );

		$_SERVER['SCRIPT_FILENAME'] = '/Users/foo/public_html/trunk/gc/gc-admin/options-permalink.php';
		$this->assertSame( '/Users/foo/public_html/trunk/', get_home_path() );

		$_SERVER['SCRIPT_FILENAME'] = 'S:/home/gechiui/trunk/gc/gc-admin/options-permalink.php';
		$this->assertSame( 'S:/home/gechiui/trunk/', get_home_path() );
	...
	/**
	 * Verify that a GC_Error object is returned when invalid input is passed as the `$url` parameter.
	 *
	 * @covers ::download_url
