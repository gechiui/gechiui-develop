 ...
 * @group themes
 */
class Tests_Admin_IncludesTheme extends GC_UnitTestCase {
	...
	public function test_page_templates() {
		...
		$theme = gc_get_theme( 'page-templates' );
		$this->assertNotEmpty( $theme );
	...
	public function test_page_templates_child_theme() {
		$theme = gc_get_theme( 'page-templates-child' );
		$this->assertNotEmpty( $theme );
	...
	/**
	 * Test that the list of theme features pulled from the www.GeChiUI.com API returns the expected data structure.
	 *
