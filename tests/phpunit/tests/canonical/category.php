 ...
 * @group canonical
 */
class Tests_Canonical_Category extends GC_Canonical_UnitTestCase {
	...
	public static function gcSetUpBeforeClass( GC_UnitTest_Factory $factory ) {
		...
		gc_set_post_categories( self::$posts[0], self::$cats[2] );
		gc_set_post_categories( self::$posts[0], self::$cats[0] );
		gc_set_post_categories( self::$posts[1], self::$cats[1] );
	}
