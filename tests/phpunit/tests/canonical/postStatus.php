 ...
 * @group query
 */
class Tests_Canonical_PostStatus extends GC_Canonical_UnitTestCase {
	...
	public static function gcSetUpBeforeClass( GC_UnitTest_Factory $factory ) {
		...
		gc_trash_post( self::$posts['trash']->ID );
		gc_trash_post( self::$posts['trash-page']->ID );
	}
	...
	public function test_canonical_redirects_to_plain_permalinks( $post_key, $user_role, $requested, $expected ) {
		gc_set_current_user( self::$users[ $user_role ] );
