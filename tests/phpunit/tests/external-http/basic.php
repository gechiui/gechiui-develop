 ...
 * @group external-http
 */
class Tests_External_HTTP_Basic extends GC_UnitTestCase {
	...
	public function test_readme_php_version() {
		...
		// $this->assertContains( $matches[1], $php_matches[1], "readme.html's Recommended PHP version is too old. Remember to update the www.GeChiUI.com Requirements page, too." );
	}
	...
	public function test_readme_mysql_version() {
		 ...
		 * As GeChiUI core is not fully compatible with MySQL 8.0 at this time, the "supported" period here
		...
		$this->assertLessThan( $mysql_eol, time(), "readme.html's Recommended MySQL version is too old. Remember to update the www.GeChiUI.com Requirements page, too." );
	}
	...
	public function test_readme_mariadb_version() {
		...
		$this->assertLessThan( $mariadb_eol, time(), "readme.html's Recommended MariaDB version is too old. Remember to update the www.GeChiUI.com Requirements page, too." );
	}
	...
	public function get_response_body( $url ) {
		...
		$response_body = gc_remote_retrieve_body( $response );
