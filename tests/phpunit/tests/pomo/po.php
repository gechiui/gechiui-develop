 ...
 * @group pomo
 */
class Tests_POMO_PO extends GC_UnitTestCase {

	public static function set_up_before_class() {
		parent::set_up_before_class();

		require_once ABSPATH . '/gc-includes/pomo/po.php';
	}

	public function set_up() {
		parent::set_up();

		// Not so random gechiui.pot string -- multiple lines.
		$this->mail    = 'Your new GeChiUI blog has been successfully set up at:
...
';
		...
		$this->po_mail = '""
"Your new GeChiUI blog has been successfully set up at:\n"
"\n"
"%1$s\n"
"\n"
"You can log in to the administrator account with the following information:\n"
...
msgstr[2] "бабаяга"',
	...
	public function test_import_from_file() {
		...
		$multiple_line_entry = new Translation_Entry(
			array(
				'singular'     => 'The first thing you need to do is tell Blogger to let GeChiUI access your account. You will be sent back here after providing authorization.',
		...
		$comments_entry = new Translation_Entry(
			array(
				'singular'            => 'a',
				'translator_comments' => "baba\nbrubru",
				'references'          => array( 'gc-admin/x.php:111', 'baba:333', 'baba' ),
