 ...
 */
class Tests_Error_Protection_gcRecoveryModeKeyService extends GC_UnitTestCase {

	/**
	 * @ticket 46130
	 *
	 * @covers GC_Recovery_Mode_Key_Service::generate_recovery_mode_token
	 * @covers GC_Recovery_Mode_Key_Service::generate_and_store_recovery_mode_key
	 */
	public function test_generate_and_store_recovery_mode_key_returns_recovery_key() {
		$service = new GC_Recovery_Mode_Key_Service();
	 ...
	 * @ticket 46130
	 *
	 * @covers GC_Recovery_Mode_Key_Service::validate_recovery_mode_key
	 */
	public function test_validate_recovery_mode_key_returns_gc_error_if_no_key_set() {
		$service = new GC_Recovery_Mode_Key_Service();
	 ...
	 * @covers GC_Recovery_Mode_Key_Service::validate_recovery_mode_key
	 */
	public function test_validate_recovery_mode_key_returns_gc_error_if_data_missing() {
	 ...
	 * @covers GC_Recovery_Mode_Key_Service::validate_recovery_mode_key
	 */
	public function test_validate_recovery_mode_key_returns_gc_error_if_bad() {
	 ...
	 * @covers GC_Recovery_Mode_Key_Service::validate_recovery_mode_key
	 */
	public function test_validate_recovery_mode_key_returns_gc_error_if_stored_format_is_invalid() {

		$token = gc_generate_password( 22, false );
		update_option( 'recovery_keys', array( $token => 'gibberish' ) );
	 ...
	 * @covers GC_Recovery_Mode_Key_Service::validate_recovery_mode_key
	 */
	public function test_validate_recovery_mode_key_returns_gc_error_if_empty_key() {
		$service = new GC_Recovery_Mode_Key_Service();
		$token   = $service->generate_recovery_mode_token();
	 ...
	 * @covers GC_Recovery_Mode_Key_Service::validate_recovery_mode_key
	 */
	public function test_validate_recovery_mode_key_returns_gc_error_if_hash_mismatch() {
		$service = new GC_Recovery_Mode_Key_Service();
		$token   = $service->generate_recovery_mode_token();
		$service->generate_and_store_recovery_mode_key( $token );
		$error = $service->validate_recovery_mode_key( $token, 'abcd', HOUR_IN_SECONDS );
	 ...
	 * @covers GC_Recovery_Mode_Key_Service::validate_recovery_mode_key
	 */
	public function test_validate_recovery_mode_key_returns_gc_error_if_expired() {
		$service = new GC_Recovery_Mode_Key_Service();
		$token   = $service->generate_recovery_mode_token();
		$key     = $service->generate_and_store_recovery_mode_key( $token );
	 ...
	 * @ticket 46595
	 *
	 * @covers GC_Recovery_Mode_Key_Service::clean_expired_keys
	 */
