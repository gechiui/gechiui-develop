 ...
 * @group i18n
 */
class Tests_L10n_GetUserLocale extends GC_UnitTestCase {
	protected $user_id;
	...
	public function set_up() {
		...
		gc_set_current_user( $this->user_id );
	}
	...
	public function test_user_id_argument_with_gc_user_object() {
		$user_id = $this->factory()->user->create(
			array(
				'locale' => 'es_ES',
			)
	...
	public function test_user_id_argument_with_nonexistent_user() {
		...
		$user_id = $gcdb->get_var( "SELECT MAX(ID) FROM $gcdb->users" ) + 1;
