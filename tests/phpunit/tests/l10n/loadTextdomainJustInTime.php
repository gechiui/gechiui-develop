 ...
 * @group i18n
 */
class Tests_L10n_LoadTextdomainJustInTime extends GC_UnitTestCase {
	...
	public function test_should_allow_unloading_of_text_domain() {
		...
		add_filter( 'locale', array( $this, 'filter_set_locale_to_german' ) );
		load_textdomain( 'internationalized-plugin', GC_LANG_DIR . '/plugins/internationalized-plugin-de_DE.mo' );
