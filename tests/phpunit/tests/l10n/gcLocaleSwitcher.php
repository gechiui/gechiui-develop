 ...
 * @ticket 26511
 */
class Tests_L10n_gcLocaleSwitcher extends GC_UnitTestCase {
	/**
	 * @var string
	 */
	protected $locale = '';
	...
	public function test_switch_to_locale_changes_gc_locale_global() {
		global $gc_locale;
		...
		$gc_locale_de_de = clone $gc_locale;

		// Cleanup.
		restore_previous_locale();

		$this->assertSameSetsWithIndex( $expected, $gc_locale_de_de->number_format );
	}
	...
	public function test_restore_previous_locale_restores_gc_locale_global() {
		global $gc_locale;
		...
		$this->assertSameSetsWithIndex( $expected, $gc_locale->number_format );
	}
	...
	public function test_switch_to_site_locale_if_user_locale_is_set() {
		global $l10n, $gc_locale_switcher;
		...
		$locale_switcher = clone $gc_locale_switcher;

		$gc_locale_switcher = new GC_Locale_Switcher();
		$gc_locale_switcher->init();
		...
		$gc_locale_switcher = $locale_switcher;
