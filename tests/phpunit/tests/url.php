 ...
 * @group url
 */
class Tests_URL extends GC_UnitTestCase {
	...
	public function test_get_adjacent_post() {
		...
		$p = get_adjacent_post();
		$this->assertInstanceOf( 'GC_Post', $p );
