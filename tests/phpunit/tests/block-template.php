 ...
 */
class Tests_Block_Template extends GC_UnitTestCase {
	private static $post;

	private static $template_canvas_path = ABSPATH . GCINC . '/template-canvas.php';
	...
	public function tear_down() {
		...
		unset( $_gc_current_template_content );
	...
	function test_page_home_block_template_takes_precedence_over_less_specific_block_templates() {
		...
		$this->assertStringEqualsFile( get_stylesheet_directory() . '/templates/page-home.html', $_gc_current_template_content );
	}
	...
	function test_page_block_template_takes_precedence() {
		...
		$this->assertSame( self::$template_canvas_path, $resolved_template_path );
		$this->assertStringEqualsFile( get_stylesheet_directory() . '/templates/page.html', $_gc_current_template_content );
	}
	...
	function test_block_template_takes_precedence_over_equally_specific_php_template() {
		...
		$this->assertSame( self::$template_canvas_path, $resolved_template_path );
		$this->assertStringEqualsFile( get_stylesheet_directory() . '/templates/index.html', $_gc_current_template_content );
	}
	 ...
	 *
	 * Covers https://github.com/GeChiUI/gutenberg/pull/29026.
	 */
	 ...
	 *
	 * Covers https://github.com/GeChiUI/gutenberg/pull/31123.
	 * Covers https://core.trac.gechiui.com/ticket/54515.
	 *
	 */
	...
	function test_child_theme_block_template_takes_precedence_over_equally_specific_parent_theme_php_template() {
		...
		$this->assertSame( self::$template_canvas_path, $resolved_template_path );
		$this->assertStringEqualsFile( get_stylesheet_directory() . '/templates/page-1.html', $_gc_current_template_content );
	}

	/**
	 * Regression: https://github.com/GeChiUI/gutenberg/issues/31399.
	 */
	...
	/**
	 * Covers: https://github.com/GeChiUI/gutenberg/pull/30438.
	 */
	public function test_custom_page_block_template_takes_precedence_over_all_other_templates() {
		...
		$args = array(
			...
			'post_name'    => 'gc-custom-template-my-block-template',
		...
		$custom_page_block_template = 'gc-custom-template-my-block-template';
		...
		$this->assertSame( self::$template_canvas_path, $resolved_template_path );
		$this->assertSame( $post->post_content, $_gc_current_template_content );

		gc_delete_post( $post->ID );
	}

	/**
	 * Regression: https://github.com/GeChiUI/gutenberg/issues/31652.
	 */
