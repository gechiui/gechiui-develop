 ...
 * @group query
 */
class Tests_Query_Vars extends GC_UnitTestCase {
	...
	public function testPublicQueryVarsAreAsExpected() {
		...
		$this->assertSame(
			...
			$gc->public_query_vars,
			'Care should be taken when introducing new public query vars. See https://core.trac.gechiui.com/ticket/35115'
		);
	}
