 ...
 */
class Tests_Query_SetupPostdata extends GC_UnitTestCase {
	...
	public function test_page_from_gc_query() {
		...
		$GLOBALS['gc_query']->query_vars['page'] = 78;
		setup_postdata( $page );
	...
	public function test_setup_postdata_with_the_content() {
		...
		$GLOBALS['gc_query']->post = $GLOBALS['post'];
