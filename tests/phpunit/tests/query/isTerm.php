 ...
 * @group taxonomy
 */
class Tests_Query_IsTerm extends GC_UnitTestCase {
	protected $tag_id;
	protected $cat_id;
	protected $tax_id;
	protected $tax_id2;
	...
	public function set_up() {
		...
		gc_set_object_terms( $this->post_id, $this->cat_id, 'category' );
		gc_set_object_terms( $this->post_id, array( $this->tax_id, $this->tax_id2 ), 'testtax' );
