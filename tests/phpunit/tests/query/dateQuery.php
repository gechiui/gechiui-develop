 ...
 * @group datequery
 */
class Tests_Query_DateQuery extends GC_UnitTestCase {
	...
	public function test_date_query_before_array() {
		...
		$this->assertSameSets( array( $p1, $p2 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_before_array_test_defaulting() {
		...
		$this->assertSameSets( array( $p1 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_before_string() {
		...
		$this->assertSame( array( $p1, $p2 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_after_array() {
		...
		$this->assertSameSets( array( $p3 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_after_array_test_defaulting() {
		...
		$this->assertSame( array( $p2 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_after_string() {
		...
		$this->assertSame( array( $p3 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_after_string_inclusive() {
		...
		$this->assertSame( array( $p2, $p3 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_inclusive_between_dates() {
		...
		$this->assertSame( array( $p2, $p3, $p4 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_year() {
		...
		$this->assertSame( array( $p1 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_between_two_times() {
		...
		$this->assertSameSets( array( $p2, $p3, $p4 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_query_relation_or() {
		...
		$this->assertSame( array( $p1, $p3 ), gc_list_pluck( $posts, 'ID' ) );
	}
	...
	public function test_date_params_monthnum_m_duplicate() {
		...
		$this->assertStringContainsString( "MONTH( $gcdb->posts.post_date ) = 5", $this->q->request );
		$this->assertStringNotContainsString( "MONTH( $gcdb->posts.post_date ) = 9", $this->q->request );
	}
	...
	public function test_date_params_week_w_duplicate() {
		...
		$this->assertStringContainsString( "WEEK( $gcdb->posts.post_date, 1 ) = 43", $this->q->request );
		$this->assertStringNotContainsString( "WEEK( $gcdb->posts.post_date, 1 ) = 42", $this->q->request );
	}
	...
	public function test_date_query_with_taxonomy_join() {
		...
		gc_set_object_terms( $p1, 'bar', 'foo' );
