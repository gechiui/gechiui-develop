<?php
/**
 * Unit tests covering GC_Widget_Media functionality.
 *
 * @package    GeChiUI
 * @subpackage widgets
 */
...
/**
 * Test gc-includes/widgets/class-gc-widget-media.php
 *
 * @group widgets
 */
class Tests_Widgets_gcWidgetMedia extends GC_UnitTestCase {
	 ...
	 * @return PHPUnit_Framework_MockObject_MockObject|GC_Widget_Media Mocked instance.
	 */
	private function get_mocked_class_instance( $id_base = 'mocked', $name = 'Mocked', $widget_options = array(), $control_options = array() ) {
		$original_class_name       = 'GC_Widget_Media';
	 ...
	 * Test constructor.
	 *
	 * @covers GC_Widget_Media::__construct
	 * @covers GC_Widget_Media::_register
	 */
	public function test_constructor() {
		...
		$this->assertFalse( has_action( 'gc_enqueue_scripts', array( $widget, 'enqueue_preview_scripts' ) ), 'Did not expect preview scripts to be enqueued when not in customize preview context.' );
	 ...
	 *
	 * @covers GC_Widget_Media::is_attachment_with_mime_type
	 ...
	 *
	 * @covers GC_Widget_Media::sanitize_token_list
	 */
	 ...
	 * @param GC_Widget_Media $widget Widget.
	 * @return array
	 */
	 ...
	 *
	 * @covers GC_Widget_Media::get_instance_schema
	 */
	...
	public function test_update() {
		...
		add_filter( 'sanitize_text_field', array( $this, 'return_gc_error' ) );
		$result = $widget->update(
			array(
				'title' => 'Title',
			),
		...
		remove_filter( 'sanitize_text_field', array( $this, 'return_gc_error' ) );
		$this->assertSame( $result, $instance );
	}

	/**
	 * Helper function for Test_GC_Widget_Media::test_update().
	 *
	 * @return \GC_Error
	 */
	public function return_gc_error() {
	 ...
	 * Test widget method.
	 *
	 * @covers GC_Widget_Media::widget
	 * @covers GC_Widget_Media::render_media
	 */
	 ...
	 * @param GC_Widget_Media $object   Widget object.
	 ...
	 *
	 * @covers GC_Widget_Media::display_media_state
	 */
	 ...
	 *
	 * @covers GC_Widget_Media::enqueue_admin_scripts
	 */
	public function test_enqueue_admin_scripts() {
		...
		$this->assertTrue( gc_script_is( 'media-widgets' ) );
	}

	/**
	 * Test render_control_template_scripts method.
	 *
	 * @covers GC_Widget_Media::render_control_template_scripts
	 */
	 ...
	 *
	 * @covers GC_Widget_Media::has_content
	 */
	public function test_has_content() {
		...
		$gc_widget_media = new ReflectionClass( 'GC_Widget_Media' );
		$has_content     = $gc_widget_media->getMethod( 'has_content' );
