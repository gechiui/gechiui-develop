<?php
/**
 * Unit tests covering GC_Widget_Media_Image functionality.
 *
 * @package    GeChiUI
 * @subpackage widgets
 */
...
/**
 * Test gc-includes/widgets/class-gc-widget-media-image.php
 *
 * @group widgets
 */
class Tests_Widgets_gcWidgetMediaImage extends GC_UnitTestCase {
	 ...
	 *
	 * @covers GC_Widget_Media_Image::get_instance_schema
	 */
	public function test_get_instance_schema() {
		$widget = new GC_Widget_Media_Image();
	 ...
	 * @param GC_Widget_Media_Image $widget Widget.
	 * @return array
	 */
	 ...
	 * Test constructor.
	 *
	 * @covers GC_Widget_Media_Image::__construct
	 */
	 ...
	 * Test get_instance_schema method.
	 *
	 * @covers GC_Widget_Media_Image::update
	 */
	 ...
	 *
	 * @covers GC_Widget_Media_Image::render_media
	...
	public function test_render_media() {
		...
		$this->assertStringContainsString( 'class="image gc-image-' . $attachment_id, $output );
		...
		// Custom image class.
		$this->assertStringContainsString( 'class="image gc-image-' . $attachment_id . ' custom-class', $output );
		...
		$link = '<a href="' . gc_get_attachment_url( $attachment_id ) . '"';
		...
		$output = ob_get_clean();
		$this->assertStringNotContainsString( 'gc-caption', $output );
		$this->assertStringNotContainsString( '<p class="gc-caption-text">', $output );
		...
		$output = ob_get_clean();
		$this->assertStringContainsString( 'class="gc-caption alignnone"', $output );
		$this->assertStringContainsString( '<p class="gc-caption-text">Default caption</p>', $output );
		...
		$output = ob_get_clean();
		$this->assertStringContainsString( 'class="gc-caption alignnone"', $output );
		$this->assertStringContainsString( '<p class="gc-caption-text">Custom caption</p>', $output );
		...
		$this->assertStringContainsString( '<p class="gc-caption-text">Caption for an image with custom size</p>', $output );
	}

	/**
	 * Test enqueue_admin_scripts method.
	 *
	 * @covers GC_Widget_Media_Image::enqueue_admin_scripts
	 */
	public function test_enqueue_admin_scripts() {
		...
		$this->assertTrue( gc_script_is( 'media-image-widget' ) );
	}

	/**
	 * Test render_control_template_scripts method.
	 *
	 * @covers GC_Widget_Media_Image::render_control_template_scripts
	 */
	public function test_render_control_template_scripts() {
		...
		$this->assertStringContainsString( '<script type="text/html" id="tmpl-gc-media-widget-image-preview">', $output );
	}
}
