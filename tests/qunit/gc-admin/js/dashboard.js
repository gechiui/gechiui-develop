/* global gc, sinon, JSON */
var communityEventsData, dateI18n, pagenow;

jQuery( document ).ready( function () {
	var getFormattedDate = gc.communityEvents.getFormattedDate,
		getTimeZone = gc.communityEvents.getTimeZone,
		getTimeZoneAbbreviation = gc.communityEvents.getTimeZoneAbbreviation,
		populateDynamicEventFields = gc.communityEvents.populateDynamicEventFields,
	...
	QUnit.module( 'dashboard', function( hooks ) {
		...
		QUnit.module( 'communityEvents.populateDynamicEventFields', function() {
			QUnit.test( 'dynamic fields should be added', function( assert ) {
				...
				var getFormattedDateStub = sinon.stub( gc.communityEvents, 'getFormattedDate' ),
					getTimeZoneStub = sinon.stub( gc.communityEvents, 'getTimeZone' ),
					getTimeZoneAbbreviationStub = sinon.stub( gc.communityEvents, 'getTimeZoneAbbreviation' );
