...
var jsWidgetsEndpointSchema =
{
    ...
    "routes": {
        "\/js-widgets\/v1": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1" }
        },
        "\/js-widgets\/v1\/widgets\/pages": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/pages" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/calendar": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/calendar" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/archives": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/archives" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/meta": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/meta" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/search": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/search" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/text": {
            ...
            "endpoints": [{
                ...
                "args": {
                    ...
                    "filter": { "required": false, "default": false, "description": "Whether paragraphs will be added for double line breaks (gcautop).", "type": "boolean" }
                }
            }],
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/text" }
        },
        "\/js-widgets\/v1\/widgets\/text\/(?P<widget_number>\\d+)": {
            ...
            "endpoints": [{
                ...
                "args": {
                    "title": { "required": false, "description": "The title for the widget.", "type": ["string", "object"] },
                    "text": { "required": false, "description": "The content for the widget.", "type": ["string", "object"] },
                    "filter": { "required": false, "description": "Whether paragraphs will be added for double line breaks (gcautop).", "type": "boolean" }
                }
            }]
        },
        "\/js-widgets\/v1\/widgets\/categories": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/categories" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/recent-posts": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/recent-posts" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/recent-comments": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/recent-comments" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/rss": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/rss" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/tag_cloud": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/tag_cloud" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/nav_menu": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/nav_menu" }
        },
        ...
        "\/js-widgets\/v1\/widgets\/post-collection": {
            ...
            "_links": { "self": "http:\/\/newtest.localhost\/gc-json\/js-widgets\/v1\/widgets\/post-collection" }
        },
    ...
    "_links": {
        "up": [
            { "href": "http:\/\/newtest.localhost\/gc-json\/" }
        ]
    }
};
