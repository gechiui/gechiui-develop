...
window._gcCustomizeSettings = {
	...
	'url': {
		'activated': 'http://example.org/gc-admin/themes.php?activated=true&previewed',
		'ajax': '/gc-admin/admin-ajax.php',
		'allowed': [
			'http://example.org/'
		],
		...
		'isCrossDomain': false,
		'login': 'http://example.org/gc-login.php?interim-login=1&customize-login=1',
		'parent': 'http://example.org/gc-admin/',
...
window._gcCustomizeControlsL10n = {};
