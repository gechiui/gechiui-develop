window._gcCustomizeWidgetsSettings = {
	'nonce': '12cc9d3284',
	'registeredSidebars': [{
		'name': 'Widget Area',
		'id': 'sidebar-1',
...
window._gcCustomizeSettings.panels.widgets = {
	'id': 'widgets',
...
window._gcCustomizeSettings.sections['sidebar-widgets-sidebar-1'] = {
...
window._gcCustomizeSettings.settings['widget_search[2]'] = {
	'value': {
...
window._gcCustomizeSettings.settings['sidebars_widgets[sidebar-1]'] = {
	'value': [ 'search-2' ],
	'transport': 'refresh',
	'dirty': false
};

window._gcCustomizeSettings.controls['widget_search[2]'] = {
	'settings': {
...
window._gcCustomizeSettings.controls['sidebars_widgets[sidebar-1]'] = {
	'settings': {
