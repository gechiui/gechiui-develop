...
window._gcCustomizeNavMenusSettings = {
	'nonce': 'yo',
...
window._gcCustomizeSettings.panels.nav_menus = {
	'id': 'nav_menus',
	'description': '<p>This panel is used for managing navigation menus for content you have already published on your site. You can create menus and add items for existing content such as pages, posts, categories, tags, formats, or custom links.</p><p>Menus can be displayed in locations defined by your theme or in <a href="javascript:gc.customize.panel( "widgets" ).focus();">widget areas</a> by adding a &#8220;Custom Menu&#8221; widget.</p>',
	'priority': 100,
	'type': 'nav_menus',
	'title': 'Menus',
	'content': '',
...
// Nav Menu Locations.
window._gcCustomizeSettings.sections.menu_locations = {
	'id': 'menu_locations',
...
window._gcCustomizeSettings.settings['nav_menu_locations[social]'] = {
	'value': 2,
	'transport': 'postMessage',
	'dirty': false
};
window._gcCustomizeSettings.controls['nav_menu_locations[social]'] = {
...
window._gcCustomizeSettings.settings['nav_menu_locations[primary]'] = {
	'value': 3,
	'transport': 'postMessage',
	'dirty': false
};
window._gcCustomizeSettings.controls['nav_menu_locations[primary]'] = {
	'active': true,
...
// Nav Menus.
window._gcCustomizeSettings.sections['nav_menu[3]'] = {
	'id': 'nav_menu[3]',
	'description': '',
	'priority': 10,
	'panel': 'nav_menus',
...
window._gcCustomizeSettings.settings['nav_menu[3]'] = {
	'value': {
		'name': 'Primary menu',
		'description': '',
		'parent': 0,
...
window._gcCustomizeSettings.sections['nav_menu[2]'] = {
	'id': 'nav_menu[2]',
	'description': '',
	'priority': 10,
	'panel': 'nav_menus',
...
window._gcCustomizeSettings.settings['nav_menu[2]'] = {
	'value': {
		'name': 'Social menu',
		'description': '',
		'parent': 0,
...
// Menu items.
window._gcCustomizeSettings.settings['nav_menu_item[2000]'] = {
	'dirty': false,
	'transport': 'postMessage',
	'value': {
		'attr_title': '',
		...
		'type': 'post_type',
		'type_label': 'Page',
		'url': 'http://src.gechiui-develop.dev/sample-page/',
		'xfn': ''
	}
};
window._gcCustomizeSettings.controls['nav_menu_item[2000]'] = {
	'active': true,
	'attr_title': '',
	'classes': '',
...
window._gcCustomizeSettings.settings['nav_menu_item[2001]'] = {
	'dirty': false,
	'transport': 'postMessage',
	'value': {
		'attr_title': '',
...
window._gcCustomizeSettings.controls['nav_menu_item[2001]'] = {
	'active': true,
	'attr_title': '',
	'classes': '',
...
window._gcCustomizeSettings.settings['nav_menu_item[2002]'] = {
	'dirty': false,
	'transport': 'postMessage',
	'value': {
		'attr_title': '',
...
window._gcCustomizeSettings.controls['nav_menu_item[2002]'] = {
	'active': true,
	'attr_title': '',
	'classes': '',
...
// Meta controls.
window._gcCustomizeSettings.sections.add_menu = {
	'id': 'add_menu',
	'description': '',
	'priority': 999,
	'panel': 'nav_menus',
...
window._gcCustomizeSettings.controls.new_menu_name = {
