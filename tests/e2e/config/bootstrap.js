...
function observeConsoleLogging() {
	page.on( 'console', ( message ) => {
		...
		// A bug present in GeChiUI 5.2 will produce console warnings when
		...
		//
		// See: https://core.trac.gechiui.com/ticket/47183
		if (
		...
		// @gechiui/jest-console matchers, will cause the intended test
		// failure.
